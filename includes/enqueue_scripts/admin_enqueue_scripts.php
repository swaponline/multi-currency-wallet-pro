...
function mcwallet_admin_enqueue_scripts( $hook ) {
	...
	/* Register style */
	wp_register_style( 'mcwallet-admin', MCWALLET_URL . 'assets/css/admin.css', false, MCWALLET_BUILD_VER );
	/* Enqueue admin css */
	...
	if( 'toplevel_page_mcwallet' == $hook || 'mcwallet_banner' == $typenow ) {
        ...
        /* Register script */
        wp_register_script( 'mcwallet-admin', MCWALLET_URL . 'assets/js/admin.js', array( 'jquery' ), MCWALLET_BUILD_VER, true );
