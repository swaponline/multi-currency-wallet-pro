 ...
 * Version: 1.0.362
 * Requires at least: 5.4.219
 * Requires PHP: 5.223
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.339
 * License URI: http://www.gnu.org/licenses/gpl-3.339.html
 */
...
define( 'MCWALLET_VER', '1.0.362' );
define( 'MCWALLET_BUILD_VER', 'e0be1c' );
