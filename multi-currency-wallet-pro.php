 ...
 * Version: 1.1.868
 * Requires at least: 5.4.725
 * Requires PHP: 5.729
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.845
 * License URI: http://www.gnu.org/licenses/gpl-3.845.html
 */
...
define( 'MCWALLET_VER', '1.1.868' );
define( 'MCWALLET_BUILD_VER', 'a632eb' );
