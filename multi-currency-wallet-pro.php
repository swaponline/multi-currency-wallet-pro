 ...
 * Version: 1.1.880
 * Requires at least: 5.4.737
 * Requires PHP: 5.741
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.857
 * License URI: http://www.gnu.org/licenses/gpl-3.857.html
 */
...
define( 'MCWALLET_VER', '1.1.880' );
define( 'MCWALLET_BUILD_VER', 'b066e1' );
