 ...
 * Version: 1.1.845
 * Requires at least: 5.4.702
 * Requires PHP: 5.706
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.822
 * License URI: http://www.gnu.org/licenses/gpl-3.822.html
 */
...
define( 'MCWALLET_VER', '1.1.845' );
define( 'MCWALLET_BUILD_VER', 'a609e1' );
