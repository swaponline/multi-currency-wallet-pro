 ...
 * Version: 1.0.538
 * Requires at least: 5.4.395
 * Requires PHP: 5.399
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.515
 * License URI: http://www.gnu.org/licenses/gpl-3.515.html
 */
...
define( 'MCWALLET_VER', '1.0.538' );
define( 'MCWALLET_BUILD_VER', 'dc5ce1' );
