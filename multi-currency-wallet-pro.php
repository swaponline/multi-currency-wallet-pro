 ...
 * Version: 1.0.542
 * Requires at least: 5.4.399
 * Requires PHP: 5.403
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.519
 * License URI: http://www.gnu.org/licenses/gpl-3.519.html
 */
...
define( 'MCWALLET_VER', '1.0.542' );
define( 'MCWALLET_BUILD_VER', '871e1f' );
