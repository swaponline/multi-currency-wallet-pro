 ...
 * Version: 1.0.378
 * Requires at least: 5.4.235
 * Requires PHP: 5.239
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.355
 * License URI: http://www.gnu.org/licenses/gpl-3.355.html
 */
...
define( 'MCWALLET_VER', '1.0.378' );
define( 'MCWALLET_BUILD_VER', '7476c4' );
