 ...
 * Version: 1.1.1507
 * Requires at least: 5.3.1143
 * Requires PHP: 5.0.1143
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1381
 * License URI: http://www.gnu.org/licenses/gpl-3.1381.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1507' );
	define( 'MCWALLET_BUILD_VER', '8a9841' );
