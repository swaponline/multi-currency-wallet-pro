 ...
 * Version: 1.0.518
 * Requires at least: 5.4.375
 * Requires PHP: 5.379
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.495
 * License URI: http://www.gnu.org/licenses/gpl-3.495.html
 */
...
define( 'MCWALLET_VER', '1.0.518' );
define( 'MCWALLET_BUILD_VER', 'a067ed' );
