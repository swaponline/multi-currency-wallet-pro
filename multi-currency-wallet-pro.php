 ...
 * Version: 1.1.947
 * Requires at least: 5.4.804
 * Requires PHP: 5.808
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.924
 * License URI: http://www.gnu.org/licenses/gpl-3.924.html
 */
...
define( 'MCWALLET_VER', '1.1.947' );
define( 'MCWALLET_BUILD_VER', '07ffa0' );
