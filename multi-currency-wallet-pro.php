 ...
 * Version: 1.1.883
 * Requires at least: 5.4.740
 * Requires PHP: 5.744
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.860
 * License URI: http://www.gnu.org/licenses/gpl-3.860.html
 */
...
define( 'MCWALLET_VER', '1.1.883' );
define( 'MCWALLET_BUILD_VER', 'fe0802' );
