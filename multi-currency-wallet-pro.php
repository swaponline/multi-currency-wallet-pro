 ...
 * Version: 1.1.936
 * Requires at least: 5.4.793
 * Requires PHP: 5.797
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.913
 * License URI: http://www.gnu.org/licenses/gpl-3.913.html
 */
...
define( 'MCWALLET_VER', '1.1.936' );
define( 'MCWALLET_BUILD_VER', 'ededa6' );
