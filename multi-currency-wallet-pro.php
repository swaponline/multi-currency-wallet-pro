 ...
 * Version: 1.0.601
 * Requires at least: 5.4.458
 * Requires PHP: 5.462
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.578
 * License URI: http://www.gnu.org/licenses/gpl-3.578.html
 */
...
define( 'MCWALLET_VER', '1.0.601' );
define( 'MCWALLET_BUILD_VER', '53d5ba' );
