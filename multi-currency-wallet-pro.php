 ...
 * Version: 1.1.974
 * Requires at least: 5.4.831
 * Requires PHP: 5.835
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.951
 * License URI: http://www.gnu.org/licenses/gpl-3.951.html
 */
...
define( 'MCWALLET_VER', '1.1.974' );
define( 'MCWALLET_BUILD_VER', 'f35384' );
