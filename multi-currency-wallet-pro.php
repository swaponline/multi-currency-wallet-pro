 ...
 * Version: 1.0.609
 * Requires at least: 5.4.466
 * Requires PHP: 5.470
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.586
 * License URI: http://www.gnu.org/licenses/gpl-3.586.html
 */
...
define( 'MCWALLET_VER', '1.0.609' );
define( 'MCWALLET_BUILD_VER', '48baaa' );
