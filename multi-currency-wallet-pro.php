 ...
 * Version: 1.0.294
 * Requires at least: 5.4.151
 * Requires PHP: 5.155
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.271
 * License URI: http://www.gnu.org/licenses/gpl-3.271.html
 */
...
define( 'MCWALLET_VER', '1.0.294' );
define( 'MCWALLET_BUILD_VER', 'e7e5c9' );
