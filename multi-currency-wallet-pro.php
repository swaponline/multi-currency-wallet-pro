 ...
 * Version: 1.0.560
 * Requires at least: 5.4.417
 * Requires PHP: 5.421
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.537
 * License URI: http://www.gnu.org/licenses/gpl-3.537.html
 */
...
define( 'MCWALLET_VER', '1.0.560' );
define( 'MCWALLET_BUILD_VER', 'e3a15c' );
