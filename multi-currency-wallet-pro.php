 ...
 * Version: 1.0.406
 * Requires at least: 5.4.263
 * Requires PHP: 5.267
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.383
 * License URI: http://www.gnu.org/licenses/gpl-3.383.html
 */
...
define( 'MCWALLET_VER', '1.0.406' );
define( 'MCWALLET_BUILD_VER', '85d308' );
