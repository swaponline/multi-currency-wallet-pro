 ...
 * Version: 1.1.771
 * Requires at least: 5.4.628
 * Requires PHP: 5.632
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.748
 * License URI: http://www.gnu.org/licenses/gpl-3.748.html
 */
...
define( 'MCWALLET_VER', '1.1.771' );
define( 'MCWALLET_BUILD_VER', '1aeda9' );
