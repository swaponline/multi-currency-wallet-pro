 ...
 * Version: 1.0.333
 * Requires at least: 5.4.190
 * Requires PHP: 5.194
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.310
 * License URI: http://www.gnu.org/licenses/gpl-3.310.html
 */
...
define( 'MCWALLET_VER', '1.0.333' );
define( 'MCWALLET_BUILD_VER', 'd897e1' );
