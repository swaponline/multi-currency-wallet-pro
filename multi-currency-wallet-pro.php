 ...
 * Version: 1.0.384
 * Requires at least: 5.4.241
 * Requires PHP: 5.245
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.361
 * License URI: http://www.gnu.org/licenses/gpl-3.361.html
 */
...
define( 'MCWALLET_VER', '1.0.384' );
define( 'MCWALLET_BUILD_VER', '9e3ca7' );
