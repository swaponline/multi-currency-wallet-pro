 ...
 * Version: 1.0.483
 * Requires at least: 5.4.340
 * Requires PHP: 5.344
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.460
 * License URI: http://www.gnu.org/licenses/gpl-3.460.html
 */
...
define( 'MCWALLET_VER', '1.0.483' );
define( 'MCWALLET_BUILD_VER', '046d80' );
