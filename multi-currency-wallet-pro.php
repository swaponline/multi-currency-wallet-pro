 ...
 * Version: 1.1.726
 * Requires at least: 5.4.583
 * Requires PHP: 5.587
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.703
 * License URI: http://www.gnu.org/licenses/gpl-3.703.html
 */
...
define( 'MCWALLET_VER', '1.1.726' );
define( 'MCWALLET_BUILD_VER', 'e28a29' );
