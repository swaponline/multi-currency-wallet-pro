 ...
 * Version: 1.0.547
 * Requires at least: 5.4.404
 * Requires PHP: 5.408
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.524
 * License URI: http://www.gnu.org/licenses/gpl-3.524.html
 */
...
define( 'MCWALLET_VER', '1.0.547' );
define( 'MCWALLET_BUILD_VER', '45a03f' );
