 ...
 * Version: 1.1.1497
 * Requires at least: 5.3.1133
 * Requires PHP: 5.0.1133
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1371
 * License URI: http://www.gnu.org/licenses/gpl-3.1371.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1497' );
	define( 'MCWALLET_BUILD_VER', '124d4b' );
