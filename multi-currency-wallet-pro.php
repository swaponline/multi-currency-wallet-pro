 ...
 * Version: 1.0.318
 * Requires at least: 5.4.175
 * Requires PHP: 5.179
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.295
 * License URI: http://www.gnu.org/licenses/gpl-3.295.html
 */
...
define( 'MCWALLET_VER', '1.0.318' );
define( 'MCWALLET_BUILD_VER', 'e08421' );
