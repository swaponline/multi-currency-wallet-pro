 ...
 * Version: 1.0.412
 * Requires at least: 5.4.269
 * Requires PHP: 5.273
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.389
 * License URI: http://www.gnu.org/licenses/gpl-3.389.html
 */
...
define( 'MCWALLET_VER', '1.0.412' );
define( 'MCWALLET_BUILD_VER', 'aee95a' );
