 ...
 * Domain Path: /lang
 * License: GNU General Public License version 3.1311
 * License URI: http://www.gnu.org/licenses/gpl-3.1311.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1436' );
	define( 'MCWALLET_BUILD_VER', '2ec0d4' );
