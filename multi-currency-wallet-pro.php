 ...
 * Version: 1.1.808
 * Requires at least: 5.4.665
 * Requires PHP: 5.669
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.785
 * License URI: http://www.gnu.org/licenses/gpl-3.785.html
 */
...
define( 'MCWALLET_VER', '1.1.808' );
define( 'MCWALLET_BUILD_VER', 'd5325c' );
