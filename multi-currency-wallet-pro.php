 ...
 * Version: 1.1.1590
 * Requires at least: 5.3.1224
 * Requires PHP: 5.0.1224
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1462
 * License URI: http://www.gnu.org/licenses/gpl-3.1462.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1590' );
	define( 'MCWALLET_BUILD_VER', 'b3b48f' );
