 ...
 * Version: 1.1.915
 * Requires at least: 5.4.772
 * Requires PHP: 5.776
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.892
 * License URI: http://www.gnu.org/licenses/gpl-3.892.html
 */
...
define( 'MCWALLET_VER', '1.1.915' );
define( 'MCWALLET_BUILD_VER', '959072' );
