 ...
 * Version: 1.0.647
 * Requires at least: 5.4.504
 * Requires PHP: 5.508
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.624
 * License URI: http://www.gnu.org/licenses/gpl-3.624.html
 */
...
define( 'MCWALLET_VER', '1.0.647' );
define( 'MCWALLET_BUILD_VER', 'f413f9' );
