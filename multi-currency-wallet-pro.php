 ...
 * Version: 1.1.1487
 * Requires at least: 5.3.1123
 * Requires PHP: 5.0.1123
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1361
 * License URI: http://www.gnu.org/licenses/gpl-3.1361.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1487' );
	define( 'MCWALLET_BUILD_VER', 'ca40f2' );
