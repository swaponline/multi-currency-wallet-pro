 ...
 * Version: 1.0.653
 * Requires at least: 5.4.510
 * Requires PHP: 5.514
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.630
 * License URI: http://www.gnu.org/licenses/gpl-3.630.html
 */
...
define( 'MCWALLET_VER', '1.0.653' );
define( 'MCWALLET_BUILD_VER', '5afff3' );
