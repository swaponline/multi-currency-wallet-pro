 ...
 * Version: 1.0.245
 * Requires at least: 5.4.102
 * Requires PHP: 5.106
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.222
 * License URI: http://www.gnu.org/licenses/gpl-3.222.html
 */
...
define( 'MCWALLET_VER', '1.0.245' );
define( 'MCWALLET_BUILD_VER', '9a0490' );
