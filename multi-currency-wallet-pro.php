 ...
 * Version: 1.0.654
 * Requires at least: 5.4.511
 * Requires PHP: 5.515
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.631
 * License URI: http://www.gnu.org/licenses/gpl-3.631.html
 */
...
define( 'MCWALLET_VER', '1.1.654' );
define( 'MCWALLET_BUILD_VER', '49c509' );
