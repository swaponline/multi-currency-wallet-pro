 ...
 * Version: 1.1.674
 * Requires at least: 5.4.531
 * Requires PHP: 5.535
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.651
 * License URI: http://www.gnu.org/licenses/gpl-3.651.html
 */
...
define( 'MCWALLET_VER', '1.1.674' );
define( 'MCWALLET_BUILD_VER', 'ffdc6b' );
