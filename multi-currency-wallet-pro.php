 ...
 * Version: 1.1.1336
 * Requires at least: 5.3.1073
 * Requires PHP: 5.0.1073
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1211
 * License URI: http://www.gnu.org/licenses/gpl-3.1211.html
 */
...
define( 'MCWALLET_VER', '1.1.1336' );
define( 'MCWALLET_BUILD_VER', 'cda9bd' );
