 ...
 * Version: 1.1.932
 * Requires at least: 5.4.789
 * Requires PHP: 5.793
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.909
 * License URI: http://www.gnu.org/licenses/gpl-3.909.html
 */
...
define( 'MCWALLET_VER', '1.1.932' );
define( 'MCWALLET_BUILD_VER', 'e48f5f' );
