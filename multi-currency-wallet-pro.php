 ...
 * Version: 1.0.550
 * Requires at least: 5.4.407
 * Requires PHP: 5.411
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.527
 * License URI: http://www.gnu.org/licenses/gpl-3.527.html
 */
...
define( 'MCWALLET_VER', '1.0.550' );
define( 'MCWALLET_BUILD_VER', 'c33bdd' );
