 ...
 * Version: 1.1.768
 * Requires at least: 5.4.625
 * Requires PHP: 5.629
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.745
 * License URI: http://www.gnu.org/licenses/gpl-3.745.html
 */
...
define( 'MCWALLET_VER', '1.1.768' );
define( 'MCWALLET_BUILD_VER', '52c97f' );
