 ...
 * Version: 1.1.826
 * Requires at least: 5.4.683
 * Requires PHP: 5.687
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.803
 * License URI: http://www.gnu.org/licenses/gpl-3.803.html
 */
...
define( 'MCWALLET_VER', '1.1.826' );
define( 'MCWALLET_BUILD_VER', 'a65806' );
