 ...
 * Version: 1.1.832
 * Requires at least: 5.4.689
 * Requires PHP: 5.693
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.809
 * License URI: http://www.gnu.org/licenses/gpl-3.809.html
 */
...
define( 'MCWALLET_VER', '1.1.832' );
define( 'MCWALLET_BUILD_VER', 'db0d0f' );
