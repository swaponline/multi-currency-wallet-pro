 ...
 * Version: 1.1.1047
 * Requires at least: 5.4.903
 * Requires PHP: 5.907
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1023
 * License URI: http://www.gnu.org/licenses/gpl-3.1023.html
 */
...
define( 'MCWALLET_VER', '1.1.1047' );
define( 'MCWALLET_BUILD_VER', '729bf6' );
