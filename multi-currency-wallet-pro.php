 ...
 * Version: 1.1.798
 * Requires at least: 5.4.655
 * Requires PHP: 5.659
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.775
 * License URI: http://www.gnu.org/licenses/gpl-3.775.html
 */
...
define( 'MCWALLET_VER', '1.1.798' );
define( 'MCWALLET_BUILD_VER', '159f71' );
