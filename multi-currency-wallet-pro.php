 ...
 * Version: 1.1.913
 * Requires at least: 5.4.770
 * Requires PHP: 5.774
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.890
 * License URI: http://www.gnu.org/licenses/gpl-3.890.html
 */
...
define( 'MCWALLET_VER', '1.1.913' );
define( 'MCWALLET_BUILD_VER', 'be3b85' );
