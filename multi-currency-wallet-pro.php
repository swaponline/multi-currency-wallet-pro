 ...
 * Version: 1.0.426
 * Requires at least: 5.4.283
 * Requires PHP: 5.287
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.403
 * License URI: http://www.gnu.org/licenses/gpl-3.403.html
 */
...
define( 'MCWALLET_VER', '1.0.426' );
define( 'MCWALLET_BUILD_VER', 'caae1c' );
