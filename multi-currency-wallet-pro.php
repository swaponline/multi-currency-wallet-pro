 ...
 * Version: 1.0.421
 * Requires at least: 5.4.278
 * Requires PHP: 5.282
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.398
 * License URI: http://www.gnu.org/licenses/gpl-3.398.html
 */
...
define( 'MCWALLET_VER', '1.0.421' );
define( 'MCWALLET_BUILD_VER', '97c0b5' );
