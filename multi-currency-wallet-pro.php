 ...
 * Version: 1.1.863
 * Requires at least: 5.4.720
 * Requires PHP: 5.724
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.840
 * License URI: http://www.gnu.org/licenses/gpl-3.840.html
 */
...
define( 'MCWALLET_VER', '1.1.863' );
define( 'MCWALLET_BUILD_VER', '3ae19b' );
