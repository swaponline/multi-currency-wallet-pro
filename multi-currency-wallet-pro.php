 ...
 * Version: 1.1.884
 * Requires at least: 5.4.741
 * Requires PHP: 5.745
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.861
 * License URI: http://www.gnu.org/licenses/gpl-3.861.html
 */
...
define( 'MCWALLET_VER', '1.1.884' );
define( 'MCWALLET_BUILD_VER', 'ac07b3' );
