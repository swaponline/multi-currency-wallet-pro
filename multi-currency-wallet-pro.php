 ...
 * Version: 1.0.325
 * Requires at least: 5.4.182
 * Requires PHP: 5.186
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.302
 * License URI: http://www.gnu.org/licenses/gpl-3.302.html
 */
...
define( 'MCWALLET_VER', '1.0.325' );
define( 'MCWALLET_BUILD_VER', '4977ae' );
