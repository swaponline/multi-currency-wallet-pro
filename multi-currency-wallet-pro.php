 ...
 * Version: 1.0.246
 * Requires at least: 5.4.103
 * Requires PHP: 5.107
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.223
 * License URI: http://www.gnu.org/licenses/gpl-3.223.html
 */
...
define( 'MCWALLET_VER', '1.0.246' );
define( 'MCWALLET_BUILD_VER', '840d28' );
