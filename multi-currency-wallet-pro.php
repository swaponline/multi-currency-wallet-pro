 ...
 * Version: 1.1.949
 * Requires at least: 5.4.806
 * Requires PHP: 5.810
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.926
 * License URI: http://www.gnu.org/licenses/gpl-3.926.html
 */
...
define( 'MCWALLET_VER', '1.1.949' );
define( 'MCWALLET_BUILD_VER', '446989' );
