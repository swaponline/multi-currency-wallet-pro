 ...
 * Version: 1.0.603
 * Requires at least: 5.4.460
 * Requires PHP: 5.464
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.580
 * License URI: http://www.gnu.org/licenses/gpl-3.580.html
 */
...
define( 'MCWALLET_VER', '1.0.603' );
define( 'MCWALLET_BUILD_VER', '61c0b0' );
