 ...
 * Version: 1.1.672
 * Requires at least: 5.4.529
 * Requires PHP: 5.533
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.649
 * License URI: http://www.gnu.org/licenses/gpl-3.649.html
 */
...
define( 'MCWALLET_VER', '1.1.672' );
define( 'MCWALLET_BUILD_VER', 'e71610' );
