 ...
 * Version: 1.0.465
 * Requires at least: 5.4.322
 * Requires PHP: 5.326
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.442
 * License URI: http://www.gnu.org/licenses/gpl-3.442.html
 */
...
define( 'MCWALLET_VER', '1.0.465' );
define( 'MCWALLET_BUILD_VER', 'caf2ce' );
