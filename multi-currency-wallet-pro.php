 ...
 * Version: 1.0.436
 * Requires at least: 5.4.293
 * Requires PHP: 5.297
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.413
 * License URI: http://www.gnu.org/licenses/gpl-3.413.html
 */
...
define( 'MCWALLET_VER', '1.0.436' );
define( 'MCWALLET_BUILD_VER', '856998' );
