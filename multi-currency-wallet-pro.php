 ...
 * Version: 1.1.801
 * Requires at least: 5.4.658
 * Requires PHP: 5.662
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.778
 * License URI: http://www.gnu.org/licenses/gpl-3.778.html
 */
...
define( 'MCWALLET_VER', '1.1.801' );
define( 'MCWALLET_BUILD_VER', '189f1c' );
