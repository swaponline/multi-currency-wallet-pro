 ...
 * Version: 1.0.655
 * Requires at least: 5.4.512
 * Requires PHP: 5.516
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.632
 * License URI: http://www.gnu.org/licenses/gpl-3.632.html
 */
...
define( 'MCWALLET_VER', '1.1.655' );
define( 'MCWALLET_BUILD_VER', '6c48ef' );
