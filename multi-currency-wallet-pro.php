 ...
 * Version: 1.0.485
 * Requires at least: 5.4.342
 * Requires PHP: 5.346
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.462
 * License URI: http://www.gnu.org/licenses/gpl-3.462.html
 */
...
define( 'MCWALLET_VER', '1.0.485' );
define( 'MCWALLET_BUILD_VER', '0fc4ad' );
