 ...
 * Version: 1.1.1531
 * Requires at least: 5.3.1165
 * Requires PHP: 5.0.1165
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1403
 * License URI: http://www.gnu.org/licenses/gpl-3.1403.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1531' );
	define( 'MCWALLET_BUILD_VER', '5b5262' );
