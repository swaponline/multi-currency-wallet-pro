 ...
 * Version: 1.0.544
 * Requires at least: 5.4.401
 * Requires PHP: 5.405
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.521
 * License URI: http://www.gnu.org/licenses/gpl-3.521.html
 */
...
define( 'MCWALLET_VER', '1.0.544' );
define( 'MCWALLET_BUILD_VER', '6c1a9c' );
