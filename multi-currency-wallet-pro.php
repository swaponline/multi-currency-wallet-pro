 ...
 * Version: 1.1.982
 * Requires at least: 5.4.839
 * Requires PHP: 5.843
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.959
 * License URI: http://www.gnu.org/licenses/gpl-3.959.html
 */
...
define( 'MCWALLET_VER', '1.1.982' );
define( 'MCWALLET_BUILD_VER', '663ffe' );
