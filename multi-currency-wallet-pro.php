 ...
 * Version: 1.0.266
 * Requires at least: 5.4.123
 * Requires PHP: 5.127
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.243
 * License URI: http://www.gnu.org/licenses/gpl-3.243.html
 */
...
define( 'MCWALLET_VER', '1.0.266' );
define( 'MCWALLET_BUILD_VER', 'b5cbf6' );
