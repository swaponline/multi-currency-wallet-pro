 ...
 * Version: 1.0.349
 * Requires at least: 5.4.206
 * Requires PHP: 5.210
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.326
 * License URI: http://www.gnu.org/licenses/gpl-3.326.html
 */
...
define( 'MCWALLET_VER', '1.0.349' );
define( 'MCWALLET_BUILD_VER', 'da045f' );
