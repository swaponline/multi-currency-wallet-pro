 ...
 * Version: 1.1.1354
 * Requires at least: 5.3.1091
 * Requires PHP: 5.0.1091
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1229
 * License URI: http://www.gnu.org/licenses/gpl-3.1229.html
 */
...
define( 'MCWALLET_VER', '1.1.1354' );
define( 'MCWALLET_BUILD_VER', '4e16bd' );
