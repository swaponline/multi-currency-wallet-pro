 ...
 * Version: 1.1.882
 * Requires at least: 5.4.739
 * Requires PHP: 5.743
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.859
 * License URI: http://www.gnu.org/licenses/gpl-3.859.html
 */
...
define( 'MCWALLET_VER', '1.1.882' );
define( 'MCWALLET_BUILD_VER', 'e09157' );
