 ...
 * Version: 1.0.535
 * Requires at least: 5.4.392
 * Requires PHP: 5.396
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.512
 * License URI: http://www.gnu.org/licenses/gpl-3.512.html
 */
...
define( 'MCWALLET_VER', '1.0.535' );
define( 'MCWALLET_BUILD_VER', '5081a2' );
