 ...
 * Version: 1.1.944
 * Requires at least: 5.4.801
 * Requires PHP: 5.805
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.921
 * License URI: http://www.gnu.org/licenses/gpl-3.921.html
 */
...
define( 'MCWALLET_VER', '1.1.944' );
define( 'MCWALLET_BUILD_VER', 'fa9300' );
