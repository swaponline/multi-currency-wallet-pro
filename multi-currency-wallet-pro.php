 ...
 * Version: 1.0.461
 * Requires at least: 5.4.318
 * Requires PHP: 5.322
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.438
 * License URI: http://www.gnu.org/licenses/gpl-3.438.html
 */
...
define( 'MCWALLET_VER', '1.0.461' );
define( 'MCWALLET_BUILD_VER', 'af7ba5' );
