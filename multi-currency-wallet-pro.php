 ...
 * Version: 1.0.541
 * Requires at least: 5.4.398
 * Requires PHP: 5.402
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.518
 * License URI: http://www.gnu.org/licenses/gpl-3.518.html
 */
...
define( 'MCWALLET_VER', '1.0.541' );
define( 'MCWALLET_BUILD_VER', '341921' );
