 ...
 * Version: 1.1.795
 * Requires at least: 5.4.652
 * Requires PHP: 5.656
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.772
 * License URI: http://www.gnu.org/licenses/gpl-3.772.html
 */
...
define( 'MCWALLET_VER', '1.1.795' );
define( 'MCWALLET_BUILD_VER', '4b086b' );
