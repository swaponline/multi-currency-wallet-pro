 ...
 * Version: 1.1.1021
 * Requires at least: 5.4.878
 * Requires PHP: 5.882
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.998
 * License URI: http://www.gnu.org/licenses/gpl-3.998.html
 */
...
define( 'MCWALLET_VER', '1.1.1021' );
define( 'MCWALLET_BUILD_VER', 'f417de' );
