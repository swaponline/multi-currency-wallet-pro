 ...
 * Version: 1.1.933
 * Requires at least: 5.4.790
 * Requires PHP: 5.794
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.910
 * License URI: http://www.gnu.org/licenses/gpl-3.910.html
 */
...
define( 'MCWALLET_VER', '1.1.933' );
define( 'MCWALLET_BUILD_VER', '562645' );
