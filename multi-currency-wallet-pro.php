 ...
 * Version: 1.0.480
 * Requires at least: 5.4.337
 * Requires PHP: 5.341
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.457
 * License URI: http://www.gnu.org/licenses/gpl-3.457.html
 */
...
define( 'MCWALLET_VER', '1.0.480' );
define( 'MCWALLET_BUILD_VER', 'd74206' );
