 ...
 * Version: 1.1.858
 * Requires at least: 5.4.715
 * Requires PHP: 5.719
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.835
 * License URI: http://www.gnu.org/licenses/gpl-3.835.html
 */
...
define( 'MCWALLET_VER', '1.1.858' );
define( 'MCWALLET_BUILD_VER', '5bdc0c' );
