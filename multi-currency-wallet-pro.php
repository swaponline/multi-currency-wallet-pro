 ...
 * Version: 1.1.910
 * Requires at least: 5.4.767
 * Requires PHP: 5.771
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.887
 * License URI: http://www.gnu.org/licenses/gpl-3.887.html
 */
...
define( 'MCWALLET_VER', '1.1.910' );
define( 'MCWALLET_BUILD_VER', '7430a6' );
