 ...
 * Version: 1.0.463
 * Requires at least: 5.4.320
 * Requires PHP: 5.324
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.440
 * License URI: http://www.gnu.org/licenses/gpl-3.440.html
 */
...
define( 'MCWALLET_VER', '1.0.463' );
define( 'MCWALLET_BUILD_VER', 'ce7e7b' );
