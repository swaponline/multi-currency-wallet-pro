 ...
 * Version: 1.0.458
 * Requires at least: 5.4.315
 * Requires PHP: 5.319
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.435
 * License URI: http://www.gnu.org/licenses/gpl-3.435.html
 */
...
define( 'MCWALLET_VER', '1.0.458' );
define( 'MCWALLET_BUILD_VER', '49f861' );
