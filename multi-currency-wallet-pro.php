 ...
 * Version: 1.1.1568
 * Requires at least: 5.3.1202
 * Requires PHP: 5.0.1202
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1440
 * License URI: http://www.gnu.org/licenses/gpl-3.1440.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1568' );
	define( 'MCWALLET_BUILD_VER', '71c2f1' );
