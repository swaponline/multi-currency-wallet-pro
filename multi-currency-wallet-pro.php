 ...
 * Version: 1.1.1038
 * Requires at least: 5.4.894
 * Requires PHP: 5.898
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1014
 * License URI: http://www.gnu.org/licenses/gpl-3.1014.html
 */
...
define( 'MCWALLET_VER', '1.1.1038' );
define( 'MCWALLET_BUILD_VER', 'bdb5fe' );
