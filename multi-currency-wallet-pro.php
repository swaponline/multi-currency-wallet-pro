 ...
 * Version: 1.1.914
 * Requires at least: 5.4.771
 * Requires PHP: 5.775
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.891
 * License URI: http://www.gnu.org/licenses/gpl-3.891.html
 */
...
define( 'MCWALLET_VER', '1.1.914' );
define( 'MCWALLET_BUILD_VER', 'd95379' );
