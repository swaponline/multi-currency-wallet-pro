 ...
 * Version: 1.1.857
 * Requires at least: 5.4.714
 * Requires PHP: 5.718
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.834
 * License URI: http://www.gnu.org/licenses/gpl-3.834.html
 */
...
define( 'MCWALLET_VER', '1.1.857' );
define( 'MCWALLET_BUILD_VER', '6ad060' );
