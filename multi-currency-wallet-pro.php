 ...
 * Version: 1.1.668
 * Requires at least: 5.4.525
 * Requires PHP: 5.529
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.645
 * License URI: http://www.gnu.org/licenses/gpl-3.645.html
 */
...
define( 'MCWALLET_VER', '1.1.668' );
define( 'MCWALLET_BUILD_VER', 'a06566' );
