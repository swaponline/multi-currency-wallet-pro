 ...
 * Version: 1.1.912
 * Requires at least: 5.4.769
 * Requires PHP: 5.773
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.889
 * License URI: http://www.gnu.org/licenses/gpl-3.889.html
 */
...
define( 'MCWALLET_VER', '1.1.912' );
define( 'MCWALLET_BUILD_VER', '2c8d1b' );
