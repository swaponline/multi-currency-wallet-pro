 ...
 * Version: 1.1.941
 * Requires at least: 5.4.798
 * Requires PHP: 5.802
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.918
 * License URI: http://www.gnu.org/licenses/gpl-3.918.html
 */
...
define( 'MCWALLET_VER', '1.1.941' );
define( 'MCWALLET_BUILD_VER', '1d361e' );
