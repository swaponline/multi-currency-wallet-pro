 ...
 * Version: 1.1.1005
 * Requires at least: 5.4.862
 * Requires PHP: 5.866
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.982
 * License URI: http://www.gnu.org/licenses/gpl-3.982.html
 */
...
define( 'MCWALLET_VER', '1.1.1005' );
define( 'MCWALLET_BUILD_VER', '552cd7' );
