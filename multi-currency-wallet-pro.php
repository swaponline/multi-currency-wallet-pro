 ...
 * Version: 1.0.610
 * Requires at least: 5.4.467
 * Requires PHP: 5.471
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.587
 * License URI: http://www.gnu.org/licenses/gpl-3.587.html
 */
...
define( 'MCWALLET_VER', '1.0.610' );
define( 'MCWALLET_BUILD_VER', 'f60d4e' );
