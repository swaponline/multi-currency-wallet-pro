 ...
 * Version: 1.0.513
 * Requires at least: 5.4.370
 * Requires PHP: 5.374
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.490
 * License URI: http://www.gnu.org/licenses/gpl-3.490.html
 */
...
define( 'MCWALLET_VER', '1.0.513' );
define( 'MCWALLET_BUILD_VER', '29fcea' );
