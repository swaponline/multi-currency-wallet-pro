 ...
 * Version: 1.1.1571
 * Requires at least: 5.3.1205
 * Requires PHP: 5.0.1205
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1443
 * License URI: http://www.gnu.org/licenses/gpl-3.1443.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1571' );
	define( 'MCWALLET_BUILD_VER', '8c52b2' );
