 ...
 * Version: 1.1.957
 * Requires at least: 5.4.814
 * Requires PHP: 5.818
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.934
 * License URI: http://www.gnu.org/licenses/gpl-3.934.html
 */
...
define( 'MCWALLET_VER', '1.1.957' );
define( 'MCWALLET_BUILD_VER', '370471' );
