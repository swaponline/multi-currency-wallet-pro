 ...
 * Version: 1.1.916
 * Requires at least: 5.4.773
 * Requires PHP: 5.777
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.893
 * License URI: http://www.gnu.org/licenses/gpl-3.893.html
 */
...
define( 'MCWALLET_VER', '1.1.916' );
define( 'MCWALLET_BUILD_VER', '2fb759' );
