 ...
 * Version: 1.1.953
 * Requires at least: 5.4.810
 * Requires PHP: 5.814
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.930
 * License URI: http://www.gnu.org/licenses/gpl-3.930.html
 */
...
define( 'MCWALLET_VER', '1.1.953' );
define( 'MCWALLET_BUILD_VER', '4c876c' );
