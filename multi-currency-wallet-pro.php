 ...
 * Version: 1.1.1276
 * Requires at least: 5.3.1013
 * Requires PHP: 5.0.1013
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1151
 * License URI: http://www.gnu.org/licenses/gpl-3.1151.html
 */
...
define( 'MCWALLET_VER', '1.1.1276' );
define( 'MCWALLET_BUILD_VER', '9d0e10' );
