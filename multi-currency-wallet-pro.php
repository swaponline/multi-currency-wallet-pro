 ...
 * Version: 1.1.891
 * Requires at least: 5.4.748
 * Requires PHP: 5.752
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.868
 * License URI: http://www.gnu.org/licenses/gpl-3.868.html
 */
...
define( 'MCWALLET_VER', '1.1.891' );
define( 'MCWALLET_BUILD_VER', 'bea613' );
