 ...
 * Version: 1.1.878
 * Requires at least: 5.4.735
 * Requires PHP: 5.739
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.855
 * License URI: http://www.gnu.org/licenses/gpl-3.855.html
 */
...
define( 'MCWALLET_VER', '1.1.878' );
define( 'MCWALLET_BUILD_VER', '0e9657' );
