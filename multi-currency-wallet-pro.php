 ...
 * Version: 1.0.444
 * Requires at least: 5.4.301
 * Requires PHP: 5.305
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.421
 * License URI: http://www.gnu.org/licenses/gpl-3.421.html
 */
...
define( 'MCWALLET_VER', '1.0.444' );
define( 'MCWALLET_BUILD_VER', '99195f' );
