 ...
 * Version: 1.1.1548
 * Requires at least: 5.3.1182
 * Requires PHP: 5.0.1182
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1420
 * License URI: http://www.gnu.org/licenses/gpl-3.1420.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1548' );
	define( 'MCWALLET_BUILD_VER', 'e832b9' );
