 ...
 * Version: 1.0.383
 * Requires at least: 5.4.240
 * Requires PHP: 5.244
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.360
 * License URI: http://www.gnu.org/licenses/gpl-3.360.html
 */
...
define( 'MCWALLET_VER', '1.0.383' );
define( 'MCWALLET_BUILD_VER', 'c6555e' );
