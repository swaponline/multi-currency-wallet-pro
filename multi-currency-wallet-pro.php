 ...
 * Version: 1.0.511
 * Requires at least: 5.4.368
 * Requires PHP: 5.372
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.488
 * License URI: http://www.gnu.org/licenses/gpl-3.488.html
 */
...
define( 'MCWALLET_VER', '1.0.511' );
define( 'MCWALLET_BUILD_VER', '398be5' );
