 ...
 * Version: 1.1.1574
 * Requires at least: 5.3.1208
 * Requires PHP: 5.0.1208
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1446
 * License URI: http://www.gnu.org/licenses/gpl-3.1446.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1574' );
	define( 'MCWALLET_BUILD_VER', '514967' );
