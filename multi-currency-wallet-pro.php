 ...
 * Version: 1.1.1550
 * Requires at least: 5.3.1184
 * Requires PHP: 5.0.1184
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1422
 * License URI: http://www.gnu.org/licenses/gpl-3.1422.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1550' );
	define( 'MCWALLET_BUILD_VER', '5c7920' );
