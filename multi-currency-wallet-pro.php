 ...
 * Version: 1.1.758
 * Requires at least: 5.4.615
 * Requires PHP: 5.619
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.735
 * License URI: http://www.gnu.org/licenses/gpl-3.735.html
 */
...
define( 'MCWALLET_VER', '1.1.758' );
define( 'MCWALLET_BUILD_VER', '80e6cf' );
