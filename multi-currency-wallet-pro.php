 ...
 * Version: 1.1.678
 * Requires at least: 5.4.535
 * Requires PHP: 5.539
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.655
 * License URI: http://www.gnu.org/licenses/gpl-3.655.html
 */
...
define( 'MCWALLET_VER', '1.1.678' );
define( 'MCWALLET_BUILD_VER', 'fb73c5' );
