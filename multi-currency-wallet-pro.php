 ...
 * Version: 1.1.1569
 * Requires at least: 5.3.1203
 * Requires PHP: 5.0.1203
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1441
 * License URI: http://www.gnu.org/licenses/gpl-3.1441.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1569' );
	define( 'MCWALLET_BUILD_VER', '6afb8a' );
