 ...
 * Version: 1.0.440
 * Requires at least: 5.4.297
 * Requires PHP: 5.301
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.417
 * License URI: http://www.gnu.org/licenses/gpl-3.417.html
 */
...
define( 'MCWALLET_VER', '1.0.440' );
define( 'MCWALLET_BUILD_VER', 'fb5c19' );
