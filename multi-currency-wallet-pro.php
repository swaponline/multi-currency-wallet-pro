 ...
 * Version: 1.0.622
 * Requires at least: 5.4.479
 * Requires PHP: 5.483
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.599
 * License URI: http://www.gnu.org/licenses/gpl-3.599.html
 */
...
define( 'MCWALLET_VER', '1.0.622' );
define( 'MCWALLET_BUILD_VER', 'ed160a' );
