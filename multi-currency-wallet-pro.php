 ...
 * Version: 1.0.494
 * Requires at least: 5.4.351
 * Requires PHP: 5.355
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.471
 * License URI: http://www.gnu.org/licenses/gpl-3.471.html
 */
...
define( 'MCWALLET_VER', '1.0.494' );
define( 'MCWALLET_BUILD_VER', '9e163a' );
