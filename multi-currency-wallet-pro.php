 ...
 * Version: 1.1.902
 * Requires at least: 5.4.759
 * Requires PHP: 5.763
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.879
 * License URI: http://www.gnu.org/licenses/gpl-3.879.html
 */
...
define( 'MCWALLET_VER', '1.1.902' );
define( 'MCWALLET_BUILD_VER', '6d7d83' );
