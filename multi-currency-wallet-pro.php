 ...
 * Version: 1.1.681
 * Requires at least: 5.4.538
 * Requires PHP: 5.542
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.658
 * License URI: http://www.gnu.org/licenses/gpl-3.658.html
 */
...
define( 'MCWALLET_VER', '1.1.681' );
define( 'MCWALLET_BUILD_VER', '6905de' );
