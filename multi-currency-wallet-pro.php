 ...
 * Version: 1.0.548
 * Requires at least: 5.4.405
 * Requires PHP: 5.409
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.525
 * License URI: http://www.gnu.org/licenses/gpl-3.525.html
 */
...
define( 'MCWALLET_VER', '1.0.548' );
define( 'MCWALLET_BUILD_VER', '5db304' );
