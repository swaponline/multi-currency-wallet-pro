 ...
 * Version: 1.0.479
 * Requires at least: 5.4.336
 * Requires PHP: 5.340
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.456
 * License URI: http://www.gnu.org/licenses/gpl-3.456.html
 */
...
define( 'MCWALLET_VER', '1.0.479' );
define( 'MCWALLET_BUILD_VER', '9e9bce' );
