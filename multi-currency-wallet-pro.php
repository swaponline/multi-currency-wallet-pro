 ...
 * Version: 1.1.873
 * Requires at least: 5.4.730
 * Requires PHP: 5.734
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.850
 * License URI: http://www.gnu.org/licenses/gpl-3.850.html
 */
...
define( 'MCWALLET_VER', '1.1.873' );
define( 'MCWALLET_BUILD_VER', 'ea0994' );
