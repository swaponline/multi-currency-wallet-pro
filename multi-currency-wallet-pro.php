 ...
 * Version: 1.1.1401
 * Requires at least: 5.3.1038
 * Requires PHP: 5.0.1038
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1276
 * License URI: http://www.gnu.org/licenses/gpl-3.1276.html
 */
...
define( 'MCWALLET_VER', '1.1.1401' );
define( 'MCWALLET_BUILD_VER', '6997fb' );
