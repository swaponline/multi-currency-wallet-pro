 ...
 * Version: 1.1.705
 * Requires at least: 5.4.562
 * Requires PHP: 5.566
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.682
 * License URI: http://www.gnu.org/licenses/gpl-3.682.html
 */
...
define( 'MCWALLET_VER', '1.1.705' );
define( 'MCWALLET_BUILD_VER', 'ce7cb4' );
