 ...
 * Version: 1.0.388
 * Requires at least: 5.4.245
 * Requires PHP: 5.249
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.365
 * License URI: http://www.gnu.org/licenses/gpl-3.365.html
 */
...
define( 'MCWALLET_VER', '1.0.388' );
define( 'MCWALLET_BUILD_VER', '5cb3d8' );
