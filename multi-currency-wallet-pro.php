 ...
 * Version: 1.0.319
 * Requires at least: 5.4.176
 * Requires PHP: 5.180
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.296
 * License URI: http://www.gnu.org/licenses/gpl-3.296.html
 */
...
define( 'MCWALLET_VER', '1.0.319' );
define( 'MCWALLET_BUILD_VER', '818272' );
