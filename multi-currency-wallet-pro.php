 ...
 * Version: 1.1.999
 * Requires at least: 5.4.856
 * Requires PHP: 5.860
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.976
 * License URI: http://www.gnu.org/licenses/gpl-3.976.html
 */
...
define( 'MCWALLET_VER', '1.1.999' );
define( 'MCWALLET_BUILD_VER', '011ec3' );
