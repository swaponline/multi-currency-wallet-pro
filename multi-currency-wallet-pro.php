 ...
 * Version: 1.0.470
 * Requires at least: 5.4.327
 * Requires PHP: 5.331
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.447
 * License URI: http://www.gnu.org/licenses/gpl-3.447.html
 */
...
define( 'MCWALLET_VER', '1.0.470' );
define( 'MCWALLET_BUILD_VER', 'd604d8' );
