 ...
 * Version: 1.1.663
 * Requires at least: 5.4.520
 * Requires PHP: 5.524
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.640
 * License URI: http://www.gnu.org/licenses/gpl-3.640.html
 */
...
define( 'MCWALLET_VER', '1.1.663' );
define( 'MCWALLET_BUILD_VER', '7495b3' );
