 ...
 * Version: 1.0.523
 * Requires at least: 5.4.380
 * Requires PHP: 5.384
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.500
 * License URI: http://www.gnu.org/licenses/gpl-3.500.html
 */
...
define( 'MCWALLET_VER', '1.0.523' );
define( 'MCWALLET_BUILD_VER', '6ba3f4' );
