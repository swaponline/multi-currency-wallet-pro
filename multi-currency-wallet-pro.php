 ...
 * Version: 1.0.317
 * Requires at least: 5.4.174
 * Requires PHP: 5.178
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.294
 * License URI: http://www.gnu.org/licenses/gpl-3.294.html
 */
...
define( 'MCWALLET_VER', '1.0.317' );
define( 'MCWALLET_BUILD_VER', '1b1729' );
