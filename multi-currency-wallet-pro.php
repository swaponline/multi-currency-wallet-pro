 ...
 * Version: 1.0.282
 * Requires at least: 5.4.139
 * Requires PHP: 5.143
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.259
 * License URI: http://www.gnu.org/licenses/gpl-3.259.html
 */
...
define( 'MCWALLET_VER', '1.0.282' );
define( 'MCWALLET_BUILD_VER', '202523' );
