 ...
 * Version: 1.1.1212
 * Requires at least: 5.4.968
 * Requires PHP: 5.972
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1088
 * License URI: http://www.gnu.org/licenses/gpl-3.1088.html
 */
...
define( 'MCWALLET_VER', '1.1.1212' );
define( 'MCWALLET_BUILD_VER', 'b54d5c' );
