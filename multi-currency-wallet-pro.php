 ...
 * Version: 1.1.673
 * Requires at least: 5.4.530
 * Requires PHP: 5.534
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.650
 * License URI: http://www.gnu.org/licenses/gpl-3.650.html
 */
...
define( 'MCWALLET_VER', '1.1.673' );
define( 'MCWALLET_BUILD_VER', '161db7' );
