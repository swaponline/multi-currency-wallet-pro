 ...
 * Version: 1.0.363
 * Requires at least: 5.4.220
 * Requires PHP: 5.224
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.340
 * License URI: http://www.gnu.org/licenses/gpl-3.340.html
 */
...
define( 'MCWALLET_VER', '1.0.363' );
define( 'MCWALLET_BUILD_VER', 'deb1e3' );
