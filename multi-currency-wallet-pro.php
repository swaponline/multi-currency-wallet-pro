 ...
 * Version: 1.1.1591
 * Requires at least: 5.3.1225
 * Requires PHP: 5.0.1225
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1463
 * License URI: http://www.gnu.org/licenses/gpl-3.1463.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1591' );
	define( 'MCWALLET_BUILD_VER', '97c0c4' );
