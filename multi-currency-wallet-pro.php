 ...
 * Version: 1.0.520
 * Requires at least: 5.4.377
 * Requires PHP: 5.381
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.497
 * License URI: http://www.gnu.org/licenses/gpl-3.497.html
 */
...
define( 'MCWALLET_VER', '1.0.520' );
define( 'MCWALLET_BUILD_VER', 'aca0cb' );
