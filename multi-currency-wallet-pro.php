 ...
 * Version: 1.1.1405
 * Requires at least: 5.3.1042
 * Requires PHP: 5.0.1042
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1280
 * License URI: http://www.gnu.org/licenses/gpl-3.1280.html
 */
...
define( 'MCWALLET_VER', '1.1.1405' );
define( 'MCWALLET_BUILD_VER', '83eb7b' );
