 ...
 * Version: 1.0.591
 * Requires at least: 5.4.448
 * Requires PHP: 5.452
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.568
 * License URI: http://www.gnu.org/licenses/gpl-3.568.html
 */
...
define( 'MCWALLET_VER', '1.0.591' );
define( 'MCWALLET_BUILD_VER', 'f7ad73' );
