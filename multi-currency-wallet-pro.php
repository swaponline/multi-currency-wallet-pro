 ...
 * Version: 1.0.315
 * Requires at least: 5.4.172
 * Requires PHP: 5.176
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.292
 * License URI: http://www.gnu.org/licenses/gpl-3.292.html
 */
...
define( 'MCWALLET_VER', '1.0.315' );
define( 'MCWALLET_BUILD_VER', '71292c' );
