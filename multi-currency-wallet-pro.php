 ...
 * Version: 1.0.569
 * Requires at least: 5.4.426
 * Requires PHP: 5.430
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.546
 * License URI: http://www.gnu.org/licenses/gpl-3.546.html
 */
...
define( 'MCWALLET_VER', '1.0.569' );
define( 'MCWALLET_BUILD_VER', '207ffd' );
