 ...
 * Version: 1.0.621
 * Requires at least: 5.4.478
 * Requires PHP: 5.482
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.598
 * License URI: http://www.gnu.org/licenses/gpl-3.598.html
 */
...
define( 'MCWALLET_VER', '1.0.621' );
define( 'MCWALLET_BUILD_VER', '5800f6' );
