 ...
 * Version: 1.1.755
 * Requires at least: 5.4.612
 * Requires PHP: 5.616
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.732
 * License URI: http://www.gnu.org/licenses/gpl-3.732.html
 */
...
define( 'MCWALLET_VER', '1.1.755' );
define( 'MCWALLET_BUILD_VER', 'd1af8a' );
