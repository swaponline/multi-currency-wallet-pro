 ...
 * Version: 1.0.565
 * Requires at least: 5.4.422
 * Requires PHP: 5.426
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.542
 * License URI: http://www.gnu.org/licenses/gpl-3.542.html
 */
...
define( 'MCWALLET_VER', '1.0.565' );
define( 'MCWALLET_BUILD_VER', '961ac7' );
