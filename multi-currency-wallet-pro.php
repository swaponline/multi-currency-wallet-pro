 ...
 * Version: 1.1.940
 * Requires at least: 5.4.797
 * Requires PHP: 5.801
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.917
 * License URI: http://www.gnu.org/licenses/gpl-3.917.html
 */
...
define( 'MCWALLET_VER', '1.1.940' );
define( 'MCWALLET_BUILD_VER', '1747ac' );
