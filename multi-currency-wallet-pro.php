 ...
 * Version: 1.0.468
 * Requires at least: 5.4.325
 * Requires PHP: 5.329
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.445
 * License URI: http://www.gnu.org/licenses/gpl-3.445.html
 */
...
define( 'MCWALLET_VER', '1.0.468' );
define( 'MCWALLET_BUILD_VER', '190c6f' );
