 ...
 * Version: 1.0.589
 * Requires at least: 5.4.446
 * Requires PHP: 5.450
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.566
 * License URI: http://www.gnu.org/licenses/gpl-3.566.html
 */
...
define( 'MCWALLET_VER', '1.0.589' );
define( 'MCWALLET_BUILD_VER', 'acc4bb' );
