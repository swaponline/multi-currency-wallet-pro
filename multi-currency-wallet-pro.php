 ...
 * Version: 1.0.522
 * Requires at least: 5.4.379
 * Requires PHP: 5.383
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.499
 * License URI: http://www.gnu.org/licenses/gpl-3.499.html
 */
...
define( 'MCWALLET_VER', '1.0.522' );
define( 'MCWALLET_BUILD_VER', '99636' );
