 ...
 * Version: 1.1.772
 * Requires at least: 5.4.629
 * Requires PHP: 5.633
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.749
 * License URI: http://www.gnu.org/licenses/gpl-3.749.html
 */
...
define( 'MCWALLET_VER', '1.1.772' );
define( 'MCWALLET_BUILD_VER', '85c82b' );
