 ...
 * Version: 1.1.1274
 * Requires at least: 5.3.1011
 * Requires PHP: 5.0.1011
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1149
 * License URI: http://www.gnu.org/licenses/gpl-3.1149.html
 */
...
define( 'MCWALLET_VER', '1.1.1274' );
define( 'MCWALLET_BUILD_VER', '636d1a' );
