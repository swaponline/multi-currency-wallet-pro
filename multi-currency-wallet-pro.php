 ...
 * Version: 1.1.692
 * Requires at least: 5.4.549
 * Requires PHP: 5.553
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.669
 * License URI: http://www.gnu.org/licenses/gpl-3.669.html
 */
...
define( 'MCWALLET_VER', '1.1.692' );
define( 'MCWALLET_BUILD_VER', 'fab3bb' );
