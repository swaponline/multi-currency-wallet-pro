 ...
 * Version: 1.0.611
 * Requires at least: 5.4.468
 * Requires PHP: 5.472
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.588
 * License URI: http://www.gnu.org/licenses/gpl-3.588.html
 */
...
define( 'MCWALLET_VER', '1.0.611' );
define( 'MCWALLET_BUILD_VER', '2c39ef' );
