 ...
 * Version: 1.1.684
 * Requires at least: 5.4.541
 * Requires PHP: 5.545
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.661
 * License URI: http://www.gnu.org/licenses/gpl-3.661.html
 */
...
define( 'MCWALLET_VER', '1.1.684' );
define( 'MCWALLET_BUILD_VER', 'e34e99' );
