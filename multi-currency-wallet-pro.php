 ...
 * Version: 1.1.1178
 * Requires at least: 5.4.938
 * Requires PHP: 5.942
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1058
 * License URI: http://www.gnu.org/licenses/gpl-3.1058.html
 */
...
define( 'MCWALLET_VER', '1.1.1178' );
define( 'MCWALLET_BUILD_VER', 'a36a8c' );
