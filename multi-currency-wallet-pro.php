 ...
 * Version: 1.1.1493
 * Requires at least: 5.3.1129
 * Requires PHP: 5.0.1129
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1367
 * License URI: http://www.gnu.org/licenses/gpl-3.1367.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1493' );
	define( 'MCWALLET_BUILD_VER', 'aef43a' );
