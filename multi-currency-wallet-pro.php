 ...
 * Version: 1.1.1370
 * Requires at least: 5.3.1107
 * Requires PHP: 5.0.1107
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1245
 * License URI: http://www.gnu.org/licenses/gpl-3.1245.html
 */
...
define( 'MCWALLET_VER', '1.1.1370' );
define( 'MCWALLET_BUILD_VER', 'fdf298' );
