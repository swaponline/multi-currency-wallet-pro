 ...
 * Version: 1.1.859
 * Requires at least: 5.4.716
 * Requires PHP: 5.720
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.836
 * License URI: http://www.gnu.org/licenses/gpl-3.836.html
 */
...
define( 'MCWALLET_VER', '1.1.859' );
define( 'MCWALLET_BUILD_VER', 'a2a4a7' );
