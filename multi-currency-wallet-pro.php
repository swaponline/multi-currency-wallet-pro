 ...
 * Version: 1.0.628
 * Requires at least: 5.4.485
 * Requires PHP: 5.489
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.605
 * License URI: http://www.gnu.org/licenses/gpl-3.605.html
 */
...
define( 'MCWALLET_VER', '1.0.628' );
define( 'MCWALLET_BUILD_VER', 'bb7a3a' );
