 ...
 * Version: 1.0.604
 * Requires at least: 5.4.461
 * Requires PHP: 5.465
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.581
 * License URI: http://www.gnu.org/licenses/gpl-3.581.html
 */
...
define( 'MCWALLET_VER', '1.0.604' );
define( 'MCWALLET_BUILD_VER', '332b98' );
