 ...
 * Version: 1.1.714
 * Requires at least: 5.4.571
 * Requires PHP: 5.575
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.691
 * License URI: http://www.gnu.org/licenses/gpl-3.691.html
 */
...
define( 'MCWALLET_VER', '1.1.714' );
define( 'MCWALLET_BUILD_VER', '3cfaac' );
