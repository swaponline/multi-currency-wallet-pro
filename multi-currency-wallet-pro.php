 ...
 * Version: 1.0.475
 * Requires at least: 5.4.332
 * Requires PHP: 5.336
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.452
 * License URI: http://www.gnu.org/licenses/gpl-3.452.html
 */
...
define( 'MCWALLET_VER', '1.0.475' );
define( 'MCWALLET_BUILD_VER', '8592df' );
