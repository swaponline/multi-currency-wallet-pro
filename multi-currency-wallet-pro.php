 ...
 * Version: 1.1.1582
 * Requires at least: 5.3.1216
 * Requires PHP: 5.0.1216
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1454
 * License URI: http://www.gnu.org/licenses/gpl-3.1454.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1582' );
	define( 'MCWALLET_BUILD_VER', '7d0a58' );
