 ...
 * Version: 1.1.1347
 * Requires at least: 5.3.1084
 * Requires PHP: 5.0.1084
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1222
 * License URI: http://www.gnu.org/licenses/gpl-3.1222.html
 */
...
define( 'MCWALLET_VER', '1.1.1347' );
define( 'MCWALLET_BUILD_VER', 'febc30' );
