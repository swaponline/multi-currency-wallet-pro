 ...
 * Version: 1.0.556
 * Requires at least: 5.4.413
 * Requires PHP: 5.417
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.533
 * License URI: http://www.gnu.org/licenses/gpl-3.533.html
 */
...
define( 'MCWALLET_VER', '1.0.556' );
define( 'MCWALLET_BUILD_VER', '56712f' );
