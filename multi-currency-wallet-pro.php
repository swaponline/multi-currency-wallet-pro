 ...
 * Version: 1.0.301
 * Requires at least: 5.4.158
 * Requires PHP: 5.162
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.278
 * License URI: http://www.gnu.org/licenses/gpl-3.278.html
 */
...
define( 'MCWALLET_VER', '1.0.301' );
define( 'MCWALLET_BUILD_VER', 'ca048a' );
