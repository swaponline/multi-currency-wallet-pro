 ...
 * Version: 1.1.965
 * Requires at least: 5.4.822
 * Requires PHP: 5.826
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.942
 * License URI: http://www.gnu.org/licenses/gpl-3.942.html
 */
...
define( 'MCWALLET_VER', '1.1.965' );
define( 'MCWALLET_BUILD_VER', '1175ac' );
