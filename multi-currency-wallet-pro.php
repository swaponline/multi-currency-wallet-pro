 ...
 * Version: 1.0.287
 * Requires at least: 5.4.144
 * Requires PHP: 5.148
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.264
 * License URI: http://www.gnu.org/licenses/gpl-3.264.html
 */
...
define( 'MCWALLET_VER', '1.0.287' );
define( 'MCWALLET_BUILD_VER', '398f1d' );
