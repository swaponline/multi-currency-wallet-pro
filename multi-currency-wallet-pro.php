 ...
 * Version: 1.1.952
 * Requires at least: 5.4.809
 * Requires PHP: 5.813
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.929
 * License URI: http://www.gnu.org/licenses/gpl-3.929.html
 */
...
define( 'MCWALLET_VER', '1.1.952' );
define( 'MCWALLET_BUILD_VER', '183cb5' );
