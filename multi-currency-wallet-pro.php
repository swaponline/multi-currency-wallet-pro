 ...
 * Version: 1.1.823
 * Requires at least: 5.4.680
 * Requires PHP: 5.684
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.800
 * License URI: http://www.gnu.org/licenses/gpl-3.800.html
 */
...
define( 'MCWALLET_VER', '1.1.823' );
define( 'MCWALLET_BUILD_VER', 'c12c32' );
