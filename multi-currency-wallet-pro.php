 ...
 * Version: 1.0.432
 * Requires at least: 5.4.289
 * Requires PHP: 5.293
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.409
 * License URI: http://www.gnu.org/licenses/gpl-3.409.html
 */
...
define( 'MCWALLET_VER', '1.0.432' );
define( 'MCWALLET_BUILD_VER', 'b5724d' );
