 ...
 * Version: 1.0.450
 * Requires at least: 5.4.307
 * Requires PHP: 5.311
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.427
 * License URI: http://www.gnu.org/licenses/gpl-3.427.html
 */
...
define( 'MCWALLET_VER', '1.0.450' );
define( 'MCWALLET_BUILD_VER', '425ef4' );
