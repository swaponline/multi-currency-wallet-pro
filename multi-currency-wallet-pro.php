 ...
 * Version: 1.1.1328
 * Requires at least: 5.3.1065
 * Requires PHP: 5.0.1065
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1203
 * License URI: http://www.gnu.org/licenses/gpl-3.1203.html
 */
...
define( 'MCWALLET_VER', '1.1.1328' );
define( 'MCWALLET_BUILD_VER', 'f54dc1' );
