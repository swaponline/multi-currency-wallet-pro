 ...
 * Version: 1.0.254
 * Requires at least: 5.4.111
 * Requires PHP: 5.115
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.231
 * License URI: http://www.gnu.org/licenses/gpl-3.231.html
 */
...
define( 'MCWALLET_VER', '1.0.254' );
define( 'MCWALLET_BUILD_VER', 'ff82de' );
