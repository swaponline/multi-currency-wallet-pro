 ...
 * Version: 1.1.1433
 * Requires at least: 5.3.1070
 * Requires PHP: 5.0.1070
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1308
 * License URI: http://www.gnu.org/licenses/gpl-3.1308.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1433' );
	define( 'MCWALLET_BUILD_VER', 'd7070a' );
