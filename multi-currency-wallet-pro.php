 ...
 * Version: 1.1.843
 * Requires at least: 5.4.700
 * Requires PHP: 5.704
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.820
 * License URI: http://www.gnu.org/licenses/gpl-3.820.html
 */
...
define( 'MCWALLET_VER', '1.1.843' );
define( 'MCWALLET_BUILD_VER', 'a178bb' );
