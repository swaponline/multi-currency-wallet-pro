 ...
 * Version: 1.1.1003
 * Requires at least: 5.4.860
 * Requires PHP: 5.864
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.980
 * License URI: http://www.gnu.org/licenses/gpl-3.980.html
 */
...
define( 'MCWALLET_VER', '1.1.1003' );
define( 'MCWALLET_BUILD_VER', 'a9dca9' );
