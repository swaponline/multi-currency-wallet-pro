 ...
 * Version: 1.1.664
 * Requires at least: 5.4.521
 * Requires PHP: 5.525
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.641
 * License URI: http://www.gnu.org/licenses/gpl-3.641.html
 */
...
define( 'MCWALLET_VER', '1.1.664' );
define( 'MCWALLET_BUILD_VER', '95e023' );
