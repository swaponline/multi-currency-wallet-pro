 ...
 * Version: 1.1.1340
 * Requires at least: 5.3.1077
 * Requires PHP: 5.0.1077
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1215
 * License URI: http://www.gnu.org/licenses/gpl-3.1215.html
 */
...
define( 'MCWALLET_VER', '1.1.1340' );
define( 'MCWALLET_BUILD_VER', '3596b3' );
