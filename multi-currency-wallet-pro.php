 ...
 * Version: 1.1.792
 * Requires at least: 5.4.649
 * Requires PHP: 5.653
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.769
 * License URI: http://www.gnu.org/licenses/gpl-3.769.html
 */
...
define( 'MCWALLET_VER', '1.1.792' );
define( 'MCWALLET_BUILD_VER', '697c63' );
