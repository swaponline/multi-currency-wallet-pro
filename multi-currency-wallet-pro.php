 ...
 * Version: 1.0.552
 * Requires at least: 5.4.409
 * Requires PHP: 5.413
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.529
 * License URI: http://www.gnu.org/licenses/gpl-3.529.html
 */
...
define( 'MCWALLET_VER', '1.0.552' );
define( 'MCWALLET_BUILD_VER', 'f4f378' );
