 ...
 * Version: 1.1.696
 * Requires at least: 5.4.553
 * Requires PHP: 5.557
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.673
 * License URI: http://www.gnu.org/licenses/gpl-3.673.html
 */
...
define( 'MCWALLET_VER', '1.1.696' );
define( 'MCWALLET_BUILD_VER', '1ef45b' );
