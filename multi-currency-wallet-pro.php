 ...
 * Version: 1.1.1495
 * Requires at least: 5.3.1131
 * Requires PHP: 5.0.1131
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1369
 * License URI: http://www.gnu.org/licenses/gpl-3.1369.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1495' );
	define( 'MCWALLET_BUILD_VER', 'fbae84' );
