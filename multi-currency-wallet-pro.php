 ...
 * Version: 1.0.281
 * Requires at least: 5.4.138
 * Requires PHP: 5.142
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.258
 * License URI: http://www.gnu.org/licenses/gpl-3.258.html
 */
...
define( 'MCWALLET_VER', '1.0.281' );
define( 'MCWALLET_BUILD_VER', 'aa8b2b' );
