 ...
 * Version: 1.1.931
 * Requires at least: 5.4.788
 * Requires PHP: 5.792
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.908
 * License URI: http://www.gnu.org/licenses/gpl-3.908.html
 */
...
define( 'MCWALLET_VER', '1.1.931' );
define( 'MCWALLET_BUILD_VER', 'b7065a' );
