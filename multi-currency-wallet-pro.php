 ...
 * Version: 1.0.413
 * Requires at least: 5.4.270
 * Requires PHP: 5.274
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.390
 * License URI: http://www.gnu.org/licenses/gpl-3.390.html
 */
...
define( 'MCWALLET_VER', '1.0.413' );
define( 'MCWALLET_BUILD_VER', 'a4e4ce' );
