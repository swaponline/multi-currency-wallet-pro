 ...
 * Version: 1.1.1474
 * Requires at least: 5.3.1110
 * Requires PHP: 5.0.1110
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1348
 * License URI: http://www.gnu.org/licenses/gpl-3.1348.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1474' );
	define( 'MCWALLET_BUILD_VER', '1bf6fe' );
