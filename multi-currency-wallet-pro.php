 ...
 * Version: 1.0.507
 * Requires at least: 5.4.364
 * Requires PHP: 5.368
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.484
 * License URI: http://www.gnu.org/licenses/gpl-3.484.html
 */
...
define( 'MCWALLET_VER', '1.0.507' );
define( 'MCWALLET_BUILD_VER', '935570' );
