 ...
 * Version: 1.1.802
 * Requires at least: 5.4.659
 * Requires PHP: 5.663
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.779
 * License URI: http://www.gnu.org/licenses/gpl-3.779.html
 */
...
define( 'MCWALLET_VER', '1.1.802' );
define( 'MCWALLET_BUILD_VER', '50beef' );
