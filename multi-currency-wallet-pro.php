 ...
 * Version: 1.1.1419
 * Requires at least: 5.3.1056
 * Requires PHP: 5.0.1056
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1294
 * License URI: http://www.gnu.org/licenses/gpl-3.1294.html
 */
...
define( 'MCWALLET_VER', '1.1.1419' );
define( 'MCWALLET_BUILD_VER', 'e1ff71' );
