 ...
 * Version: 1.0.623
 * Requires at least: 5.4.480
 * Requires PHP: 5.484
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.600
 * License URI: http://www.gnu.org/licenses/gpl-3.600.html
 */
...
define( 'MCWALLET_VER', '1.0.623' );
define( 'MCWALLET_BUILD_VER', 'b15367' );
