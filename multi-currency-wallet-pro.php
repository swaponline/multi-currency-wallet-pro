 ...
 * Version: 1.1.935
 * Requires at least: 5.4.792
 * Requires PHP: 5.796
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.912
 * License URI: http://www.gnu.org/licenses/gpl-3.912.html
 */
...
define( 'MCWALLET_VER', '1.1.935' );
define( 'MCWALLET_BUILD_VER', 'a93088' );
