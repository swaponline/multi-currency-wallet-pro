 ...
 * Version: 1.0.466
 * Requires at least: 5.4.323
 * Requires PHP: 5.327
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.443
 * License URI: http://www.gnu.org/licenses/gpl-3.443.html
 */
...
define( 'MCWALLET_VER', '1.0.466' );
define( 'MCWALLET_BUILD_VER', '25b60f' );
