 ...
 * Version: 1.0.469
 * Requires at least: 5.4.326
 * Requires PHP: 5.330
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.446
 * License URI: http://www.gnu.org/licenses/gpl-3.446.html
 */
...
define( 'MCWALLET_VER', '1.0.469' );
define( 'MCWALLET_BUILD_VER', '8af442' );
