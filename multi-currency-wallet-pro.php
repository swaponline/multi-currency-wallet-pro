 ...
 * Version: 1.0.300
 * Requires at least: 5.4.157
 * Requires PHP: 5.161
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.277
 * License URI: http://www.gnu.org/licenses/gpl-3.277.html
 */
...
define( 'MCWALLET_VER', '1.0.300' );
define( 'MCWALLET_BUILD_VER', 'db5da0' );
