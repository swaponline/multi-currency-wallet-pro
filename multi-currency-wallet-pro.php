 ...
 * Version: 1.1.691
 * Requires at least: 5.4.548
 * Requires PHP: 5.552
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.668
 * License URI: http://www.gnu.org/licenses/gpl-3.668.html
 */
...
define( 'MCWALLET_VER', '1.1.691' );
define( 'MCWALLET_BUILD_VER', 'b1218b' );
