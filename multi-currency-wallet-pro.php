 ...
 * Version: 1.0.415
 * Requires at least: 5.4.272
 * Requires PHP: 5.276
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.392
 * License URI: http://www.gnu.org/licenses/gpl-3.392.html
 */
...
define( 'MCWALLET_VER', '1.0.415' );
define( 'MCWALLET_BUILD_VER', '5055a4' );
