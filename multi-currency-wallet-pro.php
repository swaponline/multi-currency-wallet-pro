 ...
 * Version: 1.1.1322
 * Requires at least: 5.3.1059
 * Requires PHP: 5.0.1059
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1197
 * License URI: http://www.gnu.org/licenses/gpl-3.1197.html
 */
...
define( 'MCWALLET_VER', '1.1.1322' );
define( 'MCWALLET_BUILD_VER', 'e15b1c' );
