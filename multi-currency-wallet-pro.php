 ...
 * Version: 1.1.874
 * Requires at least: 5.4.731
 * Requires PHP: 5.735
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.851
 * License URI: http://www.gnu.org/licenses/gpl-3.851.html
 */
...
define( 'MCWALLET_VER', '1.1.874' );
define( 'MCWALLET_BUILD_VER', 'bb87b4' );
