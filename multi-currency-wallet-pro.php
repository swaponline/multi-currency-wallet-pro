 ...
 * Version: 1.1.961
 * Requires at least: 5.4.818
 * Requires PHP: 5.822
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.938
 * License URI: http://www.gnu.org/licenses/gpl-3.938.html
 */
...
define( 'MCWALLET_VER', '1.1.961' );
define( 'MCWALLET_BUILD_VER', 'b521bc' );
