 ...
 * Version: 1.1.975
 * Requires at least: 5.4.832
 * Requires PHP: 5.836
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.952
 * License URI: http://www.gnu.org/licenses/gpl-3.952.html
 */
...
define( 'MCWALLET_VER', '1.1.975' );
define( 'MCWALLET_BUILD_VER', 'af2097' );
