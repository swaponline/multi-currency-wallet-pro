 ...
 * Version: 1.0.272
 * Requires at least: 5.4.129
 * Requires PHP: 5.133
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.249
 * License URI: http://www.gnu.org/licenses/gpl-3.249.html
 */
...
define( 'MCWALLET_VER', '1.0.272' );
define( 'MCWALLET_BUILD_VER', 'b58d09' );
