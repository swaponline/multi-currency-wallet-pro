 ...
 * Version: 1.0.304
 * Requires at least: 5.4.161
 * Requires PHP: 5.165
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.281
 * License URI: http://www.gnu.org/licenses/gpl-3.281.html
 */
...
define( 'MCWALLET_VER', '1.0.304' );
define( 'MCWALLET_BUILD_VER', '307c6b' );
