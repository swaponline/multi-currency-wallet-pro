 ...
 * Version: 1.0.279
 * Requires at least: 5.4.136
 * Requires PHP: 5.140
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.256
 * License URI: http://www.gnu.org/licenses/gpl-3.256.html
 */
...
define( 'MCWALLET_VER', '1.0.279' );
define( 'MCWALLET_BUILD_VER', 'f1fbf7' );
