 ...
 * Version: 1.1.746
 * Requires at least: 5.4.603
 * Requires PHP: 5.607
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.723
 * License URI: http://www.gnu.org/licenses/gpl-3.723.html
 */
...
define( 'MCWALLET_VER', '1.1.746' );
define( 'MCWALLET_BUILD_VER', 'c0e387' );
