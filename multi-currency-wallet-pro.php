 ...
 * Version: 1.0.278
 * Requires at least: 5.4.135
 * Requires PHP: 5.139
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.255
 * License URI: http://www.gnu.org/licenses/gpl-3.255.html
 */
...
define( 'MCWALLET_VER', '1.0.278' );
define( 'MCWALLET_BUILD_VER', '4616ac' );
