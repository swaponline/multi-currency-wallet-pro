 ...
 * Version: 1.1.742
 * Requires at least: 5.4.599
 * Requires PHP: 5.603
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.719
 * License URI: http://www.gnu.org/licenses/gpl-3.719.html
 */
...
define( 'MCWALLET_VER', '1.1.742' );
define( 'MCWALLET_BUILD_VER', 'caf412' );
