 ...
 * Version: 1.1.1214
 * Requires at least: 5.4.970
 * Requires PHP: 5.974
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1090
 * License URI: http://www.gnu.org/licenses/gpl-3.1090.html
 */
...
define( 'MCWALLET_VER', '1.1.1214' );
define( 'MCWALLET_BUILD_VER', 'f8c2cd' );
