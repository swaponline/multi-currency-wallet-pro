 ...
 * Version: 1.1.833
 * Requires at least: 5.4.690
 * Requires PHP: 5.694
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.810
 * License URI: http://www.gnu.org/licenses/gpl-3.810.html
 */
...
define( 'MCWALLET_VER', '1.1.833' );
define( 'MCWALLET_BUILD_VER', 'f41fa7' );
