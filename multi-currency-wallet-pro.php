 ...
 * Version: 1.1.757
 * Requires at least: 5.4.614
 * Requires PHP: 5.618
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.734
 * License URI: http://www.gnu.org/licenses/gpl-3.734.html
 */
...
define( 'MCWALLET_VER', '1.1.757' );
define( 'MCWALLET_BUILD_VER', '34d025' );
