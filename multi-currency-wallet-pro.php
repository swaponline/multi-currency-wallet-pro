 ...
 * Version: 1.0.352
 * Requires at least: 5.4.209
 * Requires PHP: 5.213
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.329
 * License URI: http://www.gnu.org/licenses/gpl-3.329.html
 */
...
define( 'MCWALLET_VER', '1.0.352' );
define( 'MCWALLET_BUILD_VER', '700f3e' );
