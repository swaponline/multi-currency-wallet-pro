 ...
 * Version: 1.0.431
 * Requires at least: 5.4.288
 * Requires PHP: 5.292
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.408
 * License URI: http://www.gnu.org/licenses/gpl-3.408.html
 */
...
define( 'MCWALLET_VER', '1.0.431' );
define( 'MCWALLET_BUILD_VER', 'e83cc2' );
