 ...
 * Version: 1.0.452
 * Requires at least: 5.4.309
 * Requires PHP: 5.313
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.429
 * License URI: http://www.gnu.org/licenses/gpl-3.429.html
 */
...
define( 'MCWALLET_VER', '1.0.452' );
define( 'MCWALLET_BUILD_VER', '827b16' );
