 ...
 * Version: 1.1.697
 * Requires at least: 5.4.554
 * Requires PHP: 5.558
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.674
 * License URI: http://www.gnu.org/licenses/gpl-3.674.html
 */
...
define( 'MCWALLET_VER', '1.1.697' );
define( 'MCWALLET_BUILD_VER', '4b1d4a' );
