 ...
 * Version: 1.1.718
 * Requires at least: 5.4.575
 * Requires PHP: 5.579
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.695
 * License URI: http://www.gnu.org/licenses/gpl-3.695.html
 */
...
define( 'MCWALLET_VER', '1.1.718' );
define( 'MCWALLET_BUILD_VER', '745456' );
