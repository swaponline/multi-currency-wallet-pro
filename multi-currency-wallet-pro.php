 ...
 * Version: 1.1.885
 * Requires at least: 5.4.742
 * Requires PHP: 5.746
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.862
 * License URI: http://www.gnu.org/licenses/gpl-3.862.html
 */
...
define( 'MCWALLET_VER', '1.1.885' );
define( 'MCWALLET_BUILD_VER', '98c488' );
