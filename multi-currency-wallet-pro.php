 ...
 * Version: 1.1.958
 * Requires at least: 5.4.815
 * Requires PHP: 5.819
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.935
 * License URI: http://www.gnu.org/licenses/gpl-3.935.html
 */
...
define( 'MCWALLET_VER', '1.1.958' );
define( 'MCWALLET_BUILD_VER', 'd58efa' );
