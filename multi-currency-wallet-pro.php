 ...
 * Version: 1.0.498
 * Requires at least: 5.4.355
 * Requires PHP: 5.359
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.475
 * License URI: http://www.gnu.org/licenses/gpl-3.475.html
 */
...
define( 'MCWALLET_VER', '1.0.498' );
define( 'MCWALLET_BUILD_VER', '3e6e34' );
