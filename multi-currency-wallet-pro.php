 ...
 * Version: 1.1.1520
 * Requires at least: 5.3.1156
 * Requires PHP: 5.0.1156
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1394
 * License URI: http://www.gnu.org/licenses/gpl-3.1394.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1520' );
	define( 'MCWALLET_BUILD_VER', '62b4bc' );
