 ...
 * Version: 1.0.344
 * Requires at least: 5.4.201
 * Requires PHP: 5.205
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.321
 * License URI: http://www.gnu.org/licenses/gpl-3.321.html
 */
...
define( 'MCWALLET_VER', '1.0.344' );
define( 'MCWALLET_BUILD_VER', 'c2cd7d' );
