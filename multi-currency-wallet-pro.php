 ...
 * Version: 1.1.1235
 * Requires at least: 5.4.990
 * Requires PHP: 5.994
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1110
 * License URI: http://www.gnu.org/licenses/gpl-3.1110.html
 */
...
define( 'MCWALLET_VER', '1.1.1235' );
define( 'MCWALLET_BUILD_VER', '04f1e1' );
