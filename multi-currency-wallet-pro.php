 ...
 * Version: 1.1.717
 * Requires at least: 5.4.574
 * Requires PHP: 5.578
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.694
 * License URI: http://www.gnu.org/licenses/gpl-3.694.html
 */
...
define( 'MCWALLET_VER', '1.1.717' );
define( 'MCWALLET_BUILD_VER', '51abe9' );
