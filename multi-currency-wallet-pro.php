 ...
 * Version: 1.0.367
 * Requires at least: 5.4.224
 * Requires PHP: 5.228
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.344
 * License URI: http://www.gnu.org/licenses/gpl-3.344.html
 */
...
define( 'MCWALLET_VER', '1.0.367' );
define( 'MCWALLET_BUILD_VER', 'e3387e' );
