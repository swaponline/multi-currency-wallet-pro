 ...
 * Version: 1.0.549
 * Requires at least: 5.4.406
 * Requires PHP: 5.410
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.526
 * License URI: http://www.gnu.org/licenses/gpl-3.526.html
 */
...
define( 'MCWALLET_VER', '1.0.549' );
define( 'MCWALLET_BUILD_VER', '7046a9' );
