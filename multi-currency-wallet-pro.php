 ...
 * Version: 1.0.456
 * Requires at least: 5.4.313
 * Requires PHP: 5.317
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.433
 * License URI: http://www.gnu.org/licenses/gpl-3.433.html
 */
...
define( 'MCWALLET_VER', '1.0.456' );
define( 'MCWALLET_BUILD_VER', 'd722b6' );
