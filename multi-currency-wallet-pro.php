 ...
 * Version: 1.0.430
 * Requires at least: 5.4.287
 * Requires PHP: 5.291
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.407
 * License URI: http://www.gnu.org/licenses/gpl-3.407.html
 */
...
define( 'MCWALLET_VER', '1.0.430' );
define( 'MCWALLET_BUILD_VER', '916ce0' );
