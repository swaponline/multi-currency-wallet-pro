 ...
 * Version: 1.1.1476
 * Requires at least: 5.3.1112
 * Requires PHP: 5.0.1112
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1350
 * License URI: http://www.gnu.org/licenses/gpl-3.1350.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1476' );
	define( 'MCWALLET_BUILD_VER', 'e1a6e2' );
