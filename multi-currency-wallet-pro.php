 ...
 * Version: 1.1.815
 * Requires at least: 5.4.672
 * Requires PHP: 5.676
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.792
 * License URI: http://www.gnu.org/licenses/gpl-3.792.html
 */
...
define( 'MCWALLET_VER', '1.1.815' );
define( 'MCWALLET_BUILD_VER', '5d9fdf' );
