 ...
 * Version: 1.0.521
 * Requires at least: 5.4.378
 * Requires PHP: 5.382
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.498
 * License URI: http://www.gnu.org/licenses/gpl-3.498.html
 */
...
define( 'MCWALLET_VER', '1.0.521' );
define( 'MCWALLET_BUILD_VER', 'de2ea4' );
