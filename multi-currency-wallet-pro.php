 ...
 * Version: 1.0.570
 * Requires at least: 5.4.427
 * Requires PHP: 5.431
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.547
 * License URI: http://www.gnu.org/licenses/gpl-3.547.html
 */
...
define( 'MCWALLET_VER', '1.0.570' );
define( 'MCWALLET_BUILD_VER', '9b7a73' );
