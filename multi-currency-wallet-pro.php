 ...
 * Version: 1.0.596
 * Requires at least: 5.4.453
 * Requires PHP: 5.457
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.573
 * License URI: http://www.gnu.org/licenses/gpl-3.573.html
 */
...
define( 'MCWALLET_VER', '1.0.596' );
define( 'MCWALLET_BUILD_VER', '022a9c' );
