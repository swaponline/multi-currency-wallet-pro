 ...
 * Version: 1.0.564
 * Requires at least: 5.4.421
 * Requires PHP: 5.425
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.541
 * License URI: http://www.gnu.org/licenses/gpl-3.541.html
 */
...
define( 'MCWALLET_VER', '1.0.564' );
define( 'MCWALLET_BUILD_VER', '9fb1fb' );
