 ...
 * Version: 1.1.842
 * Requires at least: 5.4.699
 * Requires PHP: 5.703
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.819
 * License URI: http://www.gnu.org/licenses/gpl-3.819.html
 */
...
define( 'MCWALLET_VER', '1.1.842' );
define( 'MCWALLET_BUILD_VER', '129616' );
