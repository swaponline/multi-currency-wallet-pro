 ...
 * Version: 1.0.476
 * Requires at least: 5.4.333
 * Requires PHP: 5.337
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.453
 * License URI: http://www.gnu.org/licenses/gpl-3.453.html
 */
...
define( 'MCWALLET_VER', '1.0.476' );
define( 'MCWALLET_BUILD_VER', '66a8a3' );
