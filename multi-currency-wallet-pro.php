 ...
 * Version: 1.0.382
 * Requires at least: 5.4.239
 * Requires PHP: 5.243
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.359
 * License URI: http://www.gnu.org/licenses/gpl-3.359.html
 */
...
define( 'MCWALLET_VER', '1.0.382' );
define( 'MCWALLET_BUILD_VER', 'c278cf' );
