 ...
 * Version: 1.1.760
 * Requires at least: 5.4.617
 * Requires PHP: 5.621
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.737
 * License URI: http://www.gnu.org/licenses/gpl-3.737.html
 */
...
define( 'MCWALLET_VER', '1.1.760' );
define( 'MCWALLET_BUILD_VER', '169737' );
