 ...
 * Version: 1.1.751
 * Requires at least: 5.4.608
 * Requires PHP: 5.612
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.728
 * License URI: http://www.gnu.org/licenses/gpl-3.728.html
 */
...
define( 'MCWALLET_VER', '1.1.751' );
define( 'MCWALLET_BUILD_VER', 'd07db0' );
