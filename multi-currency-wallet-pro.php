 ...
 * Version: 1.1.1306
 * Requires at least: 5.3.1043
 * Requires PHP: 5.0.1043
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1181
 * License URI: http://www.gnu.org/licenses/gpl-3.1181.html
 */
...
define( 'MCWALLET_VER', '1.1.1306' );
define( 'MCWALLET_BUILD_VER', '1416fb' );
