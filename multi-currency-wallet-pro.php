 ...
 * Version: 1.1.756
 * Requires at least: 5.4.613
 * Requires PHP: 5.617
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.733
 * License URI: http://www.gnu.org/licenses/gpl-3.733.html
 */
...
define( 'MCWALLET_VER', '1.1.756' );
define( 'MCWALLET_BUILD_VER', '1e65ba' );
