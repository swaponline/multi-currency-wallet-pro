 ...
 * Version: 1.0.537
 * Requires at least: 5.4.394
 * Requires PHP: 5.398
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.514
 * License URI: http://www.gnu.org/licenses/gpl-3.514.html
 */
...
define( 'MCWALLET_VER', '1.0.537' );
define( 'MCWALLET_BUILD_VER', '88d18d' );
