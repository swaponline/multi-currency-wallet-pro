 ...
 * Version: 1.0.379
 * Requires at least: 5.4.236
 * Requires PHP: 5.240
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.356
 * License URI: http://www.gnu.org/licenses/gpl-3.356.html
 */
...
define( 'MCWALLET_VER', '1.0.379' );
define( 'MCWALLET_BUILD_VER', 'ff2c7e' );
