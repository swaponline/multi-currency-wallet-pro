 ...
 * Version: 1.0.307
 * Requires at least: 5.4.164
 * Requires PHP: 5.168
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.284
 * License URI: http://www.gnu.org/licenses/gpl-3.284.html
 */
...
define( 'MCWALLET_VER', '1.0.307' );
define( 'MCWALLET_BUILD_VER', '832678' );
