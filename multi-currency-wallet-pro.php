 ...
 * Version: 1.1.731
 * Requires at least: 5.4.588
 * Requires PHP: 5.592
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.708
 * License URI: http://www.gnu.org/licenses/gpl-3.708.html
 */
...
define( 'MCWALLET_VER', '1.1.731' );
define( 'MCWALLET_BUILD_VER', 'bc2760' );
