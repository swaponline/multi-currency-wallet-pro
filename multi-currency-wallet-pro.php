 ...
 * Version: 1.0.472
 * Requires at least: 5.4.329
 * Requires PHP: 5.333
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.449
 * License URI: http://www.gnu.org/licenses/gpl-3.449.html
 */
...
define( 'MCWALLET_VER', '1.0.472' );
define( 'MCWALLET_BUILD_VER', '634ccf' );
