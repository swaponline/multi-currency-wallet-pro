 ...
 * Version: 1.1.1506
 * Requires at least: 5.3.1142
 * Requires PHP: 5.0.1142
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1380
 * License URI: http://www.gnu.org/licenses/gpl-3.1380.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1506' );
	define( 'MCWALLET_BUILD_VER', '644776' );
