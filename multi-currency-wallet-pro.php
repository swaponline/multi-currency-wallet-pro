 ...
 * Version: 1.0.385
 * Requires at least: 5.4.242
 * Requires PHP: 5.246
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.362
 * License URI: http://www.gnu.org/licenses/gpl-3.362.html
 */
...
define( 'MCWALLET_VER', '1.0.385' );
define( 'MCWALLET_BUILD_VER', 'ccbb10' );
