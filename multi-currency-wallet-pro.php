 ...
 * Version: 1.1.724
 * Requires at least: 5.4.581
 * Requires PHP: 5.585
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.701
 * License URI: http://www.gnu.org/licenses/gpl-3.701.html
 */
...
define( 'MCWALLET_VER', '1.1.724' );
define( 'MCWALLET_BUILD_VER', '0000e9' );
