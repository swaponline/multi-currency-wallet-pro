 ...
 * Version: 1.1.871
 * Requires at least: 5.4.728
 * Requires PHP: 5.732
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.848
 * License URI: http://www.gnu.org/licenses/gpl-3.848.html
 */
...
define( 'MCWALLET_VER', '1.1.871' );
define( 'MCWALLET_BUILD_VER', '742dd4' );
