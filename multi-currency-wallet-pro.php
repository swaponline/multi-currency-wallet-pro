 ...
 * Version: 1.1.1407
 * Requires at least: 5.3.1044
 * Requires PHP: 5.0.1044
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1282
 * License URI: http://www.gnu.org/licenses/gpl-3.1282.html
 */
...
define( 'MCWALLET_VER', '1.1.1407' );
define( 'MCWALLET_BUILD_VER', 'edda09' );
