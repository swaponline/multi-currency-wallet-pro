 ...
 * Version: 1.0.602
 * Requires at least: 5.4.459
 * Requires PHP: 5.463
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.579
 * License URI: http://www.gnu.org/licenses/gpl-3.579.html
 */
...
define( 'MCWALLET_VER', '1.0.602' );
define( 'MCWALLET_BUILD_VER', 'd49d53' );
