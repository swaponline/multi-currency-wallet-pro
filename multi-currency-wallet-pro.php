 ...
 * Version: 1.1.983
 * Requires at least: 5.4.840
 * Requires PHP: 5.844
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.960
 * License URI: http://www.gnu.org/licenses/gpl-3.960.html
 */
...
define( 'MCWALLET_VER', '1.1.983' );
define( 'MCWALLET_BUILD_VER', '699930' );
