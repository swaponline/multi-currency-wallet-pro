 ...
 * Version: 1.1.964
 * Requires at least: 5.4.821
 * Requires PHP: 5.825
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.941
 * License URI: http://www.gnu.org/licenses/gpl-3.941.html
 */
...
define( 'MCWALLET_VER', '1.1.964' );
define( 'MCWALLET_BUILD_VER', 'c3edff' );
