 ...
 * Version: 1.1.1587
 * Requires at least: 5.3.1221
 * Requires PHP: 5.0.1221
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1459
 * License URI: http://www.gnu.org/licenses/gpl-3.1459.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1587' );
	define( 'MCWALLET_BUILD_VER', '698a6c' );
