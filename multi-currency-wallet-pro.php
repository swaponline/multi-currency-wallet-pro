 ...
 * Version: 1.1.926
 * Requires at least: 5.4.783
 * Requires PHP: 5.787
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.903
 * License URI: http://www.gnu.org/licenses/gpl-3.903.html
 */
...
define( 'MCWALLET_VER', '1.1.926' );
define( 'MCWALLET_BUILD_VER', 'dbf803' );
