 ...
 * Version: 1.0.559
 * Requires at least: 5.4.416
 * Requires PHP: 5.420
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.536
 * License URI: http://www.gnu.org/licenses/gpl-3.536.html
 */
...
define( 'MCWALLET_VER', '1.0.559' );
define( 'MCWALLET_BUILD_VER', '5695f4' );
