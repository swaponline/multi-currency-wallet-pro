 ...
 * Version: 1.1.782
 * Requires at least: 5.4.639
 * Requires PHP: 5.643
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.759
 * License URI: http://www.gnu.org/licenses/gpl-3.759.html
 */
...
define( 'MCWALLET_VER', '1.1.782' );
define( 'MCWALLET_BUILD_VER', 'e010e7' );
