 ...
 * Version: 1.0.634
 * Requires at least: 5.4.491
 * Requires PHP: 5.495
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.611
 * License URI: http://www.gnu.org/licenses/gpl-3.611.html
 */
...
define( 'MCWALLET_VER', '1.0.634' );
define( 'MCWALLET_BUILD_VER', '526cc8' );
