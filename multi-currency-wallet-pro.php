 ...
 * Version: 1.1.669
 * Requires at least: 5.4.526
 * Requires PHP: 5.530
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.646
 * License URI: http://www.gnu.org/licenses/gpl-3.646.html
 */
...
define( 'MCWALLET_VER', '1.1.669' );
define( 'MCWALLET_BUILD_VER', '5527c2' );
