 ...
 * Version: 1.1.1514
 * Requires at least: 5.3.1150
 * Requires PHP: 5.0.1150
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1388
 * License URI: http://www.gnu.org/licenses/gpl-3.1388.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1514' );
	define( 'MCWALLET_BUILD_VER', '805b4e' );
