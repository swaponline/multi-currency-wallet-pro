 ...
 * Version: 1.0.387
 * Requires at least: 5.4.244
 * Requires PHP: 5.248
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.364
 * License URI: http://www.gnu.org/licenses/gpl-3.364.html
 */
...
define( 'MCWALLET_VER', '1.0.387' );
define( 'MCWALLET_BUILD_VER', '70eb1e' );
