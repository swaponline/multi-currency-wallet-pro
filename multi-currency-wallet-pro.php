 ...
 * Version: 1.0.258
 * Requires at least: 5.4.115
 * Requires PHP: 5.119
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.235
 * License URI: http://www.gnu.org/licenses/gpl-3.235.html
 */
...
define( 'MCWALLET_VER', '1.0.258' );
define( 'MCWALLET_BUILD_VER', '13ace6' );
