 ...
 * Version: 1.1.990
 * Requires at least: 5.4.847
 * Requires PHP: 5.851
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.967
 * License URI: http://www.gnu.org/licenses/gpl-3.967.html
 */
...
define( 'MCWALLET_VER', '1.1.990' );
define( 'MCWALLET_BUILD_VER', 'eb4301' );
