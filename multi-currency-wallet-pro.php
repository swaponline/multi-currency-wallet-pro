 ...
 * Version: 1.0.583
 * Requires at least: 5.4.440
 * Requires PHP: 5.444
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.560
 * License URI: http://www.gnu.org/licenses/gpl-3.560.html
 */
...
define( 'MCWALLET_VER', '1.0.583' );
define( 'MCWALLET_BUILD_VER', '845870' );
