 ...
 * Version: 1.0.632
 * Requires at least: 5.4.489
 * Requires PHP: 5.493
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.609
 * License URI: http://www.gnu.org/licenses/gpl-3.609.html
 */
...
define( 'MCWALLET_VER', '1.0.632' );
define( 'MCWALLET_BUILD_VER', 'c27445' );
