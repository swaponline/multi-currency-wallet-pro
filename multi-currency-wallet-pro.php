 ...
 * Version: 1.0.488
 * Requires at least: 5.4.345
 * Requires PHP: 5.349
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.465
 * License URI: http://www.gnu.org/licenses/gpl-3.465.html
 */
...
define( 'MCWALLET_VER', '1.0.488' );
define( 'MCWALLET_BUILD_VER', '92d784' );
