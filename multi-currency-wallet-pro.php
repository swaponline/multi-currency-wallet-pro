 ...
 * Version: 1.1.814
 * Requires at least: 5.4.671
 * Requires PHP: 5.675
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.791
 * License URI: http://www.gnu.org/licenses/gpl-3.791.html
 */
...
define( 'MCWALLET_VER', '1.1.814' );
define( 'MCWALLET_BUILD_VER', '28b8f7' );
