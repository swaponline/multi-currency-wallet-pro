 ...
 * Version: 1.0.568
 * Requires at least: 5.4.425
 * Requires PHP: 5.429
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.545
 * License URI: http://www.gnu.org/licenses/gpl-3.545.html
 */
...
define( 'MCWALLET_VER', '1.0.568' );
define( 'MCWALLET_BUILD_VER', 'dd3c1c' );
