 ...
 * Version: 1.1.921
 * Requires at least: 5.4.778
 * Requires PHP: 5.782
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.898
 * License URI: http://www.gnu.org/licenses/gpl-3.898.html
 */
...
define( 'MCWALLET_VER', '1.1.921' );
define( 'MCWALLET_BUILD_VER', '8c1d92' );
