 ...
 * Version: 1.1.1564
 * Requires at least: 5.3.1198
 * Requires PHP: 5.0.1198
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1436
 * License URI: http://www.gnu.org/licenses/gpl-3.1436.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1564' );
	define( 'MCWALLET_BUILD_VER', '65f85b' );
