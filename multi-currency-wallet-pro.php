 ...
 * Version: 1.1.969
 * Requires at least: 5.4.826
 * Requires PHP: 5.830
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.946
 * License URI: http://www.gnu.org/licenses/gpl-3.946.html
 */
...
define( 'MCWALLET_VER', '1.1.969' );
define( 'MCWALLET_BUILD_VER', '45d996' );
