 ...
 * Version: 1.1.1267
 * Requires at least: 5.3.1004
 * Requires PHP: 5.0.1004
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1142
 * License URI: http://www.gnu.org/licenses/gpl-3.1142.html
 */
...
define( 'MCWALLET_VER', '1.1.1267' );
define( 'MCWALLET_BUILD_VER', '6a8aa1' );
