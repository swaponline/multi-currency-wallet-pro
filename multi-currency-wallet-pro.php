 ...
 * Version: 1.0.651
 * Requires at least: 5.4.508
 * Requires PHP: 5.512
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.628
 * License URI: http://www.gnu.org/licenses/gpl-3.628.html
 */
...
define( 'MCWALLET_VER', '1.0.651' );
define( 'MCWALLET_BUILD_VER', 'c3042a' );
