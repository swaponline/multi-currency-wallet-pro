 ...
 * Version: 1.1.1396
 * Requires at least: 5.3.1033
 * Requires PHP: 5.0.1033
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1271
 * License URI: http://www.gnu.org/licenses/gpl-3.1271.html
 */
...
define( 'MCWALLET_VER', '1.1.1396' );
define( 'MCWALLET_BUILD_VER', 'c3500d' );
