 ...
 * Version: 1.1.805
 * Requires at least: 5.4.662
 * Requires PHP: 5.666
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.782
 * License URI: http://www.gnu.org/licenses/gpl-3.782.html
 */
...
define( 'MCWALLET_VER', '1.1.805' );
define( 'MCWALLET_BUILD_VER', 'a2d0c9' );
