 ...
 * Version: 1.1.919
 * Requires at least: 5.4.776
 * Requires PHP: 5.780
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.896
 * License URI: http://www.gnu.org/licenses/gpl-3.896.html
 */
...
define( 'MCWALLET_VER', '1.1.919' );
define( 'MCWALLET_BUILD_VER', '84c5ea' );
