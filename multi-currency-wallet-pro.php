 ...
 * Version: 1.1.658
 * Requires at least: 5.4.515
 * Requires PHP: 5.519
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.635
 * License URI: http://www.gnu.org/licenses/gpl-3.635.html
 */
...
define( 'MCWALLET_VER', '1.1.658' );
define( 'MCWALLET_BUILD_VER', 'd5757c' );
