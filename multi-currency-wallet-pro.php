 ...
 * Version: 1.0.646
 * Requires at least: 5.4.503
 * Requires PHP: 5.507
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.623
 * License URI: http://www.gnu.org/licenses/gpl-3.623.html
 */
...
define( 'MCWALLET_VER', '1.0.646' );
define( 'MCWALLET_BUILD_VER', '784077' );
