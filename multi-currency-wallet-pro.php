 ...
 * Version: 1.0.348
 * Requires at least: 5.4.205
 * Requires PHP: 5.209
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.325
 * License URI: http://www.gnu.org/licenses/gpl-3.325.html
 */
...
define( 'MCWALLET_VER', '1.0.348' );
define( 'MCWALLET_BUILD_VER', 'dd35ff' );
