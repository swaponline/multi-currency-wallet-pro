 ...
 * Version: 1.0.620
 * Requires at least: 5.4.477
 * Requires PHP: 5.481
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.597
 * License URI: http://www.gnu.org/licenses/gpl-3.597.html
 */
...
define( 'MCWALLET_VER', '1.0.620' );
define( 'MCWALLET_BUILD_VER', 'b00782' );
