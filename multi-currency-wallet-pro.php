 ...
 * Version: 1.0.500
 * Requires at least: 5.4.357
 * Requires PHP: 5.361
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.477
 * License URI: http://www.gnu.org/licenses/gpl-3.477.html
 */
...
define( 'MCWALLET_VER', '1.0.500' );
define( 'MCWALLET_BUILD_VER', 'da4d54' );
