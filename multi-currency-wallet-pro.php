 ...
 * Version: 1.0.572
 * Requires at least: 5.4.429
 * Requires PHP: 5.433
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.549
 * License URI: http://www.gnu.org/licenses/gpl-3.549.html
 */
...
define( 'MCWALLET_VER', '1.0.572' );
define( 'MCWALLET_BUILD_VER', '3c7b2c' );
