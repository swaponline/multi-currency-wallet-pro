 ...
 * Version: 1.1.886
 * Requires at least: 5.4.743
 * Requires PHP: 5.747
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.863
 * License URI: http://www.gnu.org/licenses/gpl-3.863.html
 */
...
define( 'MCWALLET_VER', '1.1.886' );
define( 'MCWALLET_BUILD_VER', '2b3c1e' );
