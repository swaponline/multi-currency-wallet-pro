 ...
 * Version: 1.0.514
 * Requires at least: 5.4.371
 * Requires PHP: 5.375
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.491
 * License URI: http://www.gnu.org/licenses/gpl-3.491.html
 */
...
define( 'MCWALLET_VER', '1.0.514' );
define( 'MCWALLET_BUILD_VER', '1ece62' );
