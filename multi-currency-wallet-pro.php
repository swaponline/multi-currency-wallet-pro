 ...
 * Version: 1.1.1540
 * Requires at least: 5.3.1174
 * Requires PHP: 5.0.1174
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1412
 * License URI: http://www.gnu.org/licenses/gpl-3.1412.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1540' );
	define( 'MCWALLET_BUILD_VER', 'c571b2' );
