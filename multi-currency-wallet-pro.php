 ...
 * Version: 1.1.1225
 * Requires at least: 5.4.980
 * Requires PHP: 5.984
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1100
 * License URI: http://www.gnu.org/licenses/gpl-3.1100.html
 */
...
define( 'MCWALLET_VER', '1.1.1225' );
define( 'MCWALLET_BUILD_VER', 'dec944' );
