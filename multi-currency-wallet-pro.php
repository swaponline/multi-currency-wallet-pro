 ...
 * Version: 1.1.827
 * Requires at least: 5.4.684
 * Requires PHP: 5.688
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.804
 * License URI: http://www.gnu.org/licenses/gpl-3.804.html
 */
...
define( 'MCWALLET_VER', '1.1.827' );
define( 'MCWALLET_BUILD_VER', 'ad0b3a' );
