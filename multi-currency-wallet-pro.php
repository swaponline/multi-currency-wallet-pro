 ...
 * Version: 1.1.1552
 * Requires at least: 5.3.1186
 * Requires PHP: 5.0.1186
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1424
 * License URI: http://www.gnu.org/licenses/gpl-3.1424.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1552' );
	define( 'MCWALLET_BUILD_VER', '0578f0' );
