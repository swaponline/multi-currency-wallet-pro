 ...
 * Version: 1.1.725
 * Requires at least: 5.4.582
 * Requires PHP: 5.586
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.702
 * License URI: http://www.gnu.org/licenses/gpl-3.702.html
 */
...
define( 'MCWALLET_VER', '1.1.725' );
define( 'MCWALLET_BUILD_VER', '84a2d9' );
