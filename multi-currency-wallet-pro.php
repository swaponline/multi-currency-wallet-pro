 ...
 * Version: 1.0.574
 * Requires at least: 5.4.431
 * Requires PHP: 5.435
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.551
 * License URI: http://www.gnu.org/licenses/gpl-3.551.html
 */
...
define( 'MCWALLET_VER', '1.0.574' );
define( 'MCWALLET_BUILD_VER', 'b03b1c' );
