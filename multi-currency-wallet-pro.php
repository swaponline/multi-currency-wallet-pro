 ...
 * Version: 1.0.464
 * Requires at least: 5.4.321
 * Requires PHP: 5.325
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.441
 * License URI: http://www.gnu.org/licenses/gpl-3.441.html
 */
...
define( 'MCWALLET_VER', '1.0.464' );
define( 'MCWALLET_BUILD_VER', '7aaefc' );
