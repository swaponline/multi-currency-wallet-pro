 ...
 * Version: 1.0.435
 * Requires at least: 5.4.292
 * Requires PHP: 5.296
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.412
 * License URI: http://www.gnu.org/licenses/gpl-3.412.html
 */
...
define( 'MCWALLET_VER', '1.0.435' );
define( 'MCWALLET_BUILD_VER', '71c240' );
