 ...
 * Version: 1.1.927
 * Requires at least: 5.4.784
 * Requires PHP: 5.788
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.904
 * License URI: http://www.gnu.org/licenses/gpl-3.904.html
 */
...
define( 'MCWALLET_VER', '1.1.927' );
define( 'MCWALLET_BUILD_VER', '41bc3d' );
