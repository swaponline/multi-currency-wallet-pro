 ...
 * Version: 1.1.1051
 * Requires at least: 5.4.907
 * Requires PHP: 5.911
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1027
 * License URI: http://www.gnu.org/licenses/gpl-3.1027.html
 */
...
define( 'MCWALLET_VER', '1.1.1051' );
define( 'MCWALLET_BUILD_VER', 'dfffec' );
