 ...
 * Version: 1.1.809
 * Requires at least: 5.4.666
 * Requires PHP: 5.670
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.786
 * License URI: http://www.gnu.org/licenses/gpl-3.786.html
 */
...
define( 'MCWALLET_VER', '1.1.809' );
define( 'MCWALLET_BUILD_VER', '6d24d9' );
