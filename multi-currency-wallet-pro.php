 ...
 * Version: 1.1.707
 * Requires at least: 5.4.564
 * Requires PHP: 5.568
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.684
 * License URI: http://www.gnu.org/licenses/gpl-3.684.html
 */
...
define( 'MCWALLET_VER', '1.1.707' );
define( 'MCWALLET_BUILD_VER', '21bc42' );
