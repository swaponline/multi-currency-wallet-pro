 ...
 * Version: 1.0.563
 * Requires at least: 5.4.420
 * Requires PHP: 5.424
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.540
 * License URI: http://www.gnu.org/licenses/gpl-3.540.html
 */
...
define( 'MCWALLET_VER', '1.0.563' );
define( 'MCWALLET_BUILD_VER', '23a30b' );
