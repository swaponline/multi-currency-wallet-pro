 ...
 * Version: 1.0.390
 * Requires at least: 5.4.247
 * Requires PHP: 5.251
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.367
 * License URI: http://www.gnu.org/licenses/gpl-3.367.html
 */
...
define( 'MCWALLET_VER', '1.0.390' );
define( 'MCWALLET_BUILD_VER', 'c835a9' );
