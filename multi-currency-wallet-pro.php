 ...
 * Version: 1.1.1567
 * Requires at least: 5.3.1201
 * Requires PHP: 5.0.1201
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1439
 * License URI: http://www.gnu.org/licenses/gpl-3.1439.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1567' );
	define( 'MCWALLET_BUILD_VER', 'dcb8e1' );
