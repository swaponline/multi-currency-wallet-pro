 ...
 * Version: 1.1.1268
 * Requires at least: 5.3.1005
 * Requires PHP: 5.0.1005
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1143
 * License URI: http://www.gnu.org/licenses/gpl-3.1143.html
 */
...
define( 'MCWALLET_VER', '1.1.1268' );
define( 'MCWALLET_BUILD_VER', '9989ff' );
