 ...
 * Version: 1.1.844
 * Requires at least: 5.4.701
 * Requires PHP: 5.705
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.821
 * License URI: http://www.gnu.org/licenses/gpl-3.821.html
 */
...
define( 'MCWALLET_VER', '1.1.844' );
define( 'MCWALLET_BUILD_VER', '0f9af4' );
