 ...
 * Version: 1.1.767
 * Requires at least: 5.4.624
 * Requires PHP: 5.628
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.744
 * License URI: http://www.gnu.org/licenses/gpl-3.744.html
 */
...
define( 'MCWALLET_VER', '1.1.767' );
define( 'MCWALLET_BUILD_VER', '154b09' );
