 ...
 * Version: 1.0.555
 * Requires at least: 5.4.412
 * Requires PHP: 5.416
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.532
 * License URI: http://www.gnu.org/licenses/gpl-3.532.html
 */
...
define( 'MCWALLET_VER', '1.0.555' );
define( 'MCWALLET_BUILD_VER', 'bf764e' );
