 ...
 * Version: 1.1.813
 * Requires at least: 5.4.670
 * Requires PHP: 5.674
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.790
 * License URI: http://www.gnu.org/licenses/gpl-3.790.html
 */
...
define( 'MCWALLET_VER', '1.1.813' );
define( 'MCWALLET_BUILD_VER', '3c99c6' );
