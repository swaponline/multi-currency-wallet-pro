 ...
 * Version: 1.1.943
 * Requires at least: 5.4.800
 * Requires PHP: 5.804
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.920
 * License URI: http://www.gnu.org/licenses/gpl-3.920.html
 */
...
define( 'MCWALLET_VER', '1.1.943' );
define( 'MCWALLET_BUILD_VER', 'acecbf' );
