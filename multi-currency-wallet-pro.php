 ...
 * Version: 1.1.687
 * Requires at least: 5.4.544
 * Requires PHP: 5.548
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.664
 * License URI: http://www.gnu.org/licenses/gpl-3.664.html
 */
...
define( 'MCWALLET_VER', '1.1.687' );
define( 'MCWALLET_BUILD_VER', '572320' );
