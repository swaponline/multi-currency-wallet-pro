 ...
 * Version: 1.1.1227
 * Requires at least: 5.4.982
 * Requires PHP: 5.986
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1102
 * License URI: http://www.gnu.org/licenses/gpl-3.1102.html
 */
...
define( 'MCWALLET_VER', '1.1.1227' );
define( 'MCWALLET_BUILD_VER', 'dd5482' );
