 ...
 * Version: 1.1.1281
 * Requires at least: 5.3.1018
 * Requires PHP: 5.0.1018
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1156
 * License URI: http://www.gnu.org/licenses/gpl-3.1156.html
 */
...
define( 'MCWALLET_VER', '1.1.1281' );
define( 'MCWALLET_BUILD_VER', '1b2e5d' );
