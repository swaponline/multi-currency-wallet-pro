 ...
 * Version: 1.1.1499
 * Requires at least: 5.3.1135
 * Requires PHP: 5.0.1135
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1373
 * License URI: http://www.gnu.org/licenses/gpl-3.1373.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1499' );
	define( 'MCWALLET_BUILD_VER', 'bcbd6f' );
