 ...
 * Version: 1.1.1551
 * Requires at least: 5.3.1185
 * Requires PHP: 5.0.1185
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1423
 * License URI: http://www.gnu.org/licenses/gpl-3.1423.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1551' );
	define( 'MCWALLET_BUILD_VER', '408dc3' );
