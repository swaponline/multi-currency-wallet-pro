 ...
 * Version: 1.1.925
 * Requires at least: 5.4.782
 * Requires PHP: 5.786
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.902
 * License URI: http://www.gnu.org/licenses/gpl-3.902.html
 */
...
define( 'MCWALLET_VER', '1.1.925' );
define( 'MCWALLET_BUILD_VER', 'c9b501' );
