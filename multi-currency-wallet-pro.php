 ...
 * Version: 1.1.721
 * Requires at least: 5.4.578
 * Requires PHP: 5.582
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.698
 * License URI: http://www.gnu.org/licenses/gpl-3.698.html
 */
...
define( 'MCWALLET_VER', '1.1.721' );
define( 'MCWALLET_BUILD_VER', 'f18b02' );
