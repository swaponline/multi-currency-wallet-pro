 ...
 * Version: 1.0.543
 * Requires at least: 5.4.400
 * Requires PHP: 5.404
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.520
 * License URI: http://www.gnu.org/licenses/gpl-3.520.html
 */
...
define( 'MCWALLET_VER', '1.0.543' );
define( 'MCWALLET_BUILD_VER', 'f479a5' );
