 ...
 * Version: 1.1.905
 * Requires at least: 5.4.762
 * Requires PHP: 5.766
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.882
 * License URI: http://www.gnu.org/licenses/gpl-3.882.html
 */
...
define( 'MCWALLET_VER', '1.1.905' );
define( 'MCWALLET_BUILD_VER', 'fc3551' );
