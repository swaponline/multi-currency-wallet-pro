 ...
 * Version: 1.0.627
 * Requires at least: 5.4.484
 * Requires PHP: 5.488
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.604
 * License URI: http://www.gnu.org/licenses/gpl-3.604.html
 */
...
define( 'MCWALLET_VER', '1.0.627' );
define( 'MCWALLET_BUILD_VER', 'ddf27c' );
