 ...
 * Version: 1.1.962
 * Requires at least: 5.4.819
 * Requires PHP: 5.823
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.939
 * License URI: http://www.gnu.org/licenses/gpl-3.939.html
 */
...
define( 'MCWALLET_VER', '1.1.962' );
define( 'MCWALLET_BUILD_VER', '84f7f8' );
