 ...
 * Version: 1.1.810
 * Requires at least: 5.4.667
 * Requires PHP: 5.671
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.787
 * License URI: http://www.gnu.org/licenses/gpl-3.787.html
 */
...
define( 'MCWALLET_VER', '1.1.810' );
define( 'MCWALLET_BUILD_VER', '56f532' );
