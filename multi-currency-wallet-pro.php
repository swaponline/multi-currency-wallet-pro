 ...
 * Version: 1.0.320
 * Requires at least: 5.4.177
 * Requires PHP: 5.181
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.297
 * License URI: http://www.gnu.org/licenses/gpl-3.297.html
 */
...
define( 'MCWALLET_VER', '1.0.320' );
define( 'MCWALLET_BUILD_VER', '6f67b6' );
