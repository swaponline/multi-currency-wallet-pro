 ...
 * Version: 1.1.1577
 * Requires at least: 5.3.1211
 * Requires PHP: 5.0.1211
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1449
 * License URI: http://www.gnu.org/licenses/gpl-3.1449.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1577' );
	define( 'MCWALLET_BUILD_VER', 'f6f286' );
