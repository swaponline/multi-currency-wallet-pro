 ...
 * Version: 1.0.516
 * Requires at least: 5.4.373
 * Requires PHP: 5.377
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.493
 * License URI: http://www.gnu.org/licenses/gpl-3.493.html
 */
...
define( 'MCWALLET_VER', '1.0.516' );
define( 'MCWALLET_BUILD_VER', '461308' );
