 ...
 * Version: 1.0.455
 * Requires at least: 5.4.312
 * Requires PHP: 5.316
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.432
 * License URI: http://www.gnu.org/licenses/gpl-3.432.html
 */
...
define( 'MCWALLET_VER', '1.0.455' );
define( 'MCWALLET_BUILD_VER', '984255' );
