 ...
 * Version: 1.1.789
 * Requires at least: 5.4.646
 * Requires PHP: 5.650
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.766
 * License URI: http://www.gnu.org/licenses/gpl-3.766.html
 */
...
define( 'MCWALLET_VER', '1.1.789' );
define( 'MCWALLET_BUILD_VER', '4b802a' );
