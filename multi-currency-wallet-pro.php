 ...
 * Version: 1.1.960
 * Requires at least: 5.4.817
 * Requires PHP: 5.821
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.937
 * License URI: http://www.gnu.org/licenses/gpl-3.937.html
 */
...
define( 'MCWALLET_VER', '1.1.960' );
define( 'MCWALLET_BUILD_VER', 'ac78a1' );
