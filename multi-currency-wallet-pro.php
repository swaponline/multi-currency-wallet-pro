 ...
 * Version: 1.0.361
 * Requires at least: 5.4.218
 * Requires PHP: 5.222
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.338
 * License URI: http://www.gnu.org/licenses/gpl-3.338.html
 */
...
define( 'MCWALLET_VER', '1.0.361' );
define( 'MCWALLET_BUILD_VER', '06ffe3' );
