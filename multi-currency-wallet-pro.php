 ...
 * Version: 1.0.534
 * Requires at least: 5.4.391
 * Requires PHP: 5.395
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.511
 * License URI: http://www.gnu.org/licenses/gpl-3.511.html
 */
...
define( 'MCWALLET_VER', '1.0.534' );
define( 'MCWALLET_BUILD_VER', 'e29dfe' );
