 ...
 * Version: 1.1.846
 * Requires at least: 5.4.703
 * Requires PHP: 5.707
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.823
 * License URI: http://www.gnu.org/licenses/gpl-3.823.html
 */
...
define( 'MCWALLET_VER', '1.1.846' );
define( 'MCWALLET_BUILD_VER', 'db922b' );
