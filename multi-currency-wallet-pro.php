 ...
 * Version: 1.1.1327
 * Requires at least: 5.3.1064
 * Requires PHP: 5.0.1064
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1202
 * License URI: http://www.gnu.org/licenses/gpl-3.1202.html
 */
...
define( 'MCWALLET_VER', '1.1.1327' );
define( 'MCWALLET_BUILD_VER', '974b9d' );
