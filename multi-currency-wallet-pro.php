 ...
 * Version: 1.1.1584
 * Requires at least: 5.3.1218
 * Requires PHP: 5.0.1218
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1456
 * License URI: http://www.gnu.org/licenses/gpl-3.1456.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1584' );
	define( 'MCWALLET_BUILD_VER', 'aa7ec8' );
