 ...
 * Version: 1.0.451
 * Requires at least: 5.4.308
 * Requires PHP: 5.312
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.428
 * License URI: http://www.gnu.org/licenses/gpl-3.428.html
 */
...
define( 'MCWALLET_VER', '1.0.451' );
define( 'MCWALLET_BUILD_VER', '3133c9' );
