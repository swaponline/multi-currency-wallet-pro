 ...
 * Version: 1.0.295
 * Requires at least: 5.4.152
 * Requires PHP: 5.156
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.272
 * License URI: http://www.gnu.org/licenses/gpl-3.272.html
 */
...
define( 'MCWALLET_VER', '1.0.295' );
define( 'MCWALLET_BUILD_VER', '043f53' );
