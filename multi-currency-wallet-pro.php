 ...
 * Version: 1.0.481
 * Requires at least: 5.4.338
 * Requires PHP: 5.342
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.458
 * License URI: http://www.gnu.org/licenses/gpl-3.458.html
 */
...
define( 'MCWALLET_VER', '1.0.481' );
define( 'MCWALLET_BUILD_VER', 'acea63' );
