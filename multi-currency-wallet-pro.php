 ...
 * Version: 1.0.599
 * Requires at least: 5.4.456
 * Requires PHP: 5.460
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.576
 * License URI: http://www.gnu.org/licenses/gpl-3.576.html
 */
...
define( 'MCWALLET_VER', '1.0.599' );
define( 'MCWALLET_BUILD_VER', '6717cb' );
