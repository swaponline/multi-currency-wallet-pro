 ...
 * Version: 1.1.994
 * Requires at least: 5.4.851
 * Requires PHP: 5.855
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.971
 * License URI: http://www.gnu.org/licenses/gpl-3.971.html
 */
...
define( 'MCWALLET_VER', '1.1.994' );
define( 'MCWALLET_BUILD_VER', '8310a4' );
