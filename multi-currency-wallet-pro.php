 ...
 * Version: 1.1.735
 * Requires at least: 5.4.592
 * Requires PHP: 5.596
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.712
 * License URI: http://www.gnu.org/licenses/gpl-3.712.html
 */
...
define( 'MCWALLET_VER', '1.1.735' );
define( 'MCWALLET_BUILD_VER', '96c691' );
