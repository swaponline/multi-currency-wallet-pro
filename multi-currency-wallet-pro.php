 ...
 * Version: 1.0.271
 * Requires at least: 5.4.128
 * Requires PHP: 5.132
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.248
 * License URI: http://www.gnu.org/licenses/gpl-3.248.html
 */
...
define( 'MCWALLET_VER', '1.0.271' );
define( 'MCWALLET_BUILD_VER', 'ee61e8' );
