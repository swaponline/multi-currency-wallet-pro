 ...
 * Version: 1.1.948
 * Requires at least: 5.4.805
 * Requires PHP: 5.809
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.925
 * License URI: http://www.gnu.org/licenses/gpl-3.925.html
 */
...
define( 'MCWALLET_VER', '1.1.948' );
define( 'MCWALLET_BUILD_VER', '7b5a36' );
