 ...
 * Version: 1.1.799
 * Requires at least: 5.4.656
 * Requires PHP: 5.660
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.776
 * License URI: http://www.gnu.org/licenses/gpl-3.776.html
 */
...
define( 'MCWALLET_VER', '1.1.799' );
define( 'MCWALLET_BUILD_VER', '936e28' );
