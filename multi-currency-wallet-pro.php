 ...
 * Version: 1.1.682
 * Requires at least: 5.4.539
 * Requires PHP: 5.543
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.659
 * License URI: http://www.gnu.org/licenses/gpl-3.659.html
 */
...
define( 'MCWALLET_VER', '1.1.682' );
define( 'MCWALLET_BUILD_VER', 'e3e937' );
