 ...
 * Version: 1.1.679
 * Requires at least: 5.4.536
 * Requires PHP: 5.540
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.656
 * License URI: http://www.gnu.org/licenses/gpl-3.656.html
 */
...
define( 'MCWALLET_VER', '1.1.679' );
define( 'MCWALLET_BUILD_VER', '0c896b' );
