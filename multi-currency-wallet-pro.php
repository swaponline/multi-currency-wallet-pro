 ...
 * Version: 1.0.286
 * Requires at least: 5.4.143
 * Requires PHP: 5.147
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.263
 * License URI: http://www.gnu.org/licenses/gpl-3.263.html
 */
...
define( 'MCWALLET_VER', '1.0.286' );
define( 'MCWALLET_BUILD_VER', 'd71b3d' );
