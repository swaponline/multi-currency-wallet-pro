 ...
 * Version: 1.1.671
 * Requires at least: 5.4.528
 * Requires PHP: 5.532
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.648
 * License URI: http://www.gnu.org/licenses/gpl-3.648.html
 */
...
define( 'MCWALLET_VER', '1.1.671' );
define( 'MCWALLET_BUILD_VER', 'e85bbe' );
