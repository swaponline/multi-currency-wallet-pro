 ...
 * Version: 1.0.381
 * Requires at least: 5.4.238
 * Requires PHP: 5.242
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.358
 * License URI: http://www.gnu.org/licenses/gpl-3.358.html
 */
...
define( 'MCWALLET_VER', '1.0.381' );
define( 'MCWALLET_BUILD_VER', 'e173e0' );
