 ...
 * Version: 1.1.1218
 * Requires at least: 5.4.974
 * Requires PHP: 5.978
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1094
 * License URI: http://www.gnu.org/licenses/gpl-3.1094.html
 */
...
define( 'MCWALLET_VER', '1.1.1218' );
define( 'MCWALLET_BUILD_VER', '128dbf' );
