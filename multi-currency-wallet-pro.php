 ...
 * Version: 1.1.822
 * Requires at least: 5.4.679
 * Requires PHP: 5.683
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.799
 * License URI: http://www.gnu.org/licenses/gpl-3.799.html
 */
...
define( 'MCWALLET_VER', '1.1.822' );
define( 'MCWALLET_BUILD_VER', 'f2c829' );
