 ...
 * Version: 1.1.1594
 * Requires at least: 5.3.1228
 * Requires PHP: 5.0.1228
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1466
 * License URI: http://www.gnu.org/licenses/gpl-3.1466.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1594' );
	define( 'MCWALLET_BUILD_VER', 'cbb7b9' );
