 ...
 * Domain Path: /lang
 * License: GNU General Public License version 3.1314
 * License URI: http://www.gnu.org/licenses/gpl-3.1314.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1439' );
	define( 'MCWALLET_BUILD_VER', '55e48d' );
