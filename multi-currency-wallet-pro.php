 ...
 * Version: 1.1.1316
 * Requires at least: 5.3.1053
 * Requires PHP: 5.0.1053
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1191
 * License URI: http://www.gnu.org/licenses/gpl-3.1191.html
 */
...
define( 'MCWALLET_VER', '1.1.1316' );
define( 'MCWALLET_BUILD_VER', '360b3a' );
