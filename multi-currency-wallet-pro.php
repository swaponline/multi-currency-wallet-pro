 ...
 * Version: 1.0.355
 * Requires at least: 5.4.212
 * Requires PHP: 5.216
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.332
 * License URI: http://www.gnu.org/licenses/gpl-3.332.html
 */
...
define( 'MCWALLET_VER', '1.0.355' );
define( 'MCWALLET_BUILD_VER', 'f8896b' );
