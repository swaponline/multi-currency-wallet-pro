 ...
 * Version: 1.0.482
 * Requires at least: 5.4.339
 * Requires PHP: 5.343
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.459
 * License URI: http://www.gnu.org/licenses/gpl-3.459.html
 */
...
define( 'MCWALLET_VER', '1.0.482' );
define( 'MCWALLET_BUILD_VER', '4275a3' );
