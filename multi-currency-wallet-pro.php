 ...
 * Version: 1.1.1024
 * Requires at least: 5.4.880
 * Requires PHP: 5.884
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1000
 * License URI: http://www.gnu.org/licenses/gpl-3.1000.html
 */
...
define( 'MCWALLET_VER', '1.1.1024' );
define( 'MCWALLET_BUILD_VER', '559a56' );
