 ...
 * Version: 1.0.386
 * Requires at least: 5.4.243
 * Requires PHP: 5.247
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.363
 * License URI: http://www.gnu.org/licenses/gpl-3.363.html
 */
...
define( 'MCWALLET_VER', '1.0.386' );
define( 'MCWALLET_BUILD_VER', '5f12c1' );
