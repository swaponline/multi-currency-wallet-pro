 ...
 * Version: 1.1.776
 * Requires at least: 5.4.633
 * Requires PHP: 5.637
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.753
 * License URI: http://www.gnu.org/licenses/gpl-3.753.html
 */
...
define( 'MCWALLET_VER', '1.1.776' );
define( 'MCWALLET_BUILD_VER', 'a0c245' );
