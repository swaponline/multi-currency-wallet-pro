 ...
 * Version: 1.1.690
 * Requires at least: 5.4.547
 * Requires PHP: 5.551
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.667
 * License URI: http://www.gnu.org/licenses/gpl-3.667.html
 */
...
define( 'MCWALLET_VER', '1.1.690' );
define( 'MCWALLET_BUILD_VER', '15f1f0' );
