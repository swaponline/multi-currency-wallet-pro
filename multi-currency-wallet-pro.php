 ...
 * Version: 1.0.477
 * Requires at least: 5.4.334
 * Requires PHP: 5.338
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.454
 * License URI: http://www.gnu.org/licenses/gpl-3.454.html
 */
...
define( 'MCWALLET_VER', '1.0.477' );
define( 'MCWALLET_BUILD_VER', 'c3eca6' );
