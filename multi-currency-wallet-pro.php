 ...
 * Version: 1.1.840
 * Requires at least: 5.4.697
 * Requires PHP: 5.701
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.817
 * License URI: http://www.gnu.org/licenses/gpl-3.817.html
 */
...
define( 'MCWALLET_VER', '1.1.840' );
define( 'MCWALLET_BUILD_VER', '1e21ec' );
