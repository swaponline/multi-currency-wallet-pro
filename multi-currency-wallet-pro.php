 ...
 * Version: 1.1.769
 * Requires at least: 5.4.626
 * Requires PHP: 5.630
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.746
 * License URI: http://www.gnu.org/licenses/gpl-3.746.html
 */
...
define( 'MCWALLET_VER', '1.1.769' );
define( 'MCWALLET_BUILD_VER', '4ba118' );
