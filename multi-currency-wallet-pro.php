 ...
 * Version: 1.0.571
 * Requires at least: 5.4.428
 * Requires PHP: 5.432
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.548
 * License URI: http://www.gnu.org/licenses/gpl-3.548.html
 */
...
define( 'MCWALLET_VER', '1.0.571' );
define( 'MCWALLET_BUILD_VER', 'e2596b' );
