 ...
 * Version: 1.0.536
 * Requires at least: 5.4.393
 * Requires PHP: 5.397
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.513
 * License URI: http://www.gnu.org/licenses/gpl-3.513.html
 */
...
define( 'MCWALLET_VER', '1.0.536' );
define( 'MCWALLET_BUILD_VER', 'ddffb1' );
