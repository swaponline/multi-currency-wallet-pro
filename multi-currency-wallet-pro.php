 ...
 * Version: 1.1.1007
 * Requires at least: 5.4.864
 * Requires PHP: 5.868
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.984
 * License URI: http://www.gnu.org/licenses/gpl-3.984.html
 */
...
define( 'MCWALLET_VER', '1.1.1007' );
define( 'MCWALLET_BUILD_VER', '236aff' );
