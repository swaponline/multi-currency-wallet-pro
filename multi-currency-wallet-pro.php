 ...
 * Version: 1.1.963
 * Requires at least: 5.4.820
 * Requires PHP: 5.824
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.940
 * License URI: http://www.gnu.org/licenses/gpl-3.940.html
 */
...
define( 'MCWALLET_VER', '1.1.963' );
define( 'MCWALLET_BUILD_VER', 'e1b8ce' );
