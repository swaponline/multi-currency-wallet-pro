 ...
 * Version: 1.0.396
 * Requires at least: 5.4.253
 * Requires PHP: 5.257
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.373
 * License URI: http://www.gnu.org/licenses/gpl-3.373.html
 */
...
define( 'MCWALLET_VER', '1.0.396' );
define( 'MCWALLET_BUILD_VER', '7d3a3c' );
