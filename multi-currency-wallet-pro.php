 ...
 * Version: 1.1.713
 * Requires at least: 5.4.570
 * Requires PHP: 5.574
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.690
 * License URI: http://www.gnu.org/licenses/gpl-3.690.html
 */
...
define( 'MCWALLET_VER', '1.1.713' );
define( 'MCWALLET_BUILD_VER', 'ce063a' );
