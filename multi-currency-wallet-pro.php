 ...
 * Version: 1.1.1554
 * Requires at least: 5.3.1188
 * Requires PHP: 5.0.1188
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1426
 * License URI: http://www.gnu.org/licenses/gpl-3.1426.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1554' );
	define( 'MCWALLET_BUILD_VER', '2f8df6' );
