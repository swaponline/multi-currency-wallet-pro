 ...
 * Version: 1.1.1592
 * Requires at least: 5.3.1226
 * Requires PHP: 5.0.1226
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1464
 * License URI: http://www.gnu.org/licenses/gpl-3.1464.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1592' );
	define( 'MCWALLET_BUILD_VER', '2094bc' );
