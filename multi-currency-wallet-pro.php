 ...
 * Version: 1.0.425
 * Requires at least: 5.4.282
 * Requires PHP: 5.286
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.402
 * License URI: http://www.gnu.org/licenses/gpl-3.402.html
 */
...
define( 'MCWALLET_VER', '1.0.425' );
define( 'MCWALLET_BUILD_VER', '8a76db' );
