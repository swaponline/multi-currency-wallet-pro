 ...
 * Version: 1.0.334
 * Requires at least: 5.4.191
 * Requires PHP: 5.195
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.311
 * License URI: http://www.gnu.org/licenses/gpl-3.311.html
 */
...
define( 'MCWALLET_VER', '1.0.334' );
define( 'MCWALLET_BUILD_VER', '5f253c' );
