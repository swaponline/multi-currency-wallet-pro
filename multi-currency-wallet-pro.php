 ...
 * Version: 1.1.850
 * Requires at least: 5.4.707
 * Requires PHP: 5.711
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.827
 * License URI: http://www.gnu.org/licenses/gpl-3.827.html
 */
...
define( 'MCWALLET_VER', '1.1.850' );
define( 'MCWALLET_BUILD_VER', '59921a' );
