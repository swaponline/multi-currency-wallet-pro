 ...
 * Version: 1.1.1377
 * Requires at least: 5.3.1014
 * Requires PHP: 5.0.1014
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1252
 * License URI: http://www.gnu.org/licenses/gpl-3.1252.html
 */
...
define( 'MCWALLET_VER', '1.1.1377' );
define( 'MCWALLET_BUILD_VER', 'e0c45c' );
