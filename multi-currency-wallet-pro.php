 ...
 * Version: 1.0.635
 * Requires at least: 5.4.492
 * Requires PHP: 5.496
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.612
 * License URI: http://www.gnu.org/licenses/gpl-3.612.html
 */
...
define( 'MCWALLET_VER', '1.0.635' );
define( 'MCWALLET_BUILD_VER', 'a3f5af' );
