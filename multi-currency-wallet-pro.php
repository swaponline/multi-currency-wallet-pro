 ...
 * Version: 1.0.512
 * Requires at least: 5.4.369
 * Requires PHP: 5.373
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.489
 * License URI: http://www.gnu.org/licenses/gpl-3.489.html
 */
...
define( 'MCWALLET_VER', '1.0.512' );
define( 'MCWALLET_BUILD_VER', 'f3e678' );
