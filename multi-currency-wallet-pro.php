 ...
 * Version: 1.1.875
 * Requires at least: 5.4.732
 * Requires PHP: 5.736
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.852
 * License URI: http://www.gnu.org/licenses/gpl-3.852.html
 */
...
define( 'MCWALLET_VER', '1.1.875' );
define( 'MCWALLET_BUILD_VER', 'fb067b' );
