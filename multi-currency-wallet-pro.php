 ...
 * Version: 1.0.598
 * Requires at least: 5.4.455
 * Requires PHP: 5.459
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.575
 * License URI: http://www.gnu.org/licenses/gpl-3.575.html
 */
...
define( 'MCWALLET_VER', '1.0.598' );
define( 'MCWALLET_BUILD_VER', '78da7e' );
