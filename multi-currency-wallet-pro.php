 ...
 * Version: 1.1.1313
 * Requires at least: 5.3.1050
 * Requires PHP: 5.0.1050
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1188
 * License URI: http://www.gnu.org/licenses/gpl-3.1188.html
 */
...
define( 'MCWALLET_VER', '1.1.1313' );
define( 'MCWALLET_BUILD_VER', 'f72cc5' );
