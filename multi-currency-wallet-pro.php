 ...
 * Version: 1.1.1052
 * Requires at least: 5.4.908
 * Requires PHP: 5.912
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1028
 * License URI: http://www.gnu.org/licenses/gpl-3.1028.html
 */
...
define( 'MCWALLET_VER', '1.1.1052' );
define( 'MCWALLET_BUILD_VER', 'fd71f2' );
