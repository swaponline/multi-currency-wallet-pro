 ...
 * Version: 1.0.316
 * Requires at least: 5.4.173
 * Requires PHP: 5.177
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.293
 * License URI: http://www.gnu.org/licenses/gpl-3.293.html
 */
...
define( 'MCWALLET_VER', '1.0.316' );
define( 'MCWALLET_BUILD_VER', '1d6319' );
