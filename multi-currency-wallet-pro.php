 ...
 * Version: 1.0.566
 * Requires at least: 5.4.423
 * Requires PHP: 5.427
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.543
 * License URI: http://www.gnu.org/licenses/gpl-3.543.html
 */
...
define( 'MCWALLET_VER', '1.0.566' );
define( 'MCWALLET_BUILD_VER', '76a381' );
