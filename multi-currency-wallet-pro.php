 ...
 * Version: 1.1.877
 * Requires at least: 5.4.734
 * Requires PHP: 5.738
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.854
 * License URI: http://www.gnu.org/licenses/gpl-3.854.html
 */
...
define( 'MCWALLET_VER', '1.1.877' );
define( 'MCWALLET_BUILD_VER', 'e9126f' );
