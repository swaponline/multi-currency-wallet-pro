 ...
 * Version: 1.1.1516
 * Requires at least: 5.3.1152
 * Requires PHP: 5.0.1152
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1390
 * License URI: http://www.gnu.org/licenses/gpl-3.1390.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1516' );
	define( 'MCWALLET_BUILD_VER', 'b6f6bb' );
