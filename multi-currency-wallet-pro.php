 ...
 * Version: 1.1.956
 * Requires at least: 5.4.813
 * Requires PHP: 5.817
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.933
 * License URI: http://www.gnu.org/licenses/gpl-3.933.html
 */
...
define( 'MCWALLET_VER', '1.1.956' );
define( 'MCWALLET_BUILD_VER', 'f549b1' );
