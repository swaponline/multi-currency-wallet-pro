 ...
 * Version: 1.1.959
 * Requires at least: 5.4.816
 * Requires PHP: 5.820
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.936
 * License URI: http://www.gnu.org/licenses/gpl-3.936.html
 */
...
define( 'MCWALLET_VER', '1.1.959' );
define( 'MCWALLET_BUILD_VER', '7713fa' );
