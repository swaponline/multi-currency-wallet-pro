 ...
 * Version: 1.1.704
 * Requires at least: 5.4.561
 * Requires PHP: 5.565
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.681
 * License URI: http://www.gnu.org/licenses/gpl-3.681.html
 */
...
define( 'MCWALLET_VER', '1.1.704' );
define( 'MCWALLET_BUILD_VER', '6239ff' );
