 ...
 * Version: 1.1.876
 * Requires at least: 5.4.733
 * Requires PHP: 5.737
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.853
 * License URI: http://www.gnu.org/licenses/gpl-3.853.html
 */
...
define( 'MCWALLET_VER', '1.1.876' );
define( 'MCWALLET_BUILD_VER', 'f3f3bb' );
