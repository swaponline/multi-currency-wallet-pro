 ...
 * Version: 1.1.972
 * Requires at least: 5.4.829
 * Requires PHP: 5.833
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.949
 * License URI: http://www.gnu.org/licenses/gpl-3.949.html
 */
...
define( 'MCWALLET_VER', '1.1.972' );
define( 'MCWALLET_BUILD_VER', '769cd6' );
