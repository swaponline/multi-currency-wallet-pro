 ...
 * Version: 1.1.1221
 * Requires at least: 5.4.977
 * Requires PHP: 5.981
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1097
 * License URI: http://www.gnu.org/licenses/gpl-3.1097.html
 */
...
define( 'MCWALLET_VER', '1.1.1221' );
define( 'MCWALLET_BUILD_VER', '870c5a' );
