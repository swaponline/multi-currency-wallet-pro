 ...
 * Version: 1.1.1344
 * Requires at least: 5.3.1081
 * Requires PHP: 5.0.1081
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1219
 * License URI: http://www.gnu.org/licenses/gpl-3.1219.html
 */
...
define( 'MCWALLET_VER', '1.1.1344' );
define( 'MCWALLET_BUILD_VER', '2efee2' );
