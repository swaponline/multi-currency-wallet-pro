 ...
 * Version: 1.1.683
 * Requires at least: 5.4.540
 * Requires PHP: 5.544
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.660
 * License URI: http://www.gnu.org/licenses/gpl-3.660.html
 */
...
define( 'MCWALLET_VER', '1.1.683' );
define( 'MCWALLET_BUILD_VER', '09b2e2' );
