 ...
 * Version: 1.1.1297
 * Requires at least: 5.3.1034
 * Requires PHP: 5.0.1034
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1172
 * License URI: http://www.gnu.org/licenses/gpl-3.1172.html
 */
...
define( 'MCWALLET_VER', '1.1.1297' );
define( 'MCWALLET_BUILD_VER', '6280b4' );
