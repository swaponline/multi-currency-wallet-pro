 ...
 * Version: 1.0.613
 * Requires at least: 5.4.470
 * Requires PHP: 5.474
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.590
 * License URI: http://www.gnu.org/licenses/gpl-3.590.html
 */
...
define( 'MCWALLET_VER', '1.0.613' );
define( 'MCWALLET_BUILD_VER', '1c929b' );
