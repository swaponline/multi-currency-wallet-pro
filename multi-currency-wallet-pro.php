 ...
 * Version: 1.0.519
 * Requires at least: 5.4.376
 * Requires PHP: 5.380
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.496
 * License URI: http://www.gnu.org/licenses/gpl-3.496.html
 */
...
define( 'MCWALLET_VER', '1.0.519' );
define( 'MCWALLET_BUILD_VER', '81c379' );
