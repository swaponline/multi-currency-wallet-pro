 ...
 * Version: 1.1.1028
 * Requires at least: 5.4.884
 * Requires PHP: 5.888
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1004
 * License URI: http://www.gnu.org/licenses/gpl-3.1004.html
 */
...
define( 'MCWALLET_VER', '1.1.1028' );
define( 'MCWALLET_BUILD_VER', '8f0db3' );
