 ...
 * Version: 1.1.766
 * Requires at least: 5.4.623
 * Requires PHP: 5.627
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.743
 * License URI: http://www.gnu.org/licenses/gpl-3.743.html
 */
...
define( 'MCWALLET_VER', '1.1.766' );
define( 'MCWALLET_BUILD_VER', '71253c' );
