 ...
 * Version: 1.1.796
 * Requires at least: 5.4.653
 * Requires PHP: 5.657
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.773
 * License URI: http://www.gnu.org/licenses/gpl-3.773.html
 */
...
define( 'MCWALLET_VER', '1.1.796' );
define( 'MCWALLET_BUILD_VER', '544e8e' );
