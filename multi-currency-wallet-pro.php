 ...
 * Version: 1.1.1270
 * Requires at least: 5.3.1007
 * Requires PHP: 5.0.1007
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1145
 * License URI: http://www.gnu.org/licenses/gpl-3.1145.html
 */
...
define( 'MCWALLET_VER', '1.1.1270' );
define( 'MCWALLET_BUILD_VER', 'c2efdc' );
