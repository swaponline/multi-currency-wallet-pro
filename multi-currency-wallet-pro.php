 ...
 * Version: 1.1.1481
 * Requires at least: 5.3.1117
 * Requires PHP: 5.0.1117
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1355
 * License URI: http://www.gnu.org/licenses/gpl-3.1355.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1481' );
	define( 'MCWALLET_BUILD_VER', 'f25cee' );
