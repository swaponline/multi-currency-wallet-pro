 ...
 * Version: 1.0.486
 * Requires at least: 5.4.343
 * Requires PHP: 5.347
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.463
 * License URI: http://www.gnu.org/licenses/gpl-3.463.html
 */
...
define( 'MCWALLET_VER', '1.0.486' );
define( 'MCWALLET_BUILD_VER', '0d97d4' );
