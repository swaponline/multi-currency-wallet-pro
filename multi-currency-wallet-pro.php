 ...
 * Version: 1.1.1463
 * Requires at least: 5.3.1099
 * Requires PHP: 5.0.1099
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1337
 * License URI: http://www.gnu.org/licenses/gpl-3.1337.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1463' );
	define( 'MCWALLET_BUILD_VER', 'e5ca38' );
