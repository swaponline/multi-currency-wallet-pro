 ...
 * Version: 1.1.945
 * Requires at least: 5.4.802
 * Requires PHP: 5.806
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.922
 * License URI: http://www.gnu.org/licenses/gpl-3.922.html
 */
...
define( 'MCWALLET_VER', '1.1.945' );
define( 'MCWALLET_BUILD_VER', '9883e' );
