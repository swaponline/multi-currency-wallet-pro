 ...
 * Version: 1.1.981
 * Requires at least: 5.4.838
 * Requires PHP: 5.842
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.958
 * License URI: http://www.gnu.org/licenses/gpl-3.958.html
 */
...
define( 'MCWALLET_VER', '1.1.981' );
define( 'MCWALLET_BUILD_VER', '8186d8' );
