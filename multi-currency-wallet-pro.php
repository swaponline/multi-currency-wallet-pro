 ...
 * Version: 1.1.906
 * Requires at least: 5.4.763
 * Requires PHP: 5.767
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.883
 * License URI: http://www.gnu.org/licenses/gpl-3.883.html
 */
...
define( 'MCWALLET_VER', '1.1.906' );
define( 'MCWALLET_BUILD_VER', '2f63b1' );
