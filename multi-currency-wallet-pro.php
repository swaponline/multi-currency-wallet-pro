 ...
 * Version: 1.0.551
 * Requires at least: 5.4.408
 * Requires PHP: 5.412
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.528
 * License URI: http://www.gnu.org/licenses/gpl-3.528.html
 */
...
define( 'MCWALLET_VER', '1.0.551' );
define( 'MCWALLET_BUILD_VER', '1aaf24' );
