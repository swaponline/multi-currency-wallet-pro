 ...
 * Version: 1.0.441
 * Requires at least: 5.4.298
 * Requires PHP: 5.302
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.418
 * License URI: http://www.gnu.org/licenses/gpl-3.418.html
 */
...
define( 'MCWALLET_VER', '1.0.441' );
define( 'MCWALLET_BUILD_VER', 'f17cf3' );
