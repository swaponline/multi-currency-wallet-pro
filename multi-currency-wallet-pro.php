 ...
 * Version: 1.1.834
 * Requires at least: 5.4.691
 * Requires PHP: 5.695
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.811
 * License URI: http://www.gnu.org/licenses/gpl-3.811.html
 */
...
define( 'MCWALLET_VER', '1.1.834' );
define( 'MCWALLET_BUILD_VER', '59aed6' );
