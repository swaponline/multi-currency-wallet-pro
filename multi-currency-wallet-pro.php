 ...
 * Version: 1.0.274
 * Requires at least: 5.4.131
 * Requires PHP: 5.135
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.251
 * License URI: http://www.gnu.org/licenses/gpl-3.251.html
 */
...
define( 'MCWALLET_VER', '1.0.274' );
define( 'MCWALLET_BUILD_VER', '22d16f' );
