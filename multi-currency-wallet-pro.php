 ...
 * Version: 1.1.1343
 * Requires at least: 5.3.1080
 * Requires PHP: 5.0.1080
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1218
 * License URI: http://www.gnu.org/licenses/gpl-3.1218.html
 */
...
define( 'MCWALLET_VER', '1.1.1343' );
define( 'MCWALLET_BUILD_VER', 'b4fe8d' );
