 ...
 * Version: 1.1.820
 * Requires at least: 5.4.677
 * Requires PHP: 5.681
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.797
 * License URI: http://www.gnu.org/licenses/gpl-3.797.html
 */
...
define( 'MCWALLET_VER', '1.1.820' );
define( 'MCWALLET_BUILD_VER', '962d2f' );
