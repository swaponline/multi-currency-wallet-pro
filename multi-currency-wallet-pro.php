 ...
 * Version: 1.1.966
 * Requires at least: 5.4.823
 * Requires PHP: 5.827
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.943
 * License URI: http://www.gnu.org/licenses/gpl-3.943.html
 */
...
define( 'MCWALLET_VER', '1.1.966' );
define( 'MCWALLET_BUILD_VER', '5b939b' );
