 ...
 * Version: 1.0.600
 * Requires at least: 5.4.457
 * Requires PHP: 5.461
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.577
 * License URI: http://www.gnu.org/licenses/gpl-3.577.html
 */
...
define( 'MCWALLET_VER', '1.0.600' );
define( 'MCWALLET_BUILD_VER', '9229cc' );
