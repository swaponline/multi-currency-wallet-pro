 ...
 * Version: 1.1.785
 * Requires at least: 5.4.642
 * Requires PHP: 5.646
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.762
 * License URI: http://www.gnu.org/licenses/gpl-3.762.html
 */
...
define( 'MCWALLET_VER', '1.1.785' );
define( 'MCWALLET_BUILD_VER', '5df849' );
