 ...
 * Version: 1.1.976
 * Requires at least: 5.4.833
 * Requires PHP: 5.837
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.953
 * License URI: http://www.gnu.org/licenses/gpl-3.953.html
 */
...
define( 'MCWALLET_VER', '1.1.976' );
define( 'MCWALLET_BUILD_VER', '8ac4ee' );
