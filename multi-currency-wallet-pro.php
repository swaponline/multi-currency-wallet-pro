 ...
 * Version: 1.0.414
 * Requires at least: 5.4.271
 * Requires PHP: 5.275
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.391
 * License URI: http://www.gnu.org/licenses/gpl-3.391.html
 */
...
define( 'MCWALLET_VER', '1.0.414' );
define( 'MCWALLET_BUILD_VER', '200bf7' );
