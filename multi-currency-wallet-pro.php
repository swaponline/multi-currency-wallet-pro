 ...
 * Version: 1.0.275
 * Requires at least: 5.4.132
 * Requires PHP: 5.136
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.252
 * License URI: http://www.gnu.org/licenses/gpl-3.252.html
 */
...
define( 'MCWALLET_VER', '1.0.275' );
define( 'MCWALLET_BUILD_VER', 'b5935b' );
