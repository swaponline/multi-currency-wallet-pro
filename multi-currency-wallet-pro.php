 ...
 * Version: 1.1.745
 * Requires at least: 5.4.602
 * Requires PHP: 5.606
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.722
 * License URI: http://www.gnu.org/licenses/gpl-3.722.html
 */
...
define( 'MCWALLET_VER', '1.1.745' );
define( 'MCWALLET_BUILD_VER', '045bd0' );
