 ...
 * Version: 1.1.807
 * Requires at least: 5.4.664
 * Requires PHP: 5.668
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.784
 * License URI: http://www.gnu.org/licenses/gpl-3.784.html
 */
...
define( 'MCWALLET_VER', '1.1.807' );
define( 'MCWALLET_BUILD_VER', 'ef9638' );
