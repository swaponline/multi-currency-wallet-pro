 ...
 * Version: 1.0.357
 * Requires at least: 5.4.214
 * Requires PHP: 5.218
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.334
 * License URI: http://www.gnu.org/licenses/gpl-3.334.html
 */
...
define( 'MCWALLET_VER', '1.0.357' );
define( 'MCWALLET_BUILD_VER', '2bfc8c' );
