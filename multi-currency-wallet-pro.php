 ...
 * Version: 1.0.484
 * Requires at least: 5.4.341
 * Requires PHP: 5.345
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.461
 * License URI: http://www.gnu.org/licenses/gpl-3.461.html
 */
...
define( 'MCWALLET_VER', '1.0.484' );
define( 'MCWALLET_BUILD_VER', '75e34d' );
