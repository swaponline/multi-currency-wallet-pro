 ...
 * Version: 1.1.1457
 * Requires at least: 5.3.1093
 * Requires PHP: 5.0.1093
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1331
 * License URI: http://www.gnu.org/licenses/gpl-3.1331.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1457' );
	define( 'MCWALLET_BUILD_VER', 'ddbd9a' );
