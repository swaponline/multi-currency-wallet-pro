 ...
 * Version: 1.1.1430
 * Requires at least: 5.3.1067
 * Requires PHP: 5.0.1067
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1305
 * License URI: http://www.gnu.org/licenses/gpl-3.1305.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1430' );
	define( 'MCWALLET_BUILD_VER', '1c1770' );
