 ...
 * Version: 1.1.723
 * Requires at least: 5.4.580
 * Requires PHP: 5.584
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.700
 * License URI: http://www.gnu.org/licenses/gpl-3.700.html
 */
...
define( 'MCWALLET_VER', '1.1.723' );
define( 'MCWALLET_BUILD_VER', '14b66f' );
