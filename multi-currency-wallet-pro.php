 ...
 * Version: 1.0.454
 * Requires at least: 5.4.311
 * Requires PHP: 5.315
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.431
 * License URI: http://www.gnu.org/licenses/gpl-3.431.html
 */
...
define( 'MCWALLET_VER', '1.0.454' );
define( 'MCWALLET_BUILD_VER', '586281' );
