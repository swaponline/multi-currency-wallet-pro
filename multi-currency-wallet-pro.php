 ...
 * Version: 1.1.783
 * Requires at least: 5.4.640
 * Requires PHP: 5.644
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.760
 * License URI: http://www.gnu.org/licenses/gpl-3.760.html
 */
...
define( 'MCWALLET_VER', '1.1.783' );
define( 'MCWALLET_BUILD_VER', '3b913e' );
