 ...
 * Version: 1.0.427
 * Requires at least: 5.4.284
 * Requires PHP: 5.288
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.404
 * License URI: http://www.gnu.org/licenses/gpl-3.404.html
 */
...
define( 'MCWALLET_VER', '1.0.427' );
define( 'MCWALLET_BUILD_VER', '492a49' );
