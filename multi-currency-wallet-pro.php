 ...
 * Version: 1.0.259
 * Requires at least: 5.4.116
 * Requires PHP: 5.120
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.236
 * License URI: http://www.gnu.org/licenses/gpl-3.236.html
 */
...
define( 'MCWALLET_VER', '1.0.259' );
define( 'MCWALLET_BUILD_VER', '688914' );
