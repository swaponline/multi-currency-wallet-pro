 ...
 * Version: 1.0.457
 * Requires at least: 5.4.314
 * Requires PHP: 5.318
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.434
 * License URI: http://www.gnu.org/licenses/gpl-3.434.html
 */
...
define( 'MCWALLET_VER', '1.0.457' );
define( 'MCWALLET_BUILD_VER', 'd2ad50' );
