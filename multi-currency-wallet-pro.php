 ...
 * Version: 1.1.720
 * Requires at least: 5.4.577
 * Requires PHP: 5.581
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.697
 * License URI: http://www.gnu.org/licenses/gpl-3.697.html
 */
...
define( 'MCWALLET_VER', '1.1.720' );
define( 'MCWALLET_BUILD_VER', '934e79' );
