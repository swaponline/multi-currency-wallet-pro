 ...
 * Version: 1.1.922
 * Requires at least: 5.4.779
 * Requires PHP: 5.783
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.899
 * License URI: http://www.gnu.org/licenses/gpl-3.899.html
 */
...
define( 'MCWALLET_VER', '1.1.922' );
define( 'MCWALLET_BUILD_VER', 'f34376' );
