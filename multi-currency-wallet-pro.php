 ...
 * Version: 1.0.247
 * Requires at least: 5.4.104
 * Requires PHP: 5.108
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.224
 * License URI: http://www.gnu.org/licenses/gpl-3.224.html
 */
...
define( 'MCWALLET_VER', '1.0.247' );
define( 'MCWALLET_BUILD_VER', '943c2c' );
