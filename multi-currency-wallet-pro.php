 ...
 * Version: 1.1.733
 * Requires at least: 5.4.590
 * Requires PHP: 5.594
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.710
 * License URI: http://www.gnu.org/licenses/gpl-3.710.html
 */
...
define( 'MCWALLET_VER', '1.1.733' );
define( 'MCWALLET_BUILD_VER', '42d1fb' );
