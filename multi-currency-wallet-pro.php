 ...
 * Version: 1.1.1337
 * Requires at least: 5.3.1074
 * Requires PHP: 5.0.1074
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1212
 * License URI: http://www.gnu.org/licenses/gpl-3.1212.html
 */
...
define( 'MCWALLET_VER', '1.1.1337' );
define( 'MCWALLET_BUILD_VER', 'bfb32a' );
