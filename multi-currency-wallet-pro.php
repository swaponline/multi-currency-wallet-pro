 ...
 * Version: 1.0.489
 * Requires at least: 5.4.346
 * Requires PHP: 5.350
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.466
 * License URI: http://www.gnu.org/licenses/gpl-3.466.html
 */
...
define( 'MCWALLET_VER', '1.0.489' );
define( 'MCWALLET_BUILD_VER', 'fb440c' );
