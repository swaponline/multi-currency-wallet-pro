 ...
 * Version: 1.1.1294
 * Requires at least: 5.3.1031
 * Requires PHP: 5.0.1031
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1169
 * License URI: http://www.gnu.org/licenses/gpl-3.1169.html
 */
...
define( 'MCWALLET_VER', '1.1.1294' );
define( 'MCWALLET_BUILD_VER', 'afea47' );
