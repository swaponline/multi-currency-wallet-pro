 ...
 * Version: 1.1.1012
 * Requires at least: 5.4.869
 * Requires PHP: 5.873
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.989
 * License URI: http://www.gnu.org/licenses/gpl-3.989.html
 */
...
define( 'MCWALLET_VER', '1.1.1012' );
define( 'MCWALLET_BUILD_VER', '2624f2' );
