 ...
 * Version: 1.0.453
 * Requires at least: 5.4.310
 * Requires PHP: 5.314
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.430
 * License URI: http://www.gnu.org/licenses/gpl-3.430.html
 */
...
define( 'MCWALLET_VER', '1.0.453' );
define( 'MCWALLET_BUILD_VER', '4c6fd1' );
