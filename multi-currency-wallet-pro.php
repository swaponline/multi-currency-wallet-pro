 ...
 * Version: 1.1.657
 * Requires at least: 5.4.514
 * Requires PHP: 5.518
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.634
 * License URI: http://www.gnu.org/licenses/gpl-3.634.html
 */
...
define( 'MCWALLET_VER', '1.1.657' );
define( 'MCWALLET_BUILD_VER', '3aef42' );
