 ...
 * Version: 1.0.366
 * Requires at least: 5.4.223
 * Requires PHP: 5.227
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.343
 * License URI: http://www.gnu.org/licenses/gpl-3.343.html
 */
...
define( 'MCWALLET_VER', '1.0.366' );
define( 'MCWALLET_BUILD_VER', '4f2c3c' );
