 ...
 * Version: 1.1.870
 * Requires at least: 5.4.727
 * Requires PHP: 5.731
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.847
 * License URI: http://www.gnu.org/licenses/gpl-3.847.html
 */
...
define( 'MCWALLET_VER', '1.1.870' );
define( 'MCWALLET_BUILD_VER', '8fd87a' );
