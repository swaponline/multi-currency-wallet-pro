 ...
 * Version: 1.1.1285
 * Requires at least: 5.3.1022
 * Requires PHP: 5.0.1022
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1160
 * License URI: http://www.gnu.org/licenses/gpl-3.1160.html
 */
...
define( 'MCWALLET_VER', '1.1.1285' );
define( 'MCWALLET_BUILD_VER', '25924d' );
