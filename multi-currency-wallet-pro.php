 ...
 * Version: 1.1.911
 * Requires at least: 5.4.768
 * Requires PHP: 5.772
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.888
 * License URI: http://www.gnu.org/licenses/gpl-3.888.html
 */
...
define( 'MCWALLET_VER', '1.1.911' );
define( 'MCWALLET_BUILD_VER', 'b2c26a' );
