 ...
 * Version: 1.1.1586
 * Requires at least: 5.3.1220
 * Requires PHP: 5.0.1220
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1458
 * License URI: http://www.gnu.org/licenses/gpl-3.1458.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1586' );
	define( 'MCWALLET_BUILD_VER', '5e3f52' );
