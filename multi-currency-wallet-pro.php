 ...
 * Version: 1.1.1339
 * Requires at least: 5.3.1076
 * Requires PHP: 5.0.1076
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1214
 * License URI: http://www.gnu.org/licenses/gpl-3.1214.html
 */
...
define( 'MCWALLET_VER', '1.1.1339' );
define( 'MCWALLET_BUILD_VER', 'fce73c' );
