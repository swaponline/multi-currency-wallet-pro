 ...
 * Version: 1.0.618
 * Requires at least: 5.4.475
 * Requires PHP: 5.479
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.595
 * License URI: http://www.gnu.org/licenses/gpl-3.595.html
 */
...
define( 'MCWALLET_VER', '1.0.618' );
define( 'MCWALLET_BUILD_VER', '4f6397' );
