 ...
 * Version: 1.0.447
 * Requires at least: 5.4.304
 * Requires PHP: 5.308
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.424
 * License URI: http://www.gnu.org/licenses/gpl-3.424.html
 */
...
define( 'MCWALLET_VER', '1.0.447' );
define( 'MCWALLET_BUILD_VER', 'babdea' );
