 ...
 * Version: 1.0.467
 * Requires at least: 5.4.324
 * Requires PHP: 5.328
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.444
 * License URI: http://www.gnu.org/licenses/gpl-3.444.html
 */
...
define( 'MCWALLET_VER', '1.0.467' );
define( 'MCWALLET_BUILD_VER', '7bea54' );
