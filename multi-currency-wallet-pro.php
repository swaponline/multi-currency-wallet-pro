 ...
 * Version: 1.1.909
 * Requires at least: 5.4.766
 * Requires PHP: 5.770
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.886
 * License URI: http://www.gnu.org/licenses/gpl-3.886.html
 */
...
define( 'MCWALLET_VER', '1.1.909' );
define( 'MCWALLET_BUILD_VER', 'bd4059' );
