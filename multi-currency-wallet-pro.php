 ...
 * Version: 1.0.478
 * Requires at least: 5.4.335
 * Requires PHP: 5.339
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.455
 * License URI: http://www.gnu.org/licenses/gpl-3.455.html
 */
...
define( 'MCWALLET_VER', '1.0.478' );
define( 'MCWALLET_BUILD_VER', '0b96b3' );
