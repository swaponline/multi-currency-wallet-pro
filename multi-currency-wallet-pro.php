 ...
 * Version: 1.1.862
 * Requires at least: 5.4.719
 * Requires PHP: 5.723
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.839
 * License URI: http://www.gnu.org/licenses/gpl-3.839.html
 */
...
define( 'MCWALLET_VER', '1.1.862' );
define( 'MCWALLET_BUILD_VER', 'afed09' );
