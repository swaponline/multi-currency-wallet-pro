 ...
 * Version: 1.0.597
 * Requires at least: 5.4.454
 * Requires PHP: 5.458
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.574
 * License URI: http://www.gnu.org/licenses/gpl-3.574.html
 */
...
define( 'MCWALLET_VER', '1.0.597' );
define( 'MCWALLET_BUILD_VER', '506e49' );
