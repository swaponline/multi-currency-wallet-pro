 ...
 * Version: 1.1.722
 * Requires at least: 5.4.579
 * Requires PHP: 5.583
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.699
 * License URI: http://www.gnu.org/licenses/gpl-3.699.html
 */
...
define( 'MCWALLET_VER', '1.1.722' );
define( 'MCWALLET_BUILD_VER', '3869d1' );
