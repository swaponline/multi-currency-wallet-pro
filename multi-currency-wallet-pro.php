 ...
 * Version: 1.1.1244
 * Requires at least: 5.4.999
 * Requires PHP: 5.1003
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1119
 * License URI: http://www.gnu.org/licenses/gpl-3.1119.html
 */
...
define( 'MCWALLET_VER', '1.1.1244' );
define( 'MCWALLET_BUILD_VER', '0df185' );
