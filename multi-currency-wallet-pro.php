 ...
 * Domain Path: /lang
 * License: GNU General Public License version 3.1317
 * License URI: http://www.gnu.org/licenses/gpl-3.1317.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1442' );
	define( 'MCWALLET_BUILD_VER', '9f706f' );
