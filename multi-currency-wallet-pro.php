 ...
 * Version: 1.1.896
 * Requires at least: 5.4.753
 * Requires PHP: 5.757
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.873
 * License URI: http://www.gnu.org/licenses/gpl-3.873.html
 */
...
define( 'MCWALLET_VER', '1.1.896' );
define( 'MCWALLET_BUILD_VER', '589b4b' );
