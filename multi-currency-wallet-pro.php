 ...
 * Version: 1.0.335
 * Requires at least: 5.4.192
 * Requires PHP: 5.196
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.312
 * License URI: http://www.gnu.org/licenses/gpl-3.312.html
 */
...
define( 'MCWALLET_VER', '1.0.335' );
define( 'MCWALLET_BUILD_VER', '760641' );
