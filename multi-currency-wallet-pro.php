 ...
 * Version: 1.0.273
 * Requires at least: 5.4.130
 * Requires PHP: 5.134
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.250
 * License URI: http://www.gnu.org/licenses/gpl-3.250.html
 */
...
define( 'MCWALLET_VER', '1.0.273' );
define( 'MCWALLET_BUILD_VER', '6119a6' );
