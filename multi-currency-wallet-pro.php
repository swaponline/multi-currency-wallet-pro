 ...
 * Version: 1.1.1004
 * Requires at least: 5.4.861
 * Requires PHP: 5.865
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.981
 * License URI: http://www.gnu.org/licenses/gpl-3.981.html
 */
...
define( 'MCWALLET_VER', '1.1.1004' );
define( 'MCWALLET_BUILD_VER', '950ceb' );
