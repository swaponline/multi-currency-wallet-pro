 ...
 * Version: 1.1.872
 * Requires at least: 5.4.729
 * Requires PHP: 5.733
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.849
 * License URI: http://www.gnu.org/licenses/gpl-3.849.html
 */
...
define( 'MCWALLET_VER', '1.1.872' );
define( 'MCWALLET_BUILD_VER', '5a6a0f' );
