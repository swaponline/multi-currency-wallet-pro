 ...
 * Version: 1.0.253
 * Requires at least: 5.4.110
 * Requires PHP: 5.114
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.230
 * License URI: http://www.gnu.org/licenses/gpl-3.230.html
 */
...
define( 'MCWALLET_VER', '1.0.253' );
define( 'MCWALLET_BUILD_VER', '6b9ac4' );
