 ...
 * Version: 1.0.644
 * Requires at least: 5.4.501
 * Requires PHP: 5.505
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.621
 * License URI: http://www.gnu.org/licenses/gpl-3.621.html
 */
...
define( 'MCWALLET_VER', '1.0.644' );
define( 'MCWALLET_BUILD_VER', 'bd4ae4' );
