 ...
 * Version: 1.1.1424
 * Requires at least: 5.3.1061
 * Requires PHP: 5.0.1061
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1299
 * License URI: http://www.gnu.org/licenses/gpl-3.1299.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1424' );
	define( 'MCWALLET_BUILD_VER', '0feae0' );
