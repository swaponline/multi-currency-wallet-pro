 ...
 * Version: 1.1.973
 * Requires at least: 5.4.830
 * Requires PHP: 5.834
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.950
 * License URI: http://www.gnu.org/licenses/gpl-3.950.html
 */
...
define( 'MCWALLET_VER', '1.1.973' );
define( 'MCWALLET_BUILD_VER', '112d0d' );
