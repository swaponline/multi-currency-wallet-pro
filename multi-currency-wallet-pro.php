 ...
 * Version: 1.0.584
 * Requires at least: 5.4.441
 * Requires PHP: 5.445
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.561
 * License URI: http://www.gnu.org/licenses/gpl-3.561.html
 */
...
define( 'MCWALLET_VER', '1.0.584' );
define( 'MCWALLET_BUILD_VER', 'ebbdd6' );
