 ...
 * Version: 1.0.493
 * Requires at least: 5.4.350
 * Requires PHP: 5.354
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.470
 * License URI: http://www.gnu.org/licenses/gpl-3.470.html
 */
...
define( 'MCWALLET_VER', '1.0.493' );
define( 'MCWALLET_BUILD_VER', '672949' );
