 ...
 * Version: 1.0.629
 * Requires at least: 5.4.486
 * Requires PHP: 5.490
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.606
 * License URI: http://www.gnu.org/licenses/gpl-3.606.html
 */
...
define( 'MCWALLET_VER', '1.0.629' );
define( 'MCWALLET_BUILD_VER', '4650f' );
