 ...
 * Version: 1.0.590
 * Requires at least: 5.4.447
 * Requires PHP: 5.451
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.567
 * License URI: http://www.gnu.org/licenses/gpl-3.567.html
 */
...
define( 'MCWALLET_VER', '1.0.590' );
define( 'MCWALLET_BUILD_VER', 'c97f16' );
