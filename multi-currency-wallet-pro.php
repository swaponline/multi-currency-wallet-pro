 ...
 * Version: 1.1.1431
 * Requires at least: 5.3.1068
 * Requires PHP: 5.0.1068
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1306
 * License URI: http://www.gnu.org/licenses/gpl-3.1306.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1431' );
	define( 'MCWALLET_BUILD_VER', '0c0687' );
