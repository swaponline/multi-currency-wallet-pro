 ...
 * Version: 1.0.437
 * Requires at least: 5.4.294
 * Requires PHP: 5.298
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.414
 * License URI: http://www.gnu.org/licenses/gpl-3.414.html
 */
...
define( 'MCWALLET_VER', '1.0.437' );
define( 'MCWALLET_BUILD_VER', '766e5a' );
