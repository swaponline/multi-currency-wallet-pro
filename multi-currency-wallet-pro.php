 ...
 * Version: 1.1.895
 * Requires at least: 5.4.752
 * Requires PHP: 5.756
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.872
 * License URI: http://www.gnu.org/licenses/gpl-3.872.html
 */
...
define( 'MCWALLET_VER', '1.1.895' );
define( 'MCWALLET_BUILD_VER', '48b37d' );
