 ...
 * Version: 1.0.474
 * Requires at least: 5.4.331
 * Requires PHP: 5.335
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.451
 * License URI: http://www.gnu.org/licenses/gpl-3.451.html
 */
...
define( 'MCWALLET_VER', '1.0.474' );
define( 'MCWALLET_BUILD_VER', '24b8ee' );
