 ...
 * Version: 1.1.1572
 * Requires at least: 5.3.1206
 * Requires PHP: 5.0.1206
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1444
 * License URI: http://www.gnu.org/licenses/gpl-3.1444.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1572' );
	define( 'MCWALLET_BUILD_VER', 'd20f9b' );
