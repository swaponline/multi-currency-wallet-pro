 ...
 * Version: 1.0.490
 * Requires at least: 5.4.347
 * Requires PHP: 5.351
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.467
 * License URI: http://www.gnu.org/licenses/gpl-3.467.html
 */
...
define( 'MCWALLET_VER', '1.0.490' );
define( 'MCWALLET_BUILD_VER', '49591e' );
