 ...
 * Version: 1.0.527
 * Requires at least: 5.4.384
 * Requires PHP: 5.388
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.504
 * License URI: http://www.gnu.org/licenses/gpl-3.504.html
 */
...
define( 'MCWALLET_VER', '1.0.527' );
define( 'MCWALLET_BUILD_VER', 'ca66bb' );
