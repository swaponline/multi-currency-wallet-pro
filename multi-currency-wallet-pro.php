 ...
 * Version: 1.1.1480
 * Requires at least: 5.3.1116
 * Requires PHP: 5.0.1116
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1354
 * License URI: http://www.gnu.org/licenses/gpl-3.1354.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1480' );
	define( 'MCWALLET_BUILD_VER', '2cb416' );
