 ...
 * Version: 1.1.779
 * Requires at least: 5.4.636
 * Requires PHP: 5.640
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.756
 * License URI: http://www.gnu.org/licenses/gpl-3.756.html
 */
...
define( 'MCWALLET_VER', '1.1.779' );
define( 'MCWALLET_BUILD_VER', 'de90b5' );
