 ...
 * Version: 1.0.586
 * Requires at least: 5.4.443
 * Requires PHP: 5.447
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.563
 * License URI: http://www.gnu.org/licenses/gpl-3.563.html
 */
...
define( 'MCWALLET_VER', '1.0.586' );
define( 'MCWALLET_BUILD_VER', 'bd4767' );
