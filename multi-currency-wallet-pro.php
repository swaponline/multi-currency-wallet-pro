 ...
 * Version: 1.1.920
 * Requires at least: 5.4.777
 * Requires PHP: 5.781
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.897
 * License URI: http://www.gnu.org/licenses/gpl-3.897.html
 */
...
define( 'MCWALLET_VER', '1.1.920' );
define( 'MCWALLET_BUILD_VER', '177c6f' );
