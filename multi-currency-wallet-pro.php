 ...
 * Version: 1.1.1245
 * Requires at least: 5.4.1000
 * Requires PHP: 5.1004
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1120
 * License URI: http://www.gnu.org/licenses/gpl-3.1120.html
 */
...
define( 'MCWALLET_VER', '1.1.1245' );
define( 'MCWALLET_BUILD_VER', '397e8b' );
