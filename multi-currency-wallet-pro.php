 ...
 * Version: 1.0.446
 * Requires at least: 5.4.303
 * Requires PHP: 5.307
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.423
 * License URI: http://www.gnu.org/licenses/gpl-3.423.html
 */
...
define( 'MCWALLET_VER', '1.0.446' );
define( 'MCWALLET_BUILD_VER', 'b761a7' );
