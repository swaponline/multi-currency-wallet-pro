 ...
 * Version: 1.1.838
 * Requires at least: 5.4.695
 * Requires PHP: 5.699
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.815
 * License URI: http://www.gnu.org/licenses/gpl-3.815.html
 */
...
define( 'MCWALLET_VER', '1.1.838' );
define( 'MCWALLET_BUILD_VER', 'ff798d' );
