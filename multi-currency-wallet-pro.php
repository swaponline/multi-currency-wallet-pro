 ...
 * Version: 1.1.851
 * Requires at least: 5.4.708
 * Requires PHP: 5.712
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.828
 * License URI: http://www.gnu.org/licenses/gpl-3.828.html
 */
...
define( 'MCWALLET_VER', '1.1.851' );
define( 'MCWALLET_BUILD_VER', 'a3110d' );
