 ...
 * Version: 1.1.1223
 * Requires at least: 5.4.979
 * Requires PHP: 5.983
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1099
 * License URI: http://www.gnu.org/licenses/gpl-3.1099.html
 */
...
define( 'MCWALLET_VER', '1.1.1223' );
define( 'MCWALLET_BUILD_VER', 'f53f32' );
