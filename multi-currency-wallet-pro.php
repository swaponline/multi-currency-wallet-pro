 ...
 * Version: 1.1.680
 * Requires at least: 5.4.537
 * Requires PHP: 5.541
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.657
 * License URI: http://www.gnu.org/licenses/gpl-3.657.html
 */
...
define( 'MCWALLET_VER', '1.1.680' );
define( 'MCWALLET_BUILD_VER', '6de4e5' );
