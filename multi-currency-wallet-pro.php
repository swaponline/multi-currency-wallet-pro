 ...
 * Version: 1.0.377
 * Requires at least: 5.4.234
 * Requires PHP: 5.238
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.354
 * License URI: http://www.gnu.org/licenses/gpl-3.354.html
 */
...
define( 'MCWALLET_VER', '1.0.377' );
define( 'MCWALLET_BUILD_VER', '006e5b' );
