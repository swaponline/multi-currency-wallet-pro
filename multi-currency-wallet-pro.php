 ...
 * Version: 1.0.380
 * Requires at least: 5.4.237
 * Requires PHP: 5.241
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.357
 * License URI: http://www.gnu.org/licenses/gpl-3.357.html
 */
...
define( 'MCWALLET_VER', '1.0.380' );
define( 'MCWALLET_BUILD_VER', '804e1e' );
