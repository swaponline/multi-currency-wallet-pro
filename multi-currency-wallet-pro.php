 ...
 * Version: 1.1.1179
 * Requires at least: 5.4.939
 * Requires PHP: 5.943
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1059
 * License URI: http://www.gnu.org/licenses/gpl-3.1059.html
 */
...
define( 'MCWALLET_VER', '1.1.1179' );
define( 'MCWALLET_BUILD_VER', '8675bf' );
