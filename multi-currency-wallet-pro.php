 ...
 * Version: 1.0.592
 * Requires at least: 5.4.449
 * Requires PHP: 5.453
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.569
 * License URI: http://www.gnu.org/licenses/gpl-3.569.html
 */
...
define( 'MCWALLET_VER', '1.0.592' );
define( 'MCWALLET_BUILD_VER', '87876' );
