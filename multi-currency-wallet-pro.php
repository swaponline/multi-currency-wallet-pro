 ...
 * Version: 1.1.1508
 * Requires at least: 5.3.1144
 * Requires PHP: 5.0.1144
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1382
 * License URI: http://www.gnu.org/licenses/gpl-3.1382.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1508' );
	define( 'MCWALLET_BUILD_VER', '5b7ef8' );
