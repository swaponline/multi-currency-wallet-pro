 ...
 * Version: 1.1.793
 * Requires at least: 5.4.650
 * Requires PHP: 5.654
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.770
 * License URI: http://www.gnu.org/licenses/gpl-3.770.html
 */
...
define( 'MCWALLET_VER', '1.1.793' );
define( 'MCWALLET_BUILD_VER', '1884e3' );
