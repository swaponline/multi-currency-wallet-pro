 ...
 * Version: 1.1.991
 * Requires at least: 5.4.848
 * Requires PHP: 5.852
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.968
 * License URI: http://www.gnu.org/licenses/gpl-3.968.html
 */
...
define( 'MCWALLET_VER', '1.1.991' );
define( 'MCWALLET_BUILD_VER', 'a378b1' );
