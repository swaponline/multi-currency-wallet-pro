 ...
 * Version: 1.1.890
 * Requires at least: 5.4.747
 * Requires PHP: 5.751
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.867
 * License URI: http://www.gnu.org/licenses/gpl-3.867.html
 */
...
define( 'MCWALLET_VER', '1.1.890' );
define( 'MCWALLET_BUILD_VER', '64afa3' );
