 ...
 * Version: 1.1.1583
 * Requires at least: 5.3.1217
 * Requires PHP: 5.0.1217
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1455
 * License URI: http://www.gnu.org/licenses/gpl-3.1455.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1583' );
	define( 'MCWALLET_BUILD_VER', 'e90771' );
