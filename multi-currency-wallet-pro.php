 ...
 * Version: 1.1.1494
 * Requires at least: 5.3.1130
 * Requires PHP: 5.0.1130
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1368
 * License URI: http://www.gnu.org/licenses/gpl-3.1368.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1494' );
	define( 'MCWALLET_BUILD_VER', '963410' );
