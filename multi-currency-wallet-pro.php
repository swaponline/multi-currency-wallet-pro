 ...
 * Version: 1.1.794
 * Requires at least: 5.4.651
 * Requires PHP: 5.655
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.771
 * License URI: http://www.gnu.org/licenses/gpl-3.771.html
 */
...
define( 'MCWALLET_VER', '1.1.794' );
define( 'MCWALLET_BUILD_VER', '9e4248' );
