 ...
 * Version: 1.0.557
 * Requires at least: 5.4.414
 * Requires PHP: 5.418
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.534
 * License URI: http://www.gnu.org/licenses/gpl-3.534.html
 */
...
define( 'MCWALLET_VER', '1.0.557' );
define( 'MCWALLET_BUILD_VER', '7be9ea' );
