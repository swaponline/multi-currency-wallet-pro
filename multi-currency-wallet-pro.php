 ...
 * Version: 1.1.923
 * Requires at least: 5.4.780
 * Requires PHP: 5.784
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.900
 * License URI: http://www.gnu.org/licenses/gpl-3.900.html
 */
...
define( 'MCWALLET_VER', '1.1.923' );
define( 'MCWALLET_BUILD_VER', 'def75e' );
