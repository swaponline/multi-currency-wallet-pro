 ...
 * Version: 1.1.730
 * Requires at least: 5.4.587
 * Requires PHP: 5.591
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.707
 * License URI: http://www.gnu.org/licenses/gpl-3.707.html
 */
...
define( 'MCWALLET_VER', '1.1.730' );
define( 'MCWALLET_BUILD_VER', '21426d' );
