 ...
 * Version: 1.0.471
 * Requires at least: 5.4.328
 * Requires PHP: 5.332
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.448
 * License URI: http://www.gnu.org/licenses/gpl-3.448.html
 */
...
define( 'MCWALLET_VER', '1.0.471' );
define( 'MCWALLET_BUILD_VER', 'b153d4' );
