 ...
 * Version: 1.1.937
 * Requires at least: 5.4.794
 * Requires PHP: 5.798
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.914
 * License URI: http://www.gnu.org/licenses/gpl-3.914.html
 */
...
define( 'MCWALLET_VER', '1.1.937' );
define( 'MCWALLET_BUILD_VER', '19dfeb' );
