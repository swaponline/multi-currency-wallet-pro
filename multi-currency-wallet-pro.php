 ...
 * Version: 1.1.869
 * Requires at least: 5.4.726
 * Requires PHP: 5.730
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.846
 * License URI: http://www.gnu.org/licenses/gpl-3.846.html
 */
...
define( 'MCWALLET_VER', '1.1.869' );
define( 'MCWALLET_BUILD_VER', '2be08e' );
