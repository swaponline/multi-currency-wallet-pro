 ...
 * Version: 1.1.1400
 * Requires at least: 5.3.1037
 * Requires PHP: 5.0.1037
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1275
 * License URI: http://www.gnu.org/licenses/gpl-3.1275.html
 */
...
define( 'MCWALLET_VER', '1.1.1400' );
define( 'MCWALLET_BUILD_VER', 'db7872' );
