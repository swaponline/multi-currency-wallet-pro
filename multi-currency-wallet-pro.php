 ...
 * Version: 1.1.734
 * Requires at least: 5.4.591
 * Requires PHP: 5.595
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.711
 * License URI: http://www.gnu.org/licenses/gpl-3.711.html
 */
...
define( 'MCWALLET_VER', '1.1.734' );
define( 'MCWALLET_BUILD_VER', '7cbd94' );
