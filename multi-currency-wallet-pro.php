 ...
 * Version: 1.1.703
 * Requires at least: 5.4.560
 * Requires PHP: 5.564
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.680
 * License URI: http://www.gnu.org/licenses/gpl-3.680.html
 */
...
define( 'MCWALLET_VER', '1.1.703' );
define( 'MCWALLET_BUILD_VER', '9cbeed' );
