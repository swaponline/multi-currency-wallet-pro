 ...
 * Version: 1.1.1184
 * Requires at least: 5.4.944
 * Requires PHP: 5.948
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1064
 * License URI: http://www.gnu.org/licenses/gpl-3.1064.html
 */
...
define( 'MCWALLET_VER', '1.1.1184' );
define( 'MCWALLET_BUILD_VER', 'a7e124' );
