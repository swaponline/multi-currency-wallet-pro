 ...
 * Version: 1.0.338
 * Requires at least: 5.4.195
 * Requires PHP: 5.199
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.315
 * License URI: http://www.gnu.org/licenses/gpl-3.315.html
 */
...
define( 'MCWALLET_VER', '1.0.338' );
define( 'MCWALLET_BUILD_VER', '0aa38d' );
