 ...
 * Version: 1.1.1378
 * Requires at least: 5.3.1015
 * Requires PHP: 5.0.1015
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1253
 * License URI: http://www.gnu.org/licenses/gpl-3.1253.html
 */
...
define( 'MCWALLET_VER', '1.1.1378' );
define( 'MCWALLET_BUILD_VER', '1be90d' );
