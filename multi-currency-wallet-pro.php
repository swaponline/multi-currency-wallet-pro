 ...
 * Version: 1.1.1266
 * Requires at least: 5.3.1003
 * Requires PHP: 5.0.1003
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1141
 * License URI: http://www.gnu.org/licenses/gpl-3.1141.html
 */
...
define( 'MCWALLET_VER', '1.1.1266' );
define( 'MCWALLET_BUILD_VER', 'f23f2b' );
