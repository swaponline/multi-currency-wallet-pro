 ...
 * Version: 1.1.788
 * Requires at least: 5.4.645
 * Requires PHP: 5.649
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.765
 * License URI: http://www.gnu.org/licenses/gpl-3.765.html
 */
...
define( 'MCWALLET_VER', '1.1.788' );
define( 'MCWALLET_BUILD_VER', 'a46944' );
