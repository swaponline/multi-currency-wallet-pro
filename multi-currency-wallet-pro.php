 ...
 * Version: 1.0.280
 * Requires at least: 5.4.137
 * Requires PHP: 5.141
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.257
 * License URI: http://www.gnu.org/licenses/gpl-3.257.html
 */
...
define( 'MCWALLET_VER', '1.0.280' );
define( 'MCWALLET_BUILD_VER', '60a6d7' );
