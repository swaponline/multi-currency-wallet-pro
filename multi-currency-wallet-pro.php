 ...
 * Version: 1.1.1434
 * Requires at least: 5.3.1071
 * Requires PHP: 5.0.1071
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1309
 * License URI: http://www.gnu.org/licenses/gpl-3.1309.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1434' );
	define( 'MCWALLET_BUILD_VER', '29b0cd' );
