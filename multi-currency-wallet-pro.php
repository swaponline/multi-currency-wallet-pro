 ...
 * Version: 1.1.1203
 * Requires at least: 5.4.960
 * Requires PHP: 5.964
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1080
 * License URI: http://www.gnu.org/licenses/gpl-3.1080.html
 */
...
define( 'MCWALLET_VER', '1.1.1203' );
define( 'MCWALLET_BUILD_VER', '9a6cb9' );
