 ...
 * Version: 1.1.816
 * Requires at least: 5.4.673
 * Requires PHP: 5.677
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.793
 * License URI: http://www.gnu.org/licenses/gpl-3.793.html
 */
...
define( 'MCWALLET_VER', '1.1.816' );
define( 'MCWALLET_BUILD_VER', '81ab78' );
