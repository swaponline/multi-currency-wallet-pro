 ...
 * Version: 1.1.1011
 * Requires at least: 5.4.868
 * Requires PHP: 5.872
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.988
 * License URI: http://www.gnu.org/licenses/gpl-3.988.html
 */
...
define( 'MCWALLET_VER', '1.1.1011' );
define( 'MCWALLET_BUILD_VER', 'd8e93a' );
