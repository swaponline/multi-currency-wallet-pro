 ...
 * Version: 1.0.345
 * Requires at least: 5.4.202
 * Requires PHP: 5.206
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.322
 * License URI: http://www.gnu.org/licenses/gpl-3.322.html
 */
...
define( 'MCWALLET_VER', '1.0.345' );
define( 'MCWALLET_BUILD_VER', 'dd27af' );
