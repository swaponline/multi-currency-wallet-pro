 ...
 * Version: 1.1.1338
 * Requires at least: 5.3.1075
 * Requires PHP: 5.0.1075
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1213
 * License URI: http://www.gnu.org/licenses/gpl-3.1213.html
 */
...
define( 'MCWALLET_VER', '1.1.1338' );
define( 'MCWALLET_BUILD_VER', 'f7b752' );
