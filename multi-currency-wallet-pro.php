 ...
 * Version: 1.1.1462
 * Requires at least: 5.3.1098
 * Requires PHP: 5.0.1098
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1336
 * License URI: http://www.gnu.org/licenses/gpl-3.1336.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1462' );
	define( 'MCWALLET_BUILD_VER', 'a6ed56' );
