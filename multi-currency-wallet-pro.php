 ...
 * Version: 1.0.612
 * Requires at least: 5.4.469
 * Requires PHP: 5.473
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.589
 * License URI: http://www.gnu.org/licenses/gpl-3.589.html
 */
...
define( 'MCWALLET_VER', '1.0.612' );
define( 'MCWALLET_BUILD_VER', 'f3b5ac' );
