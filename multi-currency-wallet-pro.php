 ...
 * Version: 1.1.1565
 * Requires at least: 5.3.1199
 * Requires PHP: 5.0.1199
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1437
 * License URI: http://www.gnu.org/licenses/gpl-3.1437.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1565' );
	define( 'MCWALLET_BUILD_VER', '218d6e' );
