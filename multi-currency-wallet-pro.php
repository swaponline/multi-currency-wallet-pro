 ...
 * Version: 1.1.719
 * Requires at least: 5.4.576
 * Requires PHP: 5.580
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.696
 * License URI: http://www.gnu.org/licenses/gpl-3.696.html
 */
...
define( 'MCWALLET_VER', '1.1.719' );
define( 'MCWALLET_BUILD_VER', 'ec60c0' );
