 ...
 * Version: 1.0.255
 * Requires at least: 5.4.112
 * Requires PHP: 5.116
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.232
 * License URI: http://www.gnu.org/licenses/gpl-3.232.html
 */
...
define( 'MCWALLET_VER', '1.0.255' );
define( 'MCWALLET_BUILD_VER', '658fa4' );
