 ...
 * Version: 1.1.852
 * Requires at least: 5.4.709
 * Requires PHP: 5.713
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.829
 * License URI: http://www.gnu.org/licenses/gpl-3.829.html
 */
...
define( 'MCWALLET_VER', '1.1.852' );
define( 'MCWALLET_BUILD_VER', '349c6c' );
