 ...
 * Version: 1.0.617
 * Requires at least: 5.4.474
 * Requires PHP: 5.478
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.594
 * License URI: http://www.gnu.org/licenses/gpl-3.594.html
 */
...
define( 'MCWALLET_VER', '1.0.617' );
define( 'MCWALLET_BUILD_VER', 'aa2b76' );
