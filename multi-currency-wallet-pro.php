 ...
 * Version: 1.0.473
 * Requires at least: 5.4.330
 * Requires PHP: 5.334
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.450
 * License URI: http://www.gnu.org/licenses/gpl-3.450.html
 */
...
define( 'MCWALLET_VER', '1.0.473' );
define( 'MCWALLET_BUILD_VER', '594f56' );
