 ...
 * Version: 1.0.595
 * Requires at least: 5.4.452
 * Requires PHP: 5.456
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.572
 * License URI: http://www.gnu.org/licenses/gpl-3.572.html
 */
...
define( 'MCWALLET_VER', '1.0.595' );
define( 'MCWALLET_BUILD_VER', 'b11c40' );
