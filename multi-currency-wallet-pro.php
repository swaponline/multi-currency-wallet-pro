 ...
 * Version: 1.1.821
 * Requires at least: 5.4.678
 * Requires PHP: 5.682
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.798
 * License URI: http://www.gnu.org/licenses/gpl-3.798.html
 */
...
define( 'MCWALLET_VER', '1.1.821' );
define( 'MCWALLET_BUILD_VER', '331608' );
