 ...
 * Version: 1.1.1489
 * Requires at least: 5.3.1125
 * Requires PHP: 5.0.1125
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1363
 * License URI: http://www.gnu.org/licenses/gpl-3.1363.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1489' );
	define( 'MCWALLET_BUILD_VER', 'c65861' );
