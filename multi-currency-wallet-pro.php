 ...
 * Version: 1.1.1308
 * Requires at least: 5.3.1045
 * Requires PHP: 5.0.1045
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1183
 * License URI: http://www.gnu.org/licenses/gpl-3.1183.html
 */
...
define( 'MCWALLET_VER', '1.1.1308' );
define( 'MCWALLET_BUILD_VER', 'da677b' );
