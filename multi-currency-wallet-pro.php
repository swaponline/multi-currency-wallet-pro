 ...
 * Version: 1.1.747
 * Requires at least: 5.4.604
 * Requires PHP: 5.608
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.724
 * License URI: http://www.gnu.org/licenses/gpl-3.724.html
 */
...
define( 'MCWALLET_VER', '1.1.747' );
define( 'MCWALLET_BUILD_VER', '78b647' );
