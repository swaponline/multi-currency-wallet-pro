 ...
 * Version: 1.1.1371
 * Requires at least: 5.3.1108
 * Requires PHP: 5.0.1108
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1246
 * License URI: http://www.gnu.org/licenses/gpl-3.1246.html
 */
...
define( 'MCWALLET_VER', '1.1.1371' );
define( 'MCWALLET_BUILD_VER', 'da44cc' );
