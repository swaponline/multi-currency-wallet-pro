 ...
 * Version: 1.0.558
 * Requires at least: 5.4.415
 * Requires PHP: 5.419
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.535
 * License URI: http://www.gnu.org/licenses/gpl-3.535.html
 */
...
define( 'MCWALLET_VER', '1.0.558' );
define( 'MCWALLET_BUILD_VER', '582e1b' );
