 ...
 * Version: 1.0.616
 * Requires at least: 5.4.473
 * Requires PHP: 5.477
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.593
 * License URI: http://www.gnu.org/licenses/gpl-3.593.html
 */
...
define( 'MCWALLET_VER', '1.0.616' );
define( 'MCWALLET_BUILD_VER', 'ee2c9e' );
