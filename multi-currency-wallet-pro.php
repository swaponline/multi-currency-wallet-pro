 ...
 * Version: 1.0.517
 * Requires at least: 5.4.374
 * Requires PHP: 5.378
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.494
 * License URI: http://www.gnu.org/licenses/gpl-3.494.html
 */
...
define( 'MCWALLET_VER', '1.0.517' );
define( 'MCWALLET_BUILD_VER', '602464' );
