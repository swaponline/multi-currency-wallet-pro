 ...
 * Version: 1.1.837
 * Requires at least: 5.4.694
 * Requires PHP: 5.698
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.814
 * License URI: http://www.gnu.org/licenses/gpl-3.814.html
 */
...
define( 'MCWALLET_VER', '1.1.837' );
define( 'MCWALLET_BUILD_VER', '219800' );
