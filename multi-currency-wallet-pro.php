 ...
 * Version: 1.1.892
 * Requires at least: 5.4.749
 * Requires PHP: 5.753
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.869
 * License URI: http://www.gnu.org/licenses/gpl-3.869.html
 */
...
define( 'MCWALLET_VER', '1.1.892' );
define( 'MCWALLET_BUILD_VER', 'b59151' );
