 ...
 * Version: 1.1.806
 * Requires at least: 5.4.663
 * Requires PHP: 5.667
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.783
 * License URI: http://www.gnu.org/licenses/gpl-3.783.html
 */
...
define( 'MCWALLET_VER', '1.1.806' );
define( 'MCWALLET_BUILD_VER', '6a659c' );
