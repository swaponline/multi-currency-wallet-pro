 ...
 * Version: 1.1.800
 * Requires at least: 5.4.657
 * Requires PHP: 5.661
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.777
 * License URI: http://www.gnu.org/licenses/gpl-3.777.html
 */
...
define( 'MCWALLET_VER', '1.1.800' );
define( 'MCWALLET_BUILD_VER', 'd7690a' );
