 ...
 * Version: 1.1.1555
 * Requires at least: 5.3.1189
 * Requires PHP: 5.0.1189
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1427
 * License URI: http://www.gnu.org/licenses/gpl-3.1427.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1555' );
	define( 'MCWALLET_BUILD_VER', '8cb63f' );
