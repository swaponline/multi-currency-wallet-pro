 ...
 * Version: 1.1.698
 * Requires at least: 5.4.555
 * Requires PHP: 5.559
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.675
 * License URI: http://www.gnu.org/licenses/gpl-3.675.html
 */
...
define( 'MCWALLET_VER', '1.1.698' );
define( 'MCWALLET_BUILD_VER', '4b62fe' );
