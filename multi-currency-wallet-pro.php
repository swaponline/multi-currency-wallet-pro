 ...
 * Version: 1.0.373
 * Requires at least: 5.4.230
 * Requires PHP: 5.234
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.350
 * License URI: http://www.gnu.org/licenses/gpl-3.350.html
 */
...
define( 'MCWALLET_VER', '1.0.373' );
define( 'MCWALLET_BUILD_VER', '129cae' );
