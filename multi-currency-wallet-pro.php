 ...
 * Version: 1.1.797
 * Requires at least: 5.4.654
 * Requires PHP: 5.658
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.774
 * License URI: http://www.gnu.org/licenses/gpl-3.774.html
 */
...
define( 'MCWALLET_VER', '1.1.797' );
define( 'MCWALLET_BUILD_VER', '37cbee' );
