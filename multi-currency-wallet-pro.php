 ...
 * Version: 1.1.1048
 * Requires at least: 5.4.904
 * Requires PHP: 5.908
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1024
 * License URI: http://www.gnu.org/licenses/gpl-3.1024.html
 */
...
define( 'MCWALLET_VER', '1.1.1048' );
define( 'MCWALLET_BUILD_VER', 'a624fe' );
