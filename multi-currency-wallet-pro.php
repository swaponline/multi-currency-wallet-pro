 ...
 * Version: 1.1.699
 * Requires at least: 5.4.556
 * Requires PHP: 5.560
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.676
 * License URI: http://www.gnu.org/licenses/gpl-3.676.html
 */
...
define( 'MCWALLET_VER', '1.1.699' );
define( 'MCWALLET_BUILD_VER', '3fe859' );
