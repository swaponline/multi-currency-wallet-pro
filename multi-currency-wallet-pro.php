 ...
 * Version: 1.0.562
 * Requires at least: 5.4.419
 * Requires PHP: 5.423
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.539
 * License URI: http://www.gnu.org/licenses/gpl-3.539.html
 */
...
define( 'MCWALLET_VER', '1.0.562' );
define( 'MCWALLET_BUILD_VER', 'f61bcd' );
