 ...
 * Version: 1.0.337
 * Requires at least: 5.4.194
 * Requires PHP: 5.198
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.314
 * License URI: http://www.gnu.org/licenses/gpl-3.314.html
 */
...
define( 'MCWALLET_VER', '1.0.337' );
define( 'MCWALLET_BUILD_VER', '4f1ecd' );
