 ...
 * Version: 1.1.934
 * Requires at least: 5.4.791
 * Requires PHP: 5.795
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.911
 * License URI: http://www.gnu.org/licenses/gpl-3.911.html
 */
...
define( 'MCWALLET_VER', '1.1.934' );
define( 'MCWALLET_BUILD_VER', 'fc0dc7' );
