 ...
 * Version: 1.0.577
 * Requires at least: 5.4.434
 * Requires PHP: 5.438
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.554
 * License URI: http://www.gnu.org/licenses/gpl-3.554.html
 */
...
define( 'MCWALLET_VER', '1.0.577' );
define( 'MCWALLET_BUILD_VER', '024e47' );
