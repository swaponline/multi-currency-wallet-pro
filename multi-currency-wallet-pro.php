 ...
 * Version: 1.1.770
 * Requires at least: 5.4.627
 * Requires PHP: 5.631
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.747
 * License URI: http://www.gnu.org/licenses/gpl-3.747.html
 */
...
define( 'MCWALLET_VER', '1.1.770' );
define( 'MCWALLET_BUILD_VER', '515f27' );
