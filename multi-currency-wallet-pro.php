 ...
 * Version: 1.1.853
 * Requires at least: 5.4.710
 * Requires PHP: 5.714
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.830
 * License URI: http://www.gnu.org/licenses/gpl-3.830.html
 */
...
define( 'MCWALLET_VER', '1.1.853' );
define( 'MCWALLET_BUILD_VER', 'fc60bf' );
