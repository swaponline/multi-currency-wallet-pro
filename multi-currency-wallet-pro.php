 ...
 * Version: 1.0.585
 * Requires at least: 5.4.442
 * Requires PHP: 5.446
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.562
 * License URI: http://www.gnu.org/licenses/gpl-3.562.html
 */
...
define( 'MCWALLET_VER', '1.0.585' );
define( 'MCWALLET_BUILD_VER', 'e8f110' );
