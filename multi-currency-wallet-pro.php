 ...
 * Version: 1.0.626
 * Requires at least: 5.4.483
 * Requires PHP: 5.487
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.603
 * License URI: http://www.gnu.org/licenses/gpl-3.603.html
 */
...
define( 'MCWALLET_VER', '1.0.626' );
define( 'MCWALLET_BUILD_VER', 'f6c604' );
