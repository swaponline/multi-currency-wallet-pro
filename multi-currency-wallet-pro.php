 ...
 * Version: 1.0.487
 * Requires at least: 5.4.344
 * Requires PHP: 5.348
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.464
 * License URI: http://www.gnu.org/licenses/gpl-3.464.html
 */
...
define( 'MCWALLET_VER', '1.0.487' );
define( 'MCWALLET_BUILD_VER', 'e64290' );
