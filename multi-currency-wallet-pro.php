 ...
 * Version: 1.0.515
 * Requires at least: 5.4.372
 * Requires PHP: 5.376
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.492
 * License URI: http://www.gnu.org/licenses/gpl-3.492.html
 */
...
define( 'MCWALLET_VER', '1.0.515' );
define( 'MCWALLET_BUILD_VER', 'b30fac' );
