 ...
 * Version: 1.0.308
 * Requires at least: 5.4.165
 * Requires PHP: 5.169
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.285
 * License URI: http://www.gnu.org/licenses/gpl-3.285.html
 */
...
define( 'MCWALLET_VER', '1.0.308' );
define( 'MCWALLET_BUILD_VER', 'e8d50b' );
