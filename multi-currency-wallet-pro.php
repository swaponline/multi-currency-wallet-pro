 ...
 * Version: 1.0.630
 * Requires at least: 5.4.487
 * Requires PHP: 5.491
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.607
 * License URI: http://www.gnu.org/licenses/gpl-3.607.html
 */
...
define( 'MCWALLET_VER', '1.0.630' );
define( 'MCWALLET_BUILD_VER', 'd3d331' );
