 ...
 * Version: 1.0.462
 * Requires at least: 5.4.319
 * Requires PHP: 5.323
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.439
 * License URI: http://www.gnu.org/licenses/gpl-3.439.html
 */
...
define( 'MCWALLET_VER', '1.0.462' );
define( 'MCWALLET_BUILD_VER', 'c780c5' );
