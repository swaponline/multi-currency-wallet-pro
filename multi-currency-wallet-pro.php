 ...
 * Version: 1.1.1566
 * Requires at least: 5.3.1200
 * Requires PHP: 5.0.1200
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1438
 * License URI: http://www.gnu.org/licenses/gpl-3.1438.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1566' );
	define( 'MCWALLET_BUILD_VER', '89df79' );
