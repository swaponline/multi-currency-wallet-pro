 ...
 * Version: 1.0.576
 * Requires at least: 5.4.433
 * Requires PHP: 5.437
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.553
 * License URI: http://www.gnu.org/licenses/gpl-3.553.html
 */
...
define( 'MCWALLET_VER', '1.0.576' );
define( 'MCWALLET_BUILD_VER', '6e0c37' );
