 ...
 * Version: 1.1.736
 * Requires at least: 5.4.593
 * Requires PHP: 5.597
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.713
 * License URI: http://www.gnu.org/licenses/gpl-3.713.html
 */
...
define( 'MCWALLET_VER', '1.1.736' );
define( 'MCWALLET_BUILD_VER', '8df7be' );
