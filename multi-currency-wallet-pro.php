 ...
 * Version: 1.1.839
 * Requires at least: 5.4.696
 * Requires PHP: 5.700
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.816
 * License URI: http://www.gnu.org/licenses/gpl-3.816.html
 */
...
define( 'MCWALLET_VER', '1.1.839' );
define( 'MCWALLET_BUILD_VER', 'b29741' );
