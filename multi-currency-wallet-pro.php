 ...
 * Version: 1.1.946
 * Requires at least: 5.4.803
 * Requires PHP: 5.807
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.923
 * License URI: http://www.gnu.org/licenses/gpl-3.923.html
 */
...
define( 'MCWALLET_VER', '1.1.946' );
define( 'MCWALLET_BUILD_VER', '0855f6' );
