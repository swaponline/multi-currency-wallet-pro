 ...
 * Version: 1.0.561
 * Requires at least: 5.4.418
 * Requires PHP: 5.422
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.538
 * License URI: http://www.gnu.org/licenses/gpl-3.538.html
 */
...
define( 'MCWALLET_VER', '1.0.561' );
define( 'MCWALLET_BUILD_VER', '741e89' );
