 ...
 * Version: 1.1.847
 * Requires at least: 5.4.704
 * Requires PHP: 5.708
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.824
 * License URI: http://www.gnu.org/licenses/gpl-3.824.html
 */
...
define( 'MCWALLET_VER', '1.1.847' );
define( 'MCWALLET_BUILD_VER', '42165a' );
