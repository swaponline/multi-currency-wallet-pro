 ...
 * Version: 1.1.879
 * Requires at least: 5.4.736
 * Requires PHP: 5.740
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.856
 * License URI: http://www.gnu.org/licenses/gpl-3.856.html
 */
...
define( 'MCWALLET_VER', '1.1.879' );
define( 'MCWALLET_BUILD_VER', '86e87c' );
