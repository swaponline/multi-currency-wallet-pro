 ...
 * Version: 1.1.889
 * Requires at least: 5.4.746
 * Requires PHP: 5.750
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.866
 * License URI: http://www.gnu.org/licenses/gpl-3.866.html
 */
...
define( 'MCWALLET_VER', '1.1.889' );
define( 'MCWALLET_BUILD_VER', 'bf773d' );
