 ...
 * Version: 1.0.573
 * Requires at least: 5.4.430
 * Requires PHP: 5.434
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.550
 * License URI: http://www.gnu.org/licenses/gpl-3.550.html
 */
...
define( 'MCWALLET_VER', '1.0.573' );
define( 'MCWALLET_BUILD_VER', '8590d7' );
