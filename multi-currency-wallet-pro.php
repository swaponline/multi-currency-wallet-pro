 ...
 * Version: 1.1.1181
 * Requires at least: 5.4.941
 * Requires PHP: 5.945
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1061
 * License URI: http://www.gnu.org/licenses/gpl-3.1061.html
 */
...
define( 'MCWALLET_VER', '1.1.1181' );
define( 'MCWALLET_BUILD_VER', 'f1f749' );
