 ...
 * Version: 1.0.526
 * Requires at least: 5.4.383
 * Requires PHP: 5.387
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.503
 * License URI: http://www.gnu.org/licenses/gpl-3.503.html
 */
...
define( 'MCWALLET_VER', '1.0.526' );
define( 'MCWALLET_BUILD_VER', '14ccf1' );
