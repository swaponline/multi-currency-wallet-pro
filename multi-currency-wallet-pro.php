 ...
 * Version: 1.0.506
 * Requires at least: 5.4.363
 * Requires PHP: 5.367
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.483
 * License URI: http://www.gnu.org/licenses/gpl-3.483.html
 */
...
define( 'MCWALLET_VER', '1.0.506' );
define( 'MCWALLET_BUILD_VER', '16509d' );
