 ...
 * Version: 1.0.340
 * Requires at least: 5.4.197
 * Requires PHP: 5.201
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.317
 * License URI: http://www.gnu.org/licenses/gpl-3.317.html
 */
...
define( 'MCWALLET_VER', '1.0.340' );
define( 'MCWALLET_BUILD_VER', 'c45528' );
