 ...
 * Version: 1.0.546
 * Requires at least: 5.4.403
 * Requires PHP: 5.407
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.523
 * License URI: http://www.gnu.org/licenses/gpl-3.523.html
 */
...
define( 'MCWALLET_VER', '1.0.546' );
define( 'MCWALLET_BUILD_VER', 'bdd4d2' );
