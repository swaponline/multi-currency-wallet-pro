 ...
 * Version: 1.1.791
 * Requires at least: 5.4.648
 * Requires PHP: 5.652
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.768
 * License URI: http://www.gnu.org/licenses/gpl-3.768.html
 */
...
define( 'MCWALLET_VER', '1.1.791' );
define( 'MCWALLET_BUILD_VER', 'ca0a15' );
