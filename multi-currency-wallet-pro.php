 ...
 * Version: 1.1.854
 * Requires at least: 5.4.711
 * Requires PHP: 5.715
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.831
 * License URI: http://www.gnu.org/licenses/gpl-3.831.html
 */
...
define( 'MCWALLET_VER', '1.1.854' );
define( 'MCWALLET_BUILD_VER', '4a3e62' );
