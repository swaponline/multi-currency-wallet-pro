 ...
 * Version: 1.1.1055
 * Requires at least: 5.4.911
 * Requires PHP: 5.915
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1031
 * License URI: http://www.gnu.org/licenses/gpl-3.1031.html
 */
...
define( 'MCWALLET_VER', '1.1.1055' );
define( 'MCWALLET_BUILD_VER', 'e8a71c' );
