 ...
 * Version: 1.0.323
 * Requires at least: 5.4.180
 * Requires PHP: 5.184
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.300
 * License URI: http://www.gnu.org/licenses/gpl-3.300.html
 */
...
define( 'MCWALLET_VER', '1.0.323' );
define( 'MCWALLET_BUILD_VER', 'aa906f' );
