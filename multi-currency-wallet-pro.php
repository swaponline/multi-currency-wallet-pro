 ...
 * Version: 1.1.775
 * Requires at least: 5.4.632
 * Requires PHP: 5.636
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.752
 * License URI: http://www.gnu.org/licenses/gpl-3.752.html
 */
...
define( 'MCWALLET_VER', '1.1.775' );
define( 'MCWALLET_BUILD_VER', '72dd80' );
