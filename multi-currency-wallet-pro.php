 ...
 * Version: 1.0.439
 * Requires at least: 5.4.296
 * Requires PHP: 5.300
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.416
 * License URI: http://www.gnu.org/licenses/gpl-3.416.html
 */
...
define( 'MCWALLET_VER', '1.0.439' );
define( 'MCWALLET_BUILD_VER', 'e9a9de' );
