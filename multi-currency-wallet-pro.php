 ...
 * Version: 1.0.389
 * Requires at least: 5.4.246
 * Requires PHP: 5.250
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.366
 * License URI: http://www.gnu.org/licenses/gpl-3.366.html
 */
...
define( 'MCWALLET_VER', '1.0.389' );
define( 'MCWALLET_BUILD_VER', '546306' );
