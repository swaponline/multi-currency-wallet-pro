 ...
 * Version: 1.0.445
 * Requires at least: 5.4.302
 * Requires PHP: 5.306
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.422
 * License URI: http://www.gnu.org/licenses/gpl-3.422.html
 */
...
define( 'MCWALLET_VER', '1.0.445' );
define( 'MCWALLET_BUILD_VER', '01d4f6' );
