 ...
 * Version: 1.1.1502
 * Requires at least: 5.3.1138
 * Requires PHP: 5.0.1138
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1376
 * License URI: http://www.gnu.org/licenses/gpl-3.1376.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1502' );
	define( 'MCWALLET_BUILD_VER', 'fb98cc' );
