 ...
 * Version: 1.1.887
 * Requires at least: 5.4.744
 * Requires PHP: 5.748
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.864
 * License URI: http://www.gnu.org/licenses/gpl-3.864.html
 */
...
define( 'MCWALLET_VER', '1.1.887' );
define( 'MCWALLET_BUILD_VER', '7fff58' );
