 ...
 * Version: 1.0.309
 * Requires at least: 5.4.166
 * Requires PHP: 5.170
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.286
 * License URI: http://www.gnu.org/licenses/gpl-3.286.html
 */
...
define( 'MCWALLET_VER', '1.0.309' );
define( 'MCWALLET_BUILD_VER', '7404ae' );
