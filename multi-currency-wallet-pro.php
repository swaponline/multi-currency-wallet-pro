 ...
 * Version: 1.1.732
 * Requires at least: 5.4.589
 * Requires PHP: 5.593
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.709
 * License URI: http://www.gnu.org/licenses/gpl-3.709.html
 */
...
define( 'MCWALLET_VER', '1.1.732' );
define( 'MCWALLET_BUILD_VER', '34a66f' );
