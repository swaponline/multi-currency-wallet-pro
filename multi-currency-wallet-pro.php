 ...
 * Version: 1.0.438
 * Requires at least: 5.4.295
 * Requires PHP: 5.299
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.415
 * License URI: http://www.gnu.org/licenses/gpl-3.415.html
 */
...
define( 'MCWALLET_VER', '1.0.438' );
define( 'MCWALLET_BUILD_VER', '32c4c8' );
