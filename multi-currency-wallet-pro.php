 ...
 * Version: 1.1.1023
 * Requires at least: 5.4.879
 * Requires PHP: 5.883
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.999
 * License URI: http://www.gnu.org/licenses/gpl-3.999.html
 */
...
define( 'MCWALLET_VER', '1.1.1023' );
define( 'MCWALLET_BUILD_VER', '93a885' );
