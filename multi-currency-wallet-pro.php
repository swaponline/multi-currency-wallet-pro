 ...
 * Version: 1.1.729
 * Requires at least: 5.4.586
 * Requires PHP: 5.590
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.706
 * License URI: http://www.gnu.org/licenses/gpl-3.706.html
 */
...
define( 'MCWALLET_VER', '1.1.729' );
define( 'MCWALLET_BUILD_VER', '731349' );
