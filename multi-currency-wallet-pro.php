 ...
 * Version: 1.1.1350
 * Requires at least: 5.3.1087
 * Requires PHP: 5.0.1087
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1225
 * License URI: http://www.gnu.org/licenses/gpl-3.1225.html
 */
...
define( 'MCWALLET_VER', '1.1.1350' );
define( 'MCWALLET_BUILD_VER', '35b46c' );
