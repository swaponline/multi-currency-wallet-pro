 ...
 * Version: 1.1.1466
 * Requires at least: 5.3.1102
 * Requires PHP: 5.0.1102
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1340
 * License URI: http://www.gnu.org/licenses/gpl-3.1340.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1466' );
	define( 'MCWALLET_BUILD_VER', '1e3c1a' );
