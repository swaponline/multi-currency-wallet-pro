 ...
 * Version: 1.0.328
 * Requires at least: 5.4.185
 * Requires PHP: 5.189
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.305
 * License URI: http://www.gnu.org/licenses/gpl-3.305.html
 */
...
define( 'MCWALLET_VER', '1.0.328' );
define( 'MCWALLET_BUILD_VER', 'b74389' );
