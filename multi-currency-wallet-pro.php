 ...
 * Version: 1.0.360
 * Requires at least: 5.4.217
 * Requires PHP: 5.221
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.337
 * License URI: http://www.gnu.org/licenses/gpl-3.337.html
 */
...
define( 'MCWALLET_VER', '1.0.360' );
define( 'MCWALLET_BUILD_VER', 'a22cdd' );
