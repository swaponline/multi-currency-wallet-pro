 ...
 * Version: 1.1.1329
 * Requires at least: 5.3.1066
 * Requires PHP: 5.0.1066
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1204
 * License URI: http://www.gnu.org/licenses/gpl-3.1204.html
 */
...
define( 'MCWALLET_VER', '1.1.1329' );
define( 'MCWALLET_BUILD_VER', '028dc1' );
