 ...
 * Version: 1.1.1039
 * Requires at least: 5.4.895
 * Requires PHP: 5.899
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1015
 * License URI: http://www.gnu.org/licenses/gpl-3.1015.html
 */
...
define( 'MCWALLET_VER', '1.1.1039' );
define( 'MCWALLET_BUILD_VER', 'f3cedf' );
