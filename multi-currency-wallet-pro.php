 ...
 * Version: 1.1.924
 * Requires at least: 5.4.781
 * Requires PHP: 5.785
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.901
 * License URI: http://www.gnu.org/licenses/gpl-3.901.html
 */
...
define( 'MCWALLET_VER', '1.1.924' );
define( 'MCWALLET_BUILD_VER', '0a82cd' );
