 ...
 * Version: 1.0.248
 * Requires at least: 5.4.105
 * Requires PHP: 5.109
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.225
 * License URI: http://www.gnu.org/licenses/gpl-3.225.html
 */
...
define( 'MCWALLET_VER', '1.0.248' );
define( 'MCWALLET_BUILD_VER', '8ad9fc' );
