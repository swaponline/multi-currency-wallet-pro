 ...
 * Version: 1.0.405
 * Requires at least: 5.4.262
 * Requires PHP: 5.266
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.382
 * License URI: http://www.gnu.org/licenses/gpl-3.382.html
 */
...
define( 'MCWALLET_VER', '1.0.405' );
define( 'MCWALLET_BUILD_VER', 'd084b8' );
