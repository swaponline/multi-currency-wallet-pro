 ...
 * Version: 1.1.784
 * Requires at least: 5.4.641
 * Requires PHP: 5.645
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.761
 * License URI: http://www.gnu.org/licenses/gpl-3.761.html
 */
...
define( 'MCWALLET_VER', '1.1.784' );
define( 'MCWALLET_BUILD_VER', 'cab574' );
