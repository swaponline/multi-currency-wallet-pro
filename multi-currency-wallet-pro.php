 ...
 * Version: 1.0.645
 * Requires at least: 5.4.502
 * Requires PHP: 5.506
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.622
 * License URI: http://www.gnu.org/licenses/gpl-3.622.html
 */
...
define( 'MCWALLET_VER', '1.0.645' );
define( 'MCWALLET_BUILD_VER', '2bf53a' );
