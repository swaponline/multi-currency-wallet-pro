 ...
 * Version: 1.0.575
 * Requires at least: 5.4.432
 * Requires PHP: 5.436
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.552
 * License URI: http://www.gnu.org/licenses/gpl-3.552.html
 */
...
define( 'MCWALLET_VER', '1.0.575' );
define( 'MCWALLET_BUILD_VER', 'c8c8fb' );
