 ...
 * Version: 1.1.1449
 * Requires at least: 5.3.1086
 * Requires PHP: 5.0.1086
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1324
 * License URI: http://www.gnu.org/licenses/gpl-3.1324.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1449' );
	define( 'MCWALLET_BUILD_VER', 'e9d47e' );
