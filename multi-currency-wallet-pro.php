 ...
 * Version: 1.1.1013
 * Requires at least: 5.4.870
 * Requires PHP: 5.874
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.990
 * License URI: http://www.gnu.org/licenses/gpl-3.990.html
 */
...
define( 'MCWALLET_VER', '1.1.1013' );
define( 'MCWALLET_BUILD_VER', 'ce57af' );
