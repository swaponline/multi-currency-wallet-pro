 ...
 * Version: 1.0.652
 * Requires at least: 5.4.509
 * Requires PHP: 5.513
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.629
 * License URI: http://www.gnu.org/licenses/gpl-3.629.html
 */
...
define( 'MCWALLET_VER', '1.0.652' );
define( 'MCWALLET_BUILD_VER', '931944' );
