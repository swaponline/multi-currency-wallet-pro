 ...
 * Version: 1.0.633
 * Requires at least: 5.4.490
 * Requires PHP: 5.494
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.610
 * License URI: http://www.gnu.org/licenses/gpl-3.610.html
 */
...
define( 'MCWALLET_VER', '1.0.633' );
define( 'MCWALLET_BUILD_VER', '47179b' );
