 ...
 * Version: 1.1.841
 * Requires at least: 5.4.698
 * Requires PHP: 5.702
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.818
 * License URI: http://www.gnu.org/licenses/gpl-3.818.html
 */
...
define( 'MCWALLET_VER', '1.1.841' );
define( 'MCWALLET_BUILD_VER', '67ecee' );
