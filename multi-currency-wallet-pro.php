 ...
 * Version: 1.1.1198
 * Requires at least: 5.4.956
 * Requires PHP: 5.960
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1076
 * License URI: http://www.gnu.org/licenses/gpl-3.1076.html
 */
...
define( 'MCWALLET_VER', '1.1.1198' );
define( 'MCWALLET_BUILD_VER', '7faf1d' );
