 ...
 * Version: 1.0.407
 * Requires at least: 5.4.264
 * Requires PHP: 5.268
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.384
 * License URI: http://www.gnu.org/licenses/gpl-3.384.html
 */
...
define( 'MCWALLET_VER', '1.0.407' );
define( 'MCWALLET_BUILD_VER', '5680f4' );
