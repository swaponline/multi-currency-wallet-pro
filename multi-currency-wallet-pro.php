 ...
 * Version: 1.1.1435
 * Requires at least: 5.3.1072
 * Requires PHP: 5.0.1072
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1310
 * License URI: http://www.gnu.org/licenses/gpl-3.1310.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1435' );
	define( 'MCWALLET_BUILD_VER', '7a49c6' );
