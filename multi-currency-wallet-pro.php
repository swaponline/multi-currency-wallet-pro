 ...
 * Version: 1.0.324
 * Requires at least: 5.4.181
 * Requires PHP: 5.185
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.301
 * License URI: http://www.gnu.org/licenses/gpl-3.301.html
 */
...
define( 'MCWALLET_VER', '1.0.324' );
define( 'MCWALLET_BUILD_VER', 'ddbd56' );
