 ...
 * Version: 1.1.710
 * Requires at least: 5.4.567
 * Requires PHP: 5.571
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.687
 * License URI: http://www.gnu.org/licenses/gpl-3.687.html
 */
...
define( 'MCWALLET_VER', '1.1.710' );
define( 'MCWALLET_BUILD_VER', '2900b0' );
