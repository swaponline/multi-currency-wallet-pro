 ...
 * Version: 1.1.1468
 * Requires at least: 5.3.1104
 * Requires PHP: 5.0.1104
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1342
 * License URI: http://www.gnu.org/licenses/gpl-3.1342.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1468' );
	define( 'MCWALLET_BUILD_VER', '1e41b1' );
