 ...
 * Version: 1.0.545
 * Requires at least: 5.4.402
 * Requires PHP: 5.406
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.522
 * License URI: http://www.gnu.org/licenses/gpl-3.522.html
 */
...
define( 'MCWALLET_VER', '1.0.545' );
define( 'MCWALLET_BUILD_VER', '05ee04' );
