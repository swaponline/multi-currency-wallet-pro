 ...
 * Version: 1.0.510
 * Requires at least: 5.4.367
 * Requires PHP: 5.371
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.487
 * License URI: http://www.gnu.org/licenses/gpl-3.487.html
 */
...
define( 'MCWALLET_VER', '1.0.510' );
define( 'MCWALLET_BUILD_VER', '444360' );
