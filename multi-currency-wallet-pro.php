 ...
 * Version: 1.1.888
 * Requires at least: 5.4.745
 * Requires PHP: 5.749
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.865
 * License URI: http://www.gnu.org/licenses/gpl-3.865.html
 */
...
define( 'MCWALLET_VER', '1.1.888' );
define( 'MCWALLET_BUILD_VER', '3ad185' );
