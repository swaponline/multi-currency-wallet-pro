 ...
 * Version: 1.0.631
 * Requires at least: 5.4.488
 * Requires PHP: 5.492
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.608
 * License URI: http://www.gnu.org/licenses/gpl-3.608.html
 */
...
define( 'MCWALLET_VER', '1.0.631' );
define( 'MCWALLET_BUILD_VER', 'ba4bbd' );
