 ...
 * Version: 1.0.418
 * Requires at least: 5.4.275
 * Requires PHP: 5.279
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.395
 * License URI: http://www.gnu.org/licenses/gpl-3.395.html
 */
...
define( 'MCWALLET_VER', '1.0.418' );
define( 'MCWALLET_BUILD_VER', 'aec65d' );
