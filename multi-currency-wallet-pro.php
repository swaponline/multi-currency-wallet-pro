 ...
 * Version: 1.1.1280
 * Requires at least: 5.3.1017
 * Requires PHP: 5.0.1017
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1155
 * License URI: http://www.gnu.org/licenses/gpl-3.1155.html
 */
...
define( 'MCWALLET_VER', '1.1.1280' );
define( 'MCWALLET_BUILD_VER', '5172e7' );
