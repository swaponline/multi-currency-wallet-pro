 ...
 * Version: 1.1.1239
 * Requires at least: 5.4.994
 * Requires PHP: 5.998
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1114
 * License URI: http://www.gnu.org/licenses/gpl-3.1114.html
 */
...
define( 'MCWALLET_VER', '1.1.1239' );
define( 'MCWALLET_BUILD_VER', '51c1e0' );
