 ...
 * Version: 1.1.706
 * Requires at least: 5.4.563
 * Requires PHP: 5.567
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.683
 * License URI: http://www.gnu.org/licenses/gpl-3.683.html
 */
...
define( 'MCWALLET_VER', '1.1.706' );
define( 'MCWALLET_BUILD_VER', 'ac43f9' );
