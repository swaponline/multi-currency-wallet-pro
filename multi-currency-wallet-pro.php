 ...
 * Version: 1.0.356
 * Requires at least: 5.4.213
 * Requires PHP: 5.217
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.333
 * License URI: http://www.gnu.org/licenses/gpl-3.333.html
 */
...
define( 'MCWALLET_VER', '1.0.356' );
define( 'MCWALLET_BUILD_VER', '26d400' );
