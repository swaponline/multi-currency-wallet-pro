 ...
 * Version: 1.0.336
 * Requires at least: 5.4.193
 * Requires PHP: 5.197
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.313
 * License URI: http://www.gnu.org/licenses/gpl-3.313.html
 */
...
define( 'MCWALLET_VER', '1.0.336' );
define( 'MCWALLET_BUILD_VER', 'd671bf' );
