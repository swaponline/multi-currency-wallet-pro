 ...
 * Version: 1.1.1375
 * Requires at least: 5.3.1012
 * Requires PHP: 5.0.1012
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1250
 * License URI: http://www.gnu.org/licenses/gpl-3.1250.html
 */
...
define( 'MCWALLET_VER', '1.1.1375' );
define( 'MCWALLET_BUILD_VER', '5dc797' );
