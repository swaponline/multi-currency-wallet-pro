 ...
 * Version: 1.0.343
 * Requires at least: 5.4.200
 * Requires PHP: 5.204
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.320
 * License URI: http://www.gnu.org/licenses/gpl-3.320.html
 */
...
define( 'MCWALLET_VER', '1.0.343' );
define( 'MCWALLET_BUILD_VER', '494bc9' );
