 ...
 * Version: 1.1.750
 * Requires at least: 5.4.607
 * Requires PHP: 5.611
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.727
 * License URI: http://www.gnu.org/licenses/gpl-3.727.html
 */
...
define( 'MCWALLET_VER', '1.1.750' );
define( 'MCWALLET_BUILD_VER', '1221bf' );
