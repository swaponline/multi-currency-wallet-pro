 ...
 * Version: 1.1.656
 * Requires at least: 5.4.513
 * Requires PHP: 5.517
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.633
 * License URI: http://www.gnu.org/licenses/gpl-3.633.html
 */
...
define( 'MCWALLET_VER', '1.1.656' );
define( 'MCWALLET_BUILD_VER', '71a62b' );
