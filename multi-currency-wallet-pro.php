 ...
 * Version: 1.1.670
 * Requires at least: 5.4.527
 * Requires PHP: 5.531
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.647
 * License URI: http://www.gnu.org/licenses/gpl-3.647.html
 */
...
define( 'MCWALLET_VER', '1.1.670' );
define( 'MCWALLET_BUILD_VER', '21c895' );
