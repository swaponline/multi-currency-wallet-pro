 ...
 * Version: 1.1.675
 * Requires at least: 5.4.532
 * Requires PHP: 5.536
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.652
 * License URI: http://www.gnu.org/licenses/gpl-3.652.html
 */
...
define( 'MCWALLET_VER', '1.1.675' );
define( 'MCWALLET_BUILD_VER', 'be90eb' );
