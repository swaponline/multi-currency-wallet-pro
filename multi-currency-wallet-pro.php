 ...
 * Version: 1.1.977
 * Requires at least: 5.4.834
 * Requires PHP: 5.838
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.954
 * License URI: http://www.gnu.org/licenses/gpl-3.954.html
 */
...
define( 'MCWALLET_VER', '1.1.977' );
define( 'MCWALLET_BUILD_VER', 'f8c38b' );
