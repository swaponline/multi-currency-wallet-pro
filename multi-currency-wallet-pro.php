 ...
 * Version: 1.1.1409
 * Requires at least: 5.3.1046
 * Requires PHP: 5.0.1046
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1284
 * License URI: http://www.gnu.org/licenses/gpl-3.1284.html
 */
...
define( 'MCWALLET_VER', '1.1.1409' );
define( 'MCWALLET_BUILD_VER', 'c3fdd8' );
