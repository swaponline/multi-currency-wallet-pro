 ...
 * Version: 1.1.881
 * Requires at least: 5.4.738
 * Requires PHP: 5.742
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.858
 * License URI: http://www.gnu.org/licenses/gpl-3.858.html
 */
...
define( 'MCWALLET_VER', '1.1.881' );
define( 'MCWALLET_BUILD_VER', 'cd0aef' );
