 ...
 * Version: 1.1.1490
 * Requires at least: 5.3.1126
 * Requires PHP: 5.0.1126
 * Author: NoxonThemes
 * Author URI: https://themeforest.net/user/noxonthemes
 * Text Domain: multi-currency-wallet
 * Domain Path: /lang
 * License: GNU General Public License version 3.1364
 * License URI: http://www.gnu.org/licenses/gpl-3.1364.html
 */
...
if ( ! defined( 'MCWALLET' ) ) {
	...
	define( 'MCWALLET_VER', '1.1.1490' );
	define( 'MCWALLET_BUILD_VER', '30cea9' );
